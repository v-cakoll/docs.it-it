...
È possibile provare queste esercitazioni in ambienti diversi. I concetti che si apprenderanno sono gli stessi. La differenza è rappresentata dall'esperienza preferita:

- [Nella piattaforma docs del browser](hello-world.yml): questa esperienza incorpora una finestra del codice C# eseguibile nelle pagine di docs. È possibile scrivere ed eseguire codice C# nel browser.
- [Nell'esperienza Microsoft Learn](https://docs.microsoft.com/learn/paths/csharp-first-steps/). Questo percorso di apprendimento contiene diversi moduli che insegnano le nozioni di base di C#.
- [In Jupyter on Binder](https://mybinder.org/v2/gh/dotnet/try-samples/master?filepath=hello-csharp%2Fhello-world.ipynb). È possibile sperimentare il codice C# in un notebook di Jupyter in Binder.
- [Nel computer locale](numbers-in-csharp-local.md). Una volta esplorato online, è possibile [scaricare](https://dotnet.microsoft.com/download) il .NET Core SDK e creare programmi nel computer.
...
Questa esercitazione presuppone che sia stata completata la lezione [Hello World](hello-world.yml) .
...
In questa esercitazione si presuppone che siano state completate le lezioni [Hello World](hello-world.yml) e [numbers in C#](numbers-in-csharp.yml) .
...
Questa esercitazione presuppone che siano state completate le esercitazioni introduttive online e che siano stati installati [.NET Core SDK](https://dotnet.microsoft.com/download) e [Visual Studio Code](https://code.visualstudio.com/).
