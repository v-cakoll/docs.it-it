...
Per ulteriori informazioni, consultate [Cast e conversioni](programming-guide/types/casting-and-type-conversions.md)di tipi.
...
Come indicato in precedenza, è possibile tipizzare una variabile locale (ma non membri di classe) in modo implicito usando la parola chiave [var](language-reference/keywords/var.md). Alla variabile viene comunque assegnato un tipo in fase di compilazione, specificato dal compilatore. Per ulteriori informazioni, vedere [Variabili locali tipizzate in modo implicito.](programming-guide/classes-and-structs/implicitly-typed-local-variables.md)  
