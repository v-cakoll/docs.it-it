...
---
# <a name="cref-attribute-c-programming-guide"></a>attributo cref (C# guida per programmatori)
...
L'esempio seguente illustra attributi `cref` usati nei tag [\<see>](./see.md).
