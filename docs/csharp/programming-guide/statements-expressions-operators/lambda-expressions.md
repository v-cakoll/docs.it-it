...
## <a name="c-language-specification"></a><span data-ttu-id="1d4ee-193">Specifiche del linguaggio C#</span><span class="sxs-lookup"><span data-stu-id="1d4ee-193">C# language specification</span></span>
