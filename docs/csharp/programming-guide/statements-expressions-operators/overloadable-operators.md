...
## <a name="see-also"></a>Vedere anche  
 ...
 [Why are overloaded operators always static in C#?](http://go.microsoft.com/fwlink/?LinkId=112383) (Perché gli operatori sottoposti a overload sono sempre statici in C#?)
