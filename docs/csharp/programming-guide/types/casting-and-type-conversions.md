...
- **Conversioni implicite**: non è necessaria alcuna sintassi speciale perché la conversione ha sempre esito positivo e nessun dato andrà perso. Gli esempi includono conversioni dai tipi integrali più piccoli ai più grandi e conversioni dalle classi derivate alle classi di base.
