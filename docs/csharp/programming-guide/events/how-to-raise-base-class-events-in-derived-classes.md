...
---
# <a name="how-to-raise-base-class-events-in-derived-classes-c-programming-guide"></a>Come generare gli eventi della classe base nelle classi derivate (Guida per programmatori C
