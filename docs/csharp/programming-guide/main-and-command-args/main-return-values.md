...
Questo esempio usa gli strumenti della riga di comando [.NET Core](../../../core/index.md). Per acquisire familiarità con gli strumenti della riga di comando .NET Core, vedere questa [introduzione](../../../core/tutorials/using-with-xplat-cli.md).
