...
Nell'esempio viene usato il documento XML seguente: [File XML di esempio: clienti e ordini in uno spazio dei nomi](./sample-xml-file-customers-and-orders-in-a-namespace.md).
