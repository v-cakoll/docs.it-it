...
- In `query2` sia la clausola `where` che la clausola `select` hanno lo stesso profilo di prestazioni, come in `query1`.  
 ...
 Per un'esercitazione più dettagliata sul concatenamento di query, vedere [Esercitazione: Concatenamento di query](../../../../csharp/programming-guide/concepts/linq/tutorial-chaining-queries-together.md).  
