...
---
# <a name="how-to-write-a-query-that-finds-elements-based-on-context-c"></a>Come scrivere una query che trova gli elementi in base al contesto (c'è)How to write a query that finds elements based on context (C
