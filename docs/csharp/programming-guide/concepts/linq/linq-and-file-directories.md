---
title: LINQ e directory di fileC#()
ms.date: 07/20/2015
...
---
# <a name="linq-and-file-directories-c"></a>LINQ e directory di fileC#()
...
Molte file system operazioni sono essenzialmente query e sono pertanto ideali per l'approccio LINQ.  
 ...
 [Come eseguire una query per i file duplicati in un albero di directoryC#(LINQ) ()](./how-to-query-for-duplicate-files-in-a-directory-tree-linq.md)\
