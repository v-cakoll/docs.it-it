...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Offre informazioni introduttive su LINQ to XML, incluse una panoramica concettuale e una panoramica delle classi <xref:System.Xml.Linq?displayProperty=fullName>.  
