...
Per creare le applicazioni, si userà il comando [`dotnet new`](../../core/tools/dotnet-new.md). Questo comando genera i file e gli asset necessari per l'applicazione. Tutte le guide introduttive usano il tipo di applicazione `console`.
...
## <a name="pick-your-quickstart"></a>Selezionare la guida introduttiva

È possibile iniziare con una qualsiasi delle guide introduttive seguenti:
...
Questa guida introduttiva finale è disponibile solo per l'esecuzione nel computer, usando l'ambiente di sviluppo locale e .NET Core.
