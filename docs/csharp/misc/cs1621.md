...
Non è possibile usare l'istruzione [yield](../../csharp/language-reference/keywords/yield.md) in un [metodo anonimo](../language-reference/operators/delegate-operator.md) o un' [espressione lambda](../../csharp/programming-guide/statements-expressions-operators/lambda-expressions.md).
