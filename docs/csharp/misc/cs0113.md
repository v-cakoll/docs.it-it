...
Un membro 'function' contrassegnato come override non può essere contrassegnato come new o virtual  
 ...
 Le parole chiave [new](../../csharp/language-reference/keywords/new-modifier.md) e [override](../../csharp/language-reference/keywords/override.md) per contrassegnare un metodo si escludono reciprocamente.  
