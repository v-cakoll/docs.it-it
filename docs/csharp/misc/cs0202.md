...
> [!NOTE]
>  In C# 2.0 il metodo MoveNext e la proprietà Current vengono generati automaticamente. Per altre informazioni, vedere l'esempio di codice nel [interfacce generiche](../../csharp/programming-guide/generics/generic-interfaces.md).  
