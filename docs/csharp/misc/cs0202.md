...
> [!NOTE]
> In C# 2.0 il metodo MoveNext e la proprietà Current vengono generati automaticamente. Per ulteriori informazioni, vedere l'esempio di codice in [interfacce generiche](../programming-guide/generics/generic-interfaces.md).  
