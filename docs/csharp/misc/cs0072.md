...
'event': non è possibile eseguire l'override. 'method' non è un evento  
 ...
 Un [evento](../language-reference/keywords/event.md) può eseguire l'override solo di un altro evento. Per ulteriori informazioni, vedi [Eventi](../programming-guide/events/index.md).  
