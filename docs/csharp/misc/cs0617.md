...
---
# <a name="compiler-error-cs0617"></a>Errore del compilatore CS0617
'reference' non è un argomento di attributo denominato valido perché non è un tipo di parametro di attributo valido  
  
 Si è provato ad accedere a un membro [privato](../language-reference/keywords/private.md) di un attributo.  
