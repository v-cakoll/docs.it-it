...
- Aggiungere un riferimento all'assembly che abbia la coclasse. L'interfaccia e la coclasse devono trovarsi quasi sempre nello stesso assembly. Per altre informazioni, vedere [/reference](../language-reference/compiler-options/reference-compiler-option.md) o [Finestra di dialogo Aggiungi riferimento](/visualstudio/ide/how-to-add-or-remove-references-by-using-the-reference-manager) .  
