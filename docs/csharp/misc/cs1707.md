...
Delegato 'DelegateName' associato a 'MethodName1' anziché a 'MethodName2' a causa di nuove regole del linguaggio  
 ...
 Per una descrizione del modo in cui il compilatore determina il metodo a cui associare un delegato, vedere [utilizzo della varianza nei](../programming-guide/concepts/covariance-contravariance/using-variance-in-delegates.md)delegati.
