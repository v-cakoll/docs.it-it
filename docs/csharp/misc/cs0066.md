...
'event': l'evento deve essere di un tipo delegato  
 ...
 La parola chiave event richiede un tipo [delegate](../language-reference/keywords/delegate.md) . Per ulteriori informazioni, vedere [eventi](../programming-guide/events/index.md) e [delegati](../programming-guide/delegates/index.md).  
