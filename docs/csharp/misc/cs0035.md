...
L'operatore 'operator' è ambiguo su un operando di tipo 'type'  
 ...
 l compilatore ha a disposizione più conversioni e non è in grado di sceglierne una prima di applicare l'operatore. Per altre informazioni, vedere [le conversioni definite dall'utente basate su modelli](/cpp/misc/templated-user-defined-conversions) e [gli operatori di conversione](../../csharp/programming-guide/statements-expressions-operators/conversion-operators.md).  
