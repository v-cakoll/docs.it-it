...
'attribute modifier' non è una posizione di attributo riconosciuta. Tutti gli attributi in questo blocco verranno ignorati.  
 ...
 È stato specificato un modificatore di attributo non valido. Per altre informazioni, vedere [Destinazioni degli attributi](../programming-guide/concepts/attributes/index.md#attribute-targets) .  
