...
L'evento 'event' può essere usato solo sul lato sinistro di += o -=  
 ...
 Un [evento](../../csharp/language-reference/keywords/event.md) è stato chiamato in modo non corretto. Per altre informazioni, vedere [eventi](../../csharp/programming-guide/events/index.md) e [delegati](../../csharp/programming-guide/delegates/index.md).  
