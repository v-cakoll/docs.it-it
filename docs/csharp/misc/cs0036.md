...
---
# <a name="compiler-error-cs0036"></a>Errore del compilatore CS0036
Un parametro out non può avere l'attributo '[In]'  
  
 Attualmente, il **In** attributo non è consentito in un [out](../../csharp/language-reference/keywords/out-parameter-modifier.md) parametro.  
