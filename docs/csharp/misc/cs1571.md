...
Il commento XML in 'construct' contiene un tag param duplicato per 'parameter'  
 ...
 Quando si usa l'opzione del compilatore [/doc](../language-reference/compiler-options/doc-compiler-option.md) , vengono trovati più commenti per lo stesso parametro di metodo. Rimuovere una delle righe duplicate.  
