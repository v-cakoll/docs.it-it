...
Impossibile inserire modificatori nelle dichiarazioni delle funzioni di accesso agli eventi  
 ...
 I modificatori possono essere inseriti solo nelle dichiarazioni di evento e non nelle dichiarazioni della funzione di accesso eventi. Per altre informazioni, vedere [Using Properties](../programming-guide/classes-and-structs/using-properties.md).  
