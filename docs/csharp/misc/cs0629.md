...
Il membro condizionale 'member' non può implementare il membro di interfaccia 'base class member' nel tipo 'Type Name'  
 ...
 L'attributo [Conditional](http://msdn.microsoft.com/en-us/e1c4913b-74d0-421a-8a6d-c14b3f0e68fb) non può essere usato nell'implementazione di un'interfaccia.  
