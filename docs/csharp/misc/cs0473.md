...
Per correggere l'errore, eliminare l'implementazione esplicita e implementare entrambi i metodi di interfaccia nell'implementazione `public int TestMethod(int)`implicita.
