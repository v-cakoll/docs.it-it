...
Il tipo restituito di un' [operatore di overload](../../csharp/language-reference/operators/operator-overloading.md) deve comparire prima il `operator` (parola chiave).
