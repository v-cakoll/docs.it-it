...
Gli iteratori non possono avere parametri out o ref  
 ...
 Questo errore si verifica se un metodo iteratore accetta un `in`, `ref`, o `out` parametro. Per evitare questo errore, rimuovere il `in`, `ref`, o `out` parola chiave dalla firma del metodo.  
