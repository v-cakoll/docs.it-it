...
Il commento XML in 'member' contiene l'attributo cref 'invalid_syntax' che è sintatticamente errato  
 ...
 Uno dei parametri passati a un tag per i commenti della documentazione ha una sintassi non valida. Per altre informazioni, vedere [Tag consigliati per i commenti relativi alla documentazione](../programming-guide/xmldoc/recommended-tags-for-documentation-comments.md).  
