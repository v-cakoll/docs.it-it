...
- [/PDB (C# opzioni del compilatore)](../language-reference/compiler-options/pdb-compiler-option.md)
- [/debug (C# opzioni del compilatore)](../language-reference/compiler-options/debug-compiler-option.md)
