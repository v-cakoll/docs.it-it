...
È previsto il nome di un metodo  
 ...
 Quando si crea un oggetto [delegate](../language-reference/builtin-types/reference-types.md), specificare un metodo. Per altre informazioni, vedere [Delegati](../programming-guide/delegates/index.md).  
