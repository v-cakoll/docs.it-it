...
È previsto il nome di un metodo  
 ...
 Quando si crea un oggetto [delegate](../language-reference/keywords/delegate.md), specificare un metodo. Per altre informazioni, vedere [Delegati](../programming-guide/delegates/index.md).  
