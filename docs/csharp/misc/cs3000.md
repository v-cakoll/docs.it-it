...
I metodi con argomenti variabili non sono conformi a CLS  
 ...
 Gli argomenti usati nel metodo espongono funzionalità non incluse nelle specifiche CLS (Common Language Specification). Per altre informazioni sulla conformità a CLS, vedere [Scrittura di codice conforme a CLS](http://msdn.microsoft.com/en-us/4c705105-69a2-4e5e-b24e-0633bc32c7f3).  
