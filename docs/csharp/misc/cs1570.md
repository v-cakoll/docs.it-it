...
Il commento XML in 'construct' presenta un formato XML errato - 'reason'  
 ...
 Quando si usa [-doc](../language-reference/compiler-options/doc-compiler-option.md), i commenti nel codice sorgente devono essere in formato XML. Gli errori relativi al markup XML generano l'avviso CS1570. Esempio:  
...
- L'attributo del percorso o del file in un tag [\<include >](../programming-guide/xmldoc/include.md) manca o è formato in modo errato.  
