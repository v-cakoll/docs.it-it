...
C#8,0 è supportato in **.NET Core 3. x** e **.NET standard 2,1**. Per ulteriori informazioni, vedere [ C# controllo delle versioni dei linguaggi](../language-reference/configure-language-version.md).
