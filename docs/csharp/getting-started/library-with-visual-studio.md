---
title: Creazione di una libreria di classi con C# e .NET Core in Visual Studio 2017 | Microsoft Docs
...
# Creazione di una libreria di classi con C# e .NET Core in Visual Studio 2017
...
## Creazione di una soluzione per la libreria di classi
...
## Creazione del progetto di libreria di classi
