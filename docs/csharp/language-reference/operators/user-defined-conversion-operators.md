...
Le conversioni definite dall'utente non vengono considerate dagli operatori [is](type-testing-and-conversion-operators.md#is-operator) e [as](type-testing-and-conversion-operators.md#as-operator). Usare l'[operatore cast ()](type-testing-and-conversion-operators.md#cast-operator-) per richiamare una conversione esplicita definita dall'utente.
...
- [Operatori di conversione e di test del tipo](type-testing-and-conversion-operators.md)
