...
Per altre informazioni, vedere la [nota relativa alla proposta di funzionalità](https://github.com/dotnet/csharplang/blob/master/proposals/csharp-7.2/conditional-ref.md).
