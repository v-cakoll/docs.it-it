...
[default(T)](default.md): genera il valore predefinito del tipo T.
...
[delegate](delegate-operator.md): dichiara e restituisce un'istanza di delegato.

[sizeof](sizeof.md): restituisce le dimensioni in byte dell'operando type.
