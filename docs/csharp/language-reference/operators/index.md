...
## <a name="primary-operators"></a>Operatori primari  
 ...
 [typeof](../../../csharp/language-reference/keywords/typeof.md): restituisce l'oggetto <xref:System.Type> che rappresenta l'operando.  
...
## <a name="logical-and-operator"></a>Operatore AND logico  
 ...
 [x & y](../../../csharp/language-reference/operators/and-operator.md): AND logico o bit per bit. Di solito è possibile usarlo con i tipi Integer e con i tipi `enum`.  
...
## <a name="logical-or-operator"></a>Operatore OR logico  
 ...
 [x &#124; y](../../../csharp/language-reference/operators/or-operator.md): OR logico o bit per bit. Di solito è possibile usarlo con i tipi Integer e con i tipi `enum`.  
...
## <a name="null-coalescing-operator"></a>Operatore null-coalescing  
 ...
 [x ?? y](../../../csharp/language-reference/operators/null-coalescing-operator.md): restituisce `x` se è non `null`. In caso contrario, restituisce `y`.  
