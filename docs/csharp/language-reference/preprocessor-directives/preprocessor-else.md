---
title: '#<a name="else-c-reference"></a>else (Riferimenti per C#)'
ms.date: 07/20/2015
ms.prod: .net
...
---
# <a name="else-c-reference"></a>#else (Riferimenti per C#)
...
## <a name="remarks"></a>Note  
 La direttiva per il preprocessore `#else` deve essere seguita da [#endif](../../../csharp/language-reference/preprocessor-directives/preprocessor-endif.md). Per un esempio di utilizzo di `#else`, vedere [#if](../../../csharp/language-reference/preprocessor-directives/preprocessor-if.md).  
