...
---
# <a name="namespace-keywords-c-reference"></a>Parole chiave per spazi dei nomi (Riferimenti per C#)
Questa sezione descrive le parole chiave e gli operatori che sono associati all'uso degli spazi dei nomi:  
