...
## <a name="example"></a><span data-ttu-id="99eea-105">Esempio</span><span class="sxs-lookup"><span data-stu-id="99eea-105">Example</span></span>  
 <span data-ttu-id="99eea-106">L'esempio seguente mostra come usare la parola chiave contestuale `global` per specificare che la classe `TestApp` è definita nello spazio dei nomi globale:</span><span class="sxs-lookup"><span data-stu-id="99eea-106">The following example shows how to use the `global` contextual keyword to specify that the class `TestApp` is defined in the global namespace:</span></span>  
  
 [!code-csharp[csrefKeywordsContextual#13](../../../csharp/language-reference/keywords/codesnippet/CSharp/global_1.cs)]  
  
## <a name="see-also"></a><span data-ttu-id="99eea-107">Vedere anche</span><span class="sxs-lookup"><span data-stu-id="99eea-107">See Also</span></span>  
 [<span data-ttu-id="99eea-108">Spazi dei nomi</span><span class="sxs-lookup"><span data-stu-id="99eea-108">Namespaces</span></span>](../../../csharp/programming-guide/namespaces/index.md)
