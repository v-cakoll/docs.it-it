...
La parola chiave `internal` è un [modificatore di accesso](./access-modifiers.md) per tipi e membri dei tipi.
 ...
 > Questa pagina illustra l'accesso `internal`. La `internal` parola chiave fa [`protected internal`](./protected-internal.md) anche parte del modificatore di accesso.
