...
|[const](../../../csharp/language-reference/keywords/const.md)|Specifica che non è possibile modificare il valore del campo o della variabile locale.|  
|[event](../../../csharp/language-reference/keywords/event.md)|Dichiara un evento.|  
...
|[unsafe](../../../csharp/language-reference/keywords/unsafe.md)|Dichiara un contesto non sicuro.|  
