...
1. Aggiungere una chiamata al costruttore senza parametri in un inizializzatore di costruttore, come illustrato nell'esempio seguente. Si noti l'uso di `: this()`. Per altre informazioni, vedere [this](../keywords/this.md).  
