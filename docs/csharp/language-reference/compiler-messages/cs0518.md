...
- È stata specificata l'opzione [-nostdlib](../compiler-options/nostdlib-compiler-option.md) del compilatore della riga di comando. L'opzione /nostdlib impedisce l'importazione di mscorlib.dll. Usare questa opzione se si vuole definire o creare uno spazio dei nomi System specifico dell'utente.  
