...
- Nascondere la proprietà della classe di base aggiungendo la parola chiave [new](../../../csharp/language-reference/keywords/new-modifier.md) a una proprietà in una classe derivata.  
