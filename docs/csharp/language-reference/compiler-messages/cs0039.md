...
La conversione con l'operatore [as](../../language-reference/operators/type-testing-and-cast.md#as-operator) è consentita solo per ereditarietà oppure come conversioni di riferimenti e conversioni boxing.
