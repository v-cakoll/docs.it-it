...
- È stato passato un nome di variabile all'operatore [typeof](../../../csharp/language-reference/operators/type-testing-and-conversion-operators.md#typeof-operator).  
