...
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="4f482-102">Errore del compilatore CS0015</span><span class="sxs-lookup"><span data-stu-id="4f482-102">Compiler Error CS0015</span></span>

<span data-ttu-id="4f482-103">il nome del tipo "tipo" è troppo lungo</span><span class="sxs-lookup"><span data-stu-id="4f482-103">The name of type 'type' is too long</span></span>

 <span data-ttu-id="4f482-104">Il nome completo di un tipo definito dall'utente deve avere meno di 1024 caratteri, inclusi i punti.</span><span class="sxs-lookup"><span data-stu-id="4f482-104">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>

 <span data-ttu-id="4f482-105">L'esempio seguente genera l'errore CS0015:</span><span class="sxs-lookup"><span data-stu-id="4f482-105">The following sample generates CS0015:</span></span>
