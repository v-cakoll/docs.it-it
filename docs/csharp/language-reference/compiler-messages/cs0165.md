...
Uso della variabile locale non assegnata "name"  
 ...
 Per altre informazioni, vedere [Why does a recursive lambda cause a definite assignment error?](https://blogs.msdn.microsoft.com/ericlippert/2006/08/18/why-does-a-recursive-lambda-cause-a-definite-assignment-error/) (Perché un'espressione lambda ricorsiva causa un errore di assegnazione definita?).  
