...
Usare l'opzione della riga di comando "compiler_option" o le impostazioni di progetto appropriate anziché "attribute_name"  
 ...
 Nella [Procedura: Firmare un assembly con un nome sicuro](../../../framework/app-domains/how-to-sign-an-assembly-with-a-strong-name.md) vengono usate le opzioni del compilatore seguenti:  
