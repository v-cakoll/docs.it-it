...
- Un client che fa riferimento solo alla versione 1.0 delle due DLL identiche, ma in grado di accedere a una classe dalla versione 2.0.  
 ...
 Nel codice seguente viene creata la prima delle due DLL identiche. Per informazioni su come generare un file di chiave, vedere [-key file (C# opzioni del compilatore)](../compiler-options/keyfile-compiler-option.md).  
