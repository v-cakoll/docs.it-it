...
Il tipo Nometipo1 esiste sia in Nometipo2 che in NomeTipo3  
 ...
 Per risolvere questo errore, usare la funzionalità di alias dell'opzione del compilatore [/reference (opzioni del compilatore C#)](../compiler-options/reference-compiler-option.md) oppure non fare riferimento a uno degli assembly.  
