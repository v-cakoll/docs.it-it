...
L'opzione del compilatore -target può essere specificata in uno dei quattro formati seguenti:The **-target** compiler option can be specified in one of four forms:  
 ...
 A meno che non si specifichi **-target:module**, **-target** determina l'inserimento di un manifesto dell'assembly .NET Framework in un file di output. Per ulteriori informazioni, vedere [Assembly in .NET](../../../standard/assembly/index.md) e [Attributi comuni](../attributes/global.md).  
