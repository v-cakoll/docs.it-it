...
|Opzione|Significato|  
|------------|-------------|  
|default|Il compilatore accetta tutte le sintassi di linguaggio valide dalla versione principale più recente supportata. <sup id="TDefault">[Default](#FDefault)</sup>| 
...
### <a name="c-language-specification"></a>Specifiche del linguaggio C#
 ...
 C# 2.0 [c042926_ISO_IEC_23270_2006(E).zip](http://standards.iso.org/ittf/PubliclyAvailableStandards/c042926_ISO_IEC_23270_2006(E).zip) ISO/IEC 23270:2006 in formato PDF: Standard ISO disponibili liberamente  
