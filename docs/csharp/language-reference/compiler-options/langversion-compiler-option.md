...
La versione del linguaggio predefinita dipende dal framework di destinazione per l'applicazione e dalla versione dell'SDK o di Visual Studio installata. Queste regole sono definite nell'articolo sulla [configurazione della versione del linguaggio](../configure-language-version.md#defaults).
