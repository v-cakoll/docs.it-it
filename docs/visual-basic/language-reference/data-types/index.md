...
|[Carattere](../../../visual-basic/language-reference/data-types/char-data-type.md) (carattere singolo)|<xref:System.Char>|2 byte|da 0 a 65535 (senza segno)|  
...
|[Tempo](../../../visual-basic/language-reference/data-types/long-data-type.md) (Long Integer)|<xref:System.Int64>|8 byte|da-9.223.372.036.854.775.808 a 9.223.372.036.854.775.807 (9.2... E + 18 <sup>†</sup>) (con segno)|  
...
|[Breve](../../../visual-basic/language-reference/data-types/short-data-type.md) (short Integer)|<xref:System.Int16>|2 byte|da-32.768 a 32.767 (con segno)|  
|[Singolo](../../../visual-basic/language-reference/data-types/single-data-type.md) (virgola mobile a precisione singola)|<xref:System.Single>|4 byte|-3.4028235 e + 38-401298E E-45 <sup>†</sup> per i valori negativi;<br /><br /> 401298E e-45 tramite 3.4028235 E + 38 <sup>†</sup> per i valori positivi|  
|[Stringa](../../../visual-basic/language-reference/data-types/string-data-type.md) di (a lunghezza variabile)|<xref:System.String>classe|Dipende dalla piattaforma di implementazione|da 0 a circa 2 miliardi caratteri Unicode|  
...
> [!NOTE]
> Per le stringhe contenenti testo, usare <xref:Microsoft.VisualBasic.Strings.StrConv%2A> la funzione per convertire un formato di testo in un altro.  
