...
## <a name="remarks"></a>Note  
 Per informazioni sui metodi e proprietà del `My.Computer.Ports` , vedere <xref:Microsoft.VisualBasic.Devices.Ports>.  
...
> [!NOTE]
>  È inoltre possibile utilizzare i metodi e proprietà del <xref:System.IO.Ports.SerialPort?displayProperty=nameWithType> classe per accedere a porte seriali del computer.  
