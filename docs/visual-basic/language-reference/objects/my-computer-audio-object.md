...
## <a name="remarks"></a>Note  
 Per informazioni sui metodi e proprietà del `My.Computer.Audio` , vedere <xref:Microsoft.VisualBasic.Devices.Audio>.  
  
 Per ulteriori informazioni, vedere [gioco suoni](../../../visual-basic/developing-apps/programming/computer-resources/playing-sounds.md).  
