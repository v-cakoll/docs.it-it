...
|Un segnale acustico dal computer.|<xref:Microsoft.VisualBasic.Interaction.Beep%2A>|  
...
|Finestre di dialogo|<xref:Microsoft.VisualBasic.Interaction.InputBox%2A>, <xref:Microsoft.VisualBasic.Interaction.MsgBox%2A>|  
