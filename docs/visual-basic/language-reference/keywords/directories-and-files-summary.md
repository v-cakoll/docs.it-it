...
|----------------|--------------------------|  
|Modifica di una directory o una cartella.|<xref:Microsoft.VisualBasic.FileSystem.ChDir%2A>|  
...
|Restituire l'indicatore di data e ora di un file.|<xref:Microsoft.VisualBasic.FileSystem.FileDateTime%2A>|  
|Restituire i file, directory o attributi di etichetta.|<xref:Microsoft.VisualBasic.FileSystem.GetAttr%2A>|  
|Restituire la lunghezza di un file.|<xref:Microsoft.VisualBasic.FileSystem.FileLen%2A>|  
|Restituisce l'etichetta di volume o nome di un file.|<xref:Microsoft.VisualBasic.FileSystem.Dir%2A>|  
