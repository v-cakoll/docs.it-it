...
|Termine|Definizione|  
|---|---|  
|`result`|Obbligatorio. Qualsiasi espressione `Boolean` . The result is the `Boolean` result of comparison of the two expressions.|  
