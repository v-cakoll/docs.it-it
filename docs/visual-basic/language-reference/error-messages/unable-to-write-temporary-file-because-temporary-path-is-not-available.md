...
[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] non è riuscito a determinare il percorso in cui sono archiviati i file temporanei.  
  
 **ID errore:** BC30698  
  
## <a name="to-correct-this-error"></a>Per correggere l'errore  
  
1.  Riavviare [!INCLUDE[vsprvs](~/includes/vsprvs-md.md)].  
  
2.  Se il problema persiste, reinstallare [!INCLUDE[vsprvs](~/includes/vsprvs-md.md)].  
