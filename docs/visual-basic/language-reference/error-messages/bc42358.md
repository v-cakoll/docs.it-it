...
---
# <a name="because-this-call-is-not-awaited-execution-of-the-current-method-continues-before-the-call-is-completed"></a>Poiché questa chiamata non è attesa, l'esecuzione del metodo corrente continua prima del completamento della chiamata
