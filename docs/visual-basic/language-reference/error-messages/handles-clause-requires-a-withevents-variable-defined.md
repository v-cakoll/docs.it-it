...
Non è stato fornito un `WithEvents` di una variabile nel `Handles` clausola. Il `Handles` parola chiave alla fine di una dichiarazione di routine consente a gestire gli eventi generati da una variabile oggetto dichiarata con la `WithEvents` (parola chiave).  
  
 **ID errore:** BC30506  
  
## <a name="to-correct-this-error"></a>Per correggere l'errore  
  
- Fornire il necessario `WithEvents` variabile.  
