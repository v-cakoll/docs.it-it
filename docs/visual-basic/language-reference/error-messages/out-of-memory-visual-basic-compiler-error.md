...
-   Eliminare i form e controlli non necessari in modo che un valore più basso vengono caricati in una sola volta  
  
-   Ridurre il numero di `Public` variabili.  
  
-   Controllare lo spazio disponibile su disco.  
  
-   Aumentare la quantità di RAM disponibile mediante l'installazione di ulteriore memoria o riallocare la memoria.  
