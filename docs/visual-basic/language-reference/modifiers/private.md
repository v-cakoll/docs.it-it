...
- [Protected Friend](./protected-friend.md)    [Livelli di accesso Friend protetti in Visual Basic](../../../visual-basic/programming-guide/language-features/declared-elements/access-levels.md)
