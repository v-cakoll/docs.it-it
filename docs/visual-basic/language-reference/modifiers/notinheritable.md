...
ms.openlocfilehash: 6e7de9fac10cf6a2d47ccc1351232271391cf112
...
Specifica una classe non può essere utilizzata come classe base.  
  
## <a name="remarks"></a>Note  
 **Alternative termini**. Una classe che non può essere ereditata viene talvolta definita un *sealed* classe.  
  
 Il `NotInheritable` modificatore può essere utilizzato in questo contesto:  
