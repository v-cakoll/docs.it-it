...
Specifica che un argomento è passato in modo tale che la routine chiamata può modificare il valore di una variabile sottostante all'argomento nel codice chiamante.  
