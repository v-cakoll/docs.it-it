...
|*Nomemembro1*<br /><br /> ...<br /><br /> *memberNameN*|Nella sintassi, i puntini di sospensione (...) viene utilizzato per indicare un numero indefinito di elementi del tipo specificato immediatamente prima i puntini di sospensione.<br /><br /> Nel codice, i puntini di sospensione indicano codice omessi per maggiore chiarezza.|  
