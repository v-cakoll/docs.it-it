---
title: Membri della libreria di runtime di Visual Basic
ms.date: 07/20/2015
f1_keywords:
- VisualBasic
helpviewer_keywords:
...
ms.locfileid: "58828716"
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="62894-102">Membri della libreria di runtime di Visual Basic</span><span class="sxs-lookup"><span data-stu-id="62894-102">Visual Basic Runtime Library Members</span></span>
<span data-ttu-id="62894-103">Il `Microsoft.VisualBasic` dello spazio dei nomi contiene le classi, moduli, costanti ed enumerazioni che costituiscono la libreria di runtime di Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="62894-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="62894-104">Questi membri delle librerie di forniscono procedure, le proprietà e valori costanti che è possibile usare nel codice.</span><span class="sxs-lookup"><span data-stu-id="62894-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="62894-105">Ogni modulo e classi rappresenta una determinata categoria di funzionalità.</span><span class="sxs-lookup"><span data-stu-id="62894-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="62894-106">Microsoft.VisualBasic.Collection Class</span><span class="sxs-lookup"><span data-stu-id="62894-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="62894-107">Classe ComClassAttribute</span><span class="sxs-lookup"><span data-stu-id="62894-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="62894-108">Microsoft.VisualBasic.ControlChars Class</span><span class="sxs-lookup"><span data-stu-id="62894-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="62894-109">Microsoft.VisualBasic.Constants Class</span><span class="sxs-lookup"><span data-stu-id="62894-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="62894-110">Microsoft.VisualBasic.Conversion Module</span><span class="sxs-lookup"><span data-stu-id="62894-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="62894-111">Microsoft.VisualBasic.DateAndTime Module</span><span class="sxs-lookup"><span data-stu-id="62894-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="62894-112">Classe Microsoft.VisualBasic.ErrObject</span><span class="sxs-lookup"><span data-stu-id="62894-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="62894-113">Microsoft.VisualBasic.FileSystem Module</span><span class="sxs-lookup"><span data-stu-id="62894-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="62894-114">Microsoft.VisualBasic.Financial Module</span><span class="sxs-lookup"><span data-stu-id="62894-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="62894-115">Microsoft.VisualBasic.Globals Module</span><span class="sxs-lookup"><span data-stu-id="62894-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="62894-116">Classe Microsoft.VisualBasic.HideModuleNameAttribute</span><span class="sxs-lookup"><span data-stu-id="62894-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="62894-117">Microsoft.VisualBasic.Information Module</span><span class="sxs-lookup"><span data-stu-id="62894-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="62894-118">Microsoft.VisualBasic.Interaction Module</span><span class="sxs-lookup"><span data-stu-id="62894-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="62894-119">Classe Microsoft.VisualBasic.MyGroupCollectionAttribute</span><span class="sxs-lookup"><span data-stu-id="62894-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="62894-120">Microsoft.VisualBasic.Strings Module</span><span class="sxs-lookup"><span data-stu-id="62894-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="62894-121">Classe Microsoft.VisualBasic.VBFixedArrayAttribute</span><span class="sxs-lookup"><span data-stu-id="62894-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="62894-122">Classe Microsoft.VisualBasic.VBFixedStringAttribute</span><span class="sxs-lookup"><span data-stu-id="62894-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="62894-123">Microsoft.VisualBasic.VbMath Module</span><span class="sxs-lookup"><span data-stu-id="62894-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="62894-124">Microsoft. VisualBasic costanti ed enumerazioni</span><span class="sxs-lookup"><span data-stu-id="62894-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  
 <span data-ttu-id="62894-125">Il `Microsoft.VisualBasic` dello spazio dei nomi fornisce le costanti ed enumerazioni come parte della libreria run-time Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="62894-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="62894-126">È possibile usare questi valori costanti nel codice.</span><span class="sxs-lookup"><span data-stu-id="62894-126">You can use these constant values in your code.</span></span> <span data-ttu-id="62894-127">Ciascuna enumerazione rappresenta una determinata categoria di funzionalità.</span><span class="sxs-lookup"><span data-stu-id="62894-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="62894-128">Per altre informazioni, vedere [costanti ed enumerazioni](../../visual-basic/language-reference/constants-and-enumerations.md).</span><span class="sxs-lookup"><span data-stu-id="62894-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="62894-129">Vedere anche</span><span class="sxs-lookup"><span data-stu-id="62894-129">See also</span></span>

- [<span data-ttu-id="62894-130">Costanti ed enumerazioni</span><span class="sxs-lookup"><span data-stu-id="62894-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)
- [<span data-ttu-id="62894-131">Parole chiave</span><span class="sxs-lookup"><span data-stu-id="62894-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
