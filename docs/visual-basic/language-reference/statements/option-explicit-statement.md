...
## <a name="parts"></a>Parti  
 `On`  
 Facoltativa. Abilita il controllo `Option Explicit`. Se non si specifica `On` o `Off`, il valore predefinito è `On`.  
  
 `Off`  
 Facoltativa. Disabilita il controllo `Option Explicit`.  
