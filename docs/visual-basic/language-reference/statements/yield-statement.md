...
-   <span data-ttu-id="678a2-125">Non può avere qualsiasi `ByRef` parametri.</span><span class="sxs-lookup"><span data-stu-id="678a2-125">It cannot have any `ByRef` parameters.</span></span>  
