...
---
# <a name="visual-basic-power-packs-controls"></a>Controlli Visual Basic Power Pack
I controlli Visual Basic Power Pack sono controlli Windows Form aggiuntivi. Non sono inclusi in Visual Studio.  È possibile [scaricarli](http://go.microsoft.com/fwlink/?LinkId=321343), ma vengono forniti come-sono, senza il supporto.  
