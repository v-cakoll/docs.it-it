...
-   [Aggiunta di oggetti personalizzati per il personale Namespace](#addingcustom)  
  
-   [Aggiunta di membri per il personale Namespace](#addingtonamespace)  
...
##  <a name="addingcustom"></a>Aggiunta di oggetti personalizzati per il personale Namespace  
...
###  <a name="addingtonamespace"></a>Aggiunta di membri per il personale Namespace  
