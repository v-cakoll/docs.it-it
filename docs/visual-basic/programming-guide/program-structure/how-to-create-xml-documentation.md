...
5. Compile the code to generate an XML file containing the documentation comments. Per altre informazioni, vedere [-doc](../../../visual-basic/reference/command-line-compiler/doc.md).
