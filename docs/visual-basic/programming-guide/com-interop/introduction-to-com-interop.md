...
### <a name="importing-and-exporting-type-libraries"></a>Importazione ed esportazione delle librerie dei tipi  
 ...
 Per informazioni su Tlbimp e Tlbexp, vedere [(tipo di libreria utilità di importazione) Tlbimp.exe](../../../framework/tools/tlbimp-exe-type-library-importer.md) e [Tlbexp.exe (Type Library Exporter)](https://msdn.microsoft.com/library/a487d61b-d166-467b-a7ca-d8b52fbff42d).  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Interoperabilità COM senza registrazione](https://msdn.microsoft.com/library/90f308b9-82dc-414a-bce1-77e0155e56bd)
