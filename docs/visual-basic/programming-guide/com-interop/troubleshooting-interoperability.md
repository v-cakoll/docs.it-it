...
## <a name="overloaded-methods"></a>Metodi di overload  
 Sebbene sia possibile creare metodi di overload con [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)], non sono supportate da COM. Quando una classe che contiene i metodi di overload è esposta come un oggetto COM, vengono generati nuovi nomi per i metodi di overload.  
