---
title: 'Procedura: dichiarare e utilizzare prefissi dello spazio dei nomi XML (Visual Basic)'
ms.date: 07/20/2015
helpviewer_keywords:
...
In questo esempio viene illustrato come importare il prefisso dello spazio dei nomi XML `ns` e usarla in un valore letterale XML e proprietà axis XML.  
