...
-   Se il parametro corrispondente viene dichiarato `ByVal` nella procedura, non è necessario eseguire passaggi aggiuntivi. [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]già prevede di passare l'argomento per valore.  
