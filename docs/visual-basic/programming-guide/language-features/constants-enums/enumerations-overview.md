...
## <a name="tasks-involving-enumerations"></a>Attività che includono le enumerazioni  
 Nella tabella seguente vengono elencate attività comuni che interessano le enumerazioni.  
...
|Il nome di un'enumerazione completo|[Qualifica di nomi ed enumerazioni](../../../../visual-basic/programming-guide/language-features/constants-enums/enumerations-and-name-qualification.md)|  
