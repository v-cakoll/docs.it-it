...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene illustrato come convertire un `Object` variabile a qualsiasi altro tipo di dati.  
  
 [Conversioni di matrice](../../../../visual-basic/programming-guide/language-features/data-types/array-conversions.md)  
 I passaggi necessari per il processo di conversione tra matrici di tipi di dati diversi.  
