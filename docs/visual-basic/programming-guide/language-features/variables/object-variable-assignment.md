...
Every XML document object could then call the procedure and pass its current instance as an argument. Nell'esempio che segue viene illustrato quanto descritto.
