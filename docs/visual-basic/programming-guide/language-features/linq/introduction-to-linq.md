...
|[LINQ (Language-Integrated Query)](../../concepts/linq/index.md)|Sono incluse informazioni generali, materiale sussidiario sulla programmazione ed esempi per LINQ.|  
...
|[LINQ to Objects](../../concepts/linq/linq-to-objects.md)|Sono incluse informazioni generali, materiale sussidiario sulla programmazione ed esempi per LINQ to Objects.|  
