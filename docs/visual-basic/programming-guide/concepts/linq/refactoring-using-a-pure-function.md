...
- [Proiezione di XML in una forma diversa (Visual Basic)](projecting-xml-in-a-different-shape.md)  
...
- [Refactoring tramite un metodo di estensione (Visual Basic)](refactoring-using-an-extension-method.md)
