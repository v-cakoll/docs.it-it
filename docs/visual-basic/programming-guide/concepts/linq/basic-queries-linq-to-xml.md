...
---
# <a name="basic-queries-linq-to-xml-visual-basic"></a>Le query di base (LINQ to XML) (Visual Basic)
...
|[Procedura: eseguire il Debug di set di risultati vuoto Query (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-debug-empty-query-results-sets.md)|Viene illustrata la correzione appropriata per il debug di query su codice XML incluso in uno spazio dei nomi predefinito.|  
