...
---
# <a name="how-to-find-child-elements-based-on-position-xpath-linq-to-xml-visual-basic"></a>Procedura: Trova elementi figlio in base alla posizione (XPath-LINQ to XML) (Visual Basic)
