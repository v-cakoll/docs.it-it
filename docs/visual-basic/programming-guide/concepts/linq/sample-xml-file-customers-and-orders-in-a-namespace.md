...
ms.locfileid: "84413336"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="8cd36-102">File XML di esempio: clienti e ordini in uno spazio dei nomi</span><span class="sxs-lookup"><span data-stu-id="8cd36-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="8cd36-103">Il file XML seguente viene usato in vari esempi nella documentazione di [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)].</span><span class="sxs-lookup"><span data-stu-id="8cd36-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="8cd36-104">Contiene Customers e Orders.</span><span class="sxs-lookup"><span data-stu-id="8cd36-104">This file contains customers and orders.</span></span> <span data-ttu-id="8cd36-105">L'XML si trova in uno spazio dei nomi.</span><span class="sxs-lookup"><span data-stu-id="8cd36-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="8cd36-106">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="8cd36-106">CustomersOrdersInNamespace.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="8cd36-107">Vedere anche</span><span class="sxs-lookup"><span data-stu-id="8cd36-107">See also</span></span>

- [<span data-ttu-id="8cd36-108">Documenti XML di esempio (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="8cd36-108">Sample XML Documents (LINQ to XML)</span></span>](sample-xml-documents-linq-to-xml.md)
