...
---
# <a name="how-to-find-a-single-descendant-using-the-descendants-method-visual-basic"></a>Procedura: Trovare un discendente singolo con il metodo Descendants (Visual Basic)
