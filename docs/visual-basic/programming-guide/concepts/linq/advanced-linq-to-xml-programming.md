---
title: Avanzate di LINQ to XML programmazione (Visual Basic)
ms.custom: 
ms.date: 07/20/2015
ms.prod: .net
ms.reviewer: 
...
---
# <a name="advanced-linq-to-xml-programming-visual-basic"></a>Avanzate di LINQ to XML programmazione (Visual Basic)
