...
## <a name="remarks"></a>Note  
 L'opzione `-nowarn` impedisce al compilatore di generare avvisi. Per escludere un singolo avviso, fornire l'ID avviso all'opzione `-nowarn` che segue i due punti. Separare più numeri di avviso con virgole.  
  
 È necessario specificare solo la parte numerica dell'identificatore di avviso. Ad esempio, se si desidera disattivare BC42024, l'avviso per le variabili locali non usate, specificare `-nowarn:42024`.  
