...
## <a name="arguments"></a>Argomenti  
 `response_file`  
 Richiesto. File che elenca le opzioni del compilatore o i file del codice sorgente da compilare. Racchiudere il nome file tra virgolette ("") se contiene uno spazio.  
