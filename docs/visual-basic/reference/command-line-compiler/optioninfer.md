...
## <a name="remarks"></a>Note  
 Se il file di codice sorgente contiene un' [istruzione Option deduce](../../../visual-basic/language-reference/statements/option-infer-statement.md), l'istruzione sostituisce l'impostazione del compilatore `-optioninfer` dalla riga di comando.  
