...
## <a name="arguments"></a>Argomenti  
 `+` &#124; `-`  
 facoltativo. L'opzione è disattivata per impostazione predefinita o se si specifica `-highentropyva-`. L'opzione è attiva se si specifica `-highentropyva` o `-highentropyva+`.  
