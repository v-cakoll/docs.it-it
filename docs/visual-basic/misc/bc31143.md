...
---
# <a name="method-ltmethodnamegt-does-not-have-a-signature-compatible-with-delegate-ltdelegatenamegt"></a>Metodo '&lt;NomeMetodo&gt;' non ha una firma compatibile con il delegato &lt;'delegatename'&gt;
