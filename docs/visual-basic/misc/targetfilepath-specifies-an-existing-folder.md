...
## <a name="see-also"></a>Vedere anche  
 ...
 [Procedura: spostare una Directory in Visual Basic](https://msdn.microsoft.com/library/0f26d1ef-c0a0-4445-8eb0-9b7d0490411c)  
 [Procedura: rinominare un file](../../visual-basic/developing-apps/programming/drives-directories-files/how-to-rename-a-file.md)  
 [Procedura: rinominare una Directory in Visual Basic](https://msdn.microsoft.com/library/780c7afc-a03c-4b01-865a-510fe331b1cc)
