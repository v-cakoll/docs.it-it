...
---
# <a name="property-cannot-be-declared-ltpropertymodifiergt-because-it-contains-a-private-accessor"></a>Proprietà non può essere dichiarata '&lt;modificatoreproprietà&gt;' perché contiene una funzione di accesso 'Private'
