...
Un elenco di vincoli include sia la [Class (Visual Basic)](../../visual-basic/language-reference/statements/class-statement.md) vincolo e il nome di una classe definita.  
