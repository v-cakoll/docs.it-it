...
Un elenco di vincoli include sia il vincolo [Class (Visual Basic)](../../visual-basic/language-reference/statements/class-statement.md) che il nome di una classe definita.  
