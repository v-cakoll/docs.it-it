...
---
# <a name="39class39-constraint-and-a-specific-class-type-constraint-cannot-be-combined"></a>&#39;Classe&#39; Impossibile combinare il vincolo e un vincolo di tipo di classe specifico
Un elenco di vincoli include sia il [Class (Visual Basic)](http://msdn.microsoft.com/library/0777c6e6-46bc-451b-ad70-57b49d4ef4f7) vincolo e il nome di una classe definita.  
