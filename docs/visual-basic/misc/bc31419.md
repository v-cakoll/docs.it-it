...
---
# <a name="isnot-requires-operands-that-have-reference-types-but-this-operand-has-the-value-type-lttypenamegt"></a>Gli operandi di avere tipi riferimento devono 'IsNot', ma questo operando ha tipo valore '&lt;typename&gt;'.
