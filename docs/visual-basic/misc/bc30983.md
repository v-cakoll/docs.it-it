...
---
# <a name="type-of-variablename-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>Il tipo di ' \<variablename >' è ambiguo perché i limiti del ciclo e la variabile Step non si ampliano allo stesso tipo
