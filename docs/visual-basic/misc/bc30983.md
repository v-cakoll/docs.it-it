...
---
# <a name="type-of-ltvariablenamegt-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>Tipo di '&lt;variablename&gt;' è ambiguo perché i limiti del ciclo e la clausola dell'istruzione non si convertono allo stesso tipo
