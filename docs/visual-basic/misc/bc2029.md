...
---
# <a name="cannot-infer-an-output-file-name-from-resource-only-input-files-provide-the-39out39-option"></a>Non è possibile dedurre un nome di file di output solo input i file di risorse; specificare il &#39; / out &#39; opzione
