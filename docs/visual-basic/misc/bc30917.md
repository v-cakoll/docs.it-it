...
---
# <a name="class-ltclassnamegt-must-declare-a-sub-new-because-the-ltconstructornamegt-in-its-base-class-ltbaseclassnamegt-is-marked-obsolete"></a>Della classe&lt;NomeClasse&gt;' deve dichiarare un 'Sub New' perché il '&lt;nomecostruttore&gt;'nella relativa classe base'&lt;nomeclassebase&gt;' è contrassegnato come obsoleto
