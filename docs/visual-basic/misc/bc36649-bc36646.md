...
---
# <a name="data-types-of-the-type-parameters-in-extension-method-ltmethodnamegt-defined-in-lttypenamegt-cannot-be-inferred-from-these-arguments"></a>I tipi di dati dei parametri di tipo nel metodo di estensione '&lt;NomeMetodo&gt;'definito '&lt;nomeTipo&gt;' non è possibile dedurre da questi argomenti
