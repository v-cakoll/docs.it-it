...
---
# <a name="overload-resolution-failed-because-no-accessible-ltmethodgt-is-most-specific-for-these-argumentslterrorgt"></a>Non è riuscita perché la risoluzione dell'overload non accessibile '&lt;metodo&gt;' è specifico per questi argomenti:&lt;errore&gt;
