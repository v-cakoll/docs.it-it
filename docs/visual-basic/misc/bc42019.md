...
---
# <a name="operands-of-type-object-used-for-operator-ltoperatorsymbolgt-runtime-errors-could-occur"></a>Gli operandi di tipo Object usati per l'operatore '&lt;simbolooperatore&gt;'; potrebbero verificarsi errori di runtime
