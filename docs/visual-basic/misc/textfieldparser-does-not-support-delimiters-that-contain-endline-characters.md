...
È stato fornito un delimitatore che contiene un carattere di fine riga, ma la `TextFieldParser` non supporta delimitatori che contengono caratteri di fine riga.  
