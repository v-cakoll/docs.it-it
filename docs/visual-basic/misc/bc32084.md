...
---
# <a name="type-parameter-typeparametername1-must-have-either-a-new-constraint-or-a-structure-constraint-to-satisfy-the-new-constraint-for-type-parameter-typeparametername2"></a>Il parametro di\<tipo ' nomeparametrotipo1 >' deve contenere un vincolo ' New ' o ' Structure ' per soddisfare il vincolo ' New ' per il parametro di tipo\<' nomeparametrotipo2 >'
