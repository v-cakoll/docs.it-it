...
---
# <a name="elementname-is-ambiguous-because-multiple-kinds-of-members-with-this-name-exist-in-type-typename"></a>'\<ElementName >' è ambiguo perché esistono più tipi di membri con questo nome nel tipo di \<>'\<typeName >'
