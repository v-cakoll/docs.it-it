...
---
# <a name="use-command-line-option-ltoptiongt-or-appropriate-project-settings-instead-of-ltparametergt"></a>Usare l'opzione della riga di comando '&lt;opzione&gt;'o le impostazioni di progetto anziché appropriate'&lt;parametro&gt;'
