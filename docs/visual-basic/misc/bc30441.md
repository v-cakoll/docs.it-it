...
Un'istruzione `Catch` viene visualizzata nel codice senza un'istruzione `End Try` corrispondente. `Catch` devono essere concluse con un'istruzione `End Try` corrispondente.  
