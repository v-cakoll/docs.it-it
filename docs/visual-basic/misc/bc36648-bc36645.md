...
---
# <a name="data-types-of-the-type-parameters-in-method-methodname-cannot-be-inferred-from-these-arguments"></a>Non è possibile dedurre da questi argomenti i tipi di dati dei parametri di\<tipo nel metodo ' methodName >'
Non è possibile dedurre da questi argomenti i tipi di dati dei parametri di\<tipo nel metodo ' methodName >'. Per correggere l'errore, provare a specificare i tipi di dati in modo esplicito.  
