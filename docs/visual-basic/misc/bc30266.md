...
---
# <a name="declaration1-cannot-override-declaration2-because-they-have-different-access-levels"></a>'\<dichiarazione1 >' non può eseguire\<l'override di ' dichiarazione2 >' perché hanno livelli di accesso diversi
