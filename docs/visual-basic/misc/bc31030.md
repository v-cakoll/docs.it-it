...
---
# <a name="project-level-conditional-compilation-constant-constantname-is-not-valid-error"></a>La costante di compilazione condizionale a\<livello di progetto ' constantname >' \<non è valida: errore >
