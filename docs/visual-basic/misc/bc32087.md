...
---
# <a name="overload-resolution-failed-because-no-accessible-ltgenericprocedurenamegt-accepts-this-number-of-type-arguments"></a>Non è riuscita perché la risoluzione dell'overload non accessibile '&lt;nomeroutinegenerica&gt;' accetta questo numero di argomenti tipo
