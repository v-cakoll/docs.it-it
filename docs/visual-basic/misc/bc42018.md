...
---
# <a name="operands-of-type-object-used-for-operator-ltoperatorsymbolgt-use-the-is-operator-to-test-object-identity"></a>Gli operandi di tipo Object usati per l'operatore '&lt;simbolooperatore&gt;'; utilizzare l'operatore 'Is' per verificare l'identità dell'oggetto
