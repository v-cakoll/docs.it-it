...
---
# <a name="expression-recursively-calls-containing-operator-ltoperatorsymbolgt"></a>Espressione in modo ricorsivo chiama l'operatore che lo contiene '&lt;simbolooperatore&gt;'
