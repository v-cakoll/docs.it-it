...
---
# <a name="variable-variablename-is-passed-by-reference-before-it-has-been-assigned-a-value"></a>Variabile '\<nomevariabile >' viene passato per riferimento prima che sia stato assegnato un valore
