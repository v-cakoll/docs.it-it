...
---
# <a name="parameter-type-of-this-unary-operator-must-be-the-containing-type-lttypenamegt"></a>Tipo di parametro dell'operatore unario deve essere di tipo contiene '&lt;typename&gt;'
