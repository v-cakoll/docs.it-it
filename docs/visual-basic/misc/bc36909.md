...
---
# <a name="cannot-infer-a-data-type-for-ltvariablenamegt-because-the-array-dimensions-do-not-match"></a>Non è possibile dedurre un tipo di dati per '&lt;variablename&gt;' perché le dimensioni di matrice non corrispondono
