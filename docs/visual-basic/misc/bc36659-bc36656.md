...
>  Quando non è possibile specificare gli argomenti (ad esempio per gli operatori di query nelle espressioni di query), il messaggio di errore visualizzato non contiene la seconda frase.  
 ...
 Per altre informazioni ed esempi, vedere [i tipi di dati dei parametri di tipo nel metodo '\<NomeMetodo >' non è possibile dedurre da questi argomenti, in quanto non vengono convertiti nello stesso tipo](../../visual-basic/misc/bc36660-bc36657.md).  
