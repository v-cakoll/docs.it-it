...
---
# <a name="extension-method-methodname-has-type-constraints-that-can-never-be-satisfied"></a>Metodo di estensione '\<NomeMetodo >' ha vincoli di tipo non possono mai essere soddisfatti
