...
\<tipo1 > '\<nomeMembro >' nasconde un membro che supportano l'overload dichiarato nella base \<type2 > '\<NomeClasse >. Per eseguire l'overload del metodo di base, quest'ultimo deve essere dichiarato 'Overloads'.  
