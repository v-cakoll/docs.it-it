...
---
# <a name="variable-39ltvariablenamegt39-is-passed-by-reference-before-it-has-been-assigned-a-value-structure-variable"></a>Variabile &#39; &lt;variablename&gt; &#39; viene passato per riferimento prima che sia stato assegnato un valore (struttura variabile)
Variabile '\<variablename >' è passato per riferimento prima che sia stato assegnato un valore. È possibile che venga restituita un'eccezione di riferimento null al runtime. Verificare che la struttura o tutti i membri del riferimento siano inizializzati prima di usarli  
