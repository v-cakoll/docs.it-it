...
---
# <a name="variable-ltvariablenamegt-is-passed-by-reference-before-it-has-been-assigned-a-value-structure-variable"></a>Variabile '&lt;variablename&gt;' viene passato per riferimento prima che sia stato assegnato un valore (variabile di struttura)
