...
---
# <a name="variable-39ltvariablenamegt39-is-passed-by-reference-before-it-has-been-assigned-a-value-structure-variable"></a>Variabile &#39; &lt;variablename&gt;&#39; è passato per riferimento prima che sia stato assegnato un valore (variabile di struttura)
