...
---
# <a name="mybase-cannot-be-used-with-method-methodname-because-it-is-declared-mustoverride"></a>' MyBase ' non può essere usato con il metodo\<' methodName >' perché è dichiarato come ' MustOverride '
