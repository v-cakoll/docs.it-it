...
---
# <a name="type-argument-inference-failed-for-type-parameter-lttypeparameternamegt-of-ltgenericproceduresignaturegt"></a>Inferenza di argomento non è riuscita per il parametro di tipo '&lt;nomeparametrotipo&gt;'di'&lt;firmaroutinegenerica&gt;'
