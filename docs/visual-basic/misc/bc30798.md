...
---
# <a name="ltelementnamegt-for-the-imports-alias-to-ltqualifiedelementnamegt-does-not-refer-to-a-namespace-class-structure-interface-enum-or-module"></a>«&lt;elementname&gt;'per l'alias di Imports per'&lt;nomeelementoqualificato&gt;' non fa riferimento a un Namespace, classe, struttura, interfaccia, enumerazione o modulo
