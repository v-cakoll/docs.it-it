...
- [Operatore ^](../language-reference/operators/exponentiation-operator.md)
- [Tipi di dati numerici](../programming-guide/language-features/data-types/numeric-data-types.md)
