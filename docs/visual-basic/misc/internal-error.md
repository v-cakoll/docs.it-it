...
Si è verificato un malfunzionamento interno in [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)].  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Metodo Raise (oggetto Err)](http://msdn.microsoft.com/library/80ffe307-57f1-4ef5-92d7-8ae7b6ec3f42)
