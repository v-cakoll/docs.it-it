...
---
# <a name="property-ltpropertynamegt-cannot-be-initialized-in-an-object-initializer-expression-because-all-accessible-overloads-require-arguments"></a>Proprietà '&lt;propertyname&gt;' non può essere inizializzato in un'espressione dell'inizializzatore di oggetto perché tutti gli overload accessibili richiedono argomenti
