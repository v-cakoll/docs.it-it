...
---
# <a name="type-lttypenamegt-must-define-operator-ltoperatorgt-to-be-used-in-a-for-statement"></a>Tipo '&lt;nomeTipo&gt;'deve definire l'operatore'&lt;operatore&gt;' da usare in un'istruzione 'For'
