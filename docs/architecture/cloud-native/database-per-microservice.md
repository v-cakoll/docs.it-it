---
title: Database per microservizi
...
ms.locfileid: "76794905"
---
# <a name="database-per-microservice"></a>Database per microservizi
...
**Figura 5-6**. Esecuzione del rollback di una transazione
