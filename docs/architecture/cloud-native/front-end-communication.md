...
| Qualità del servizio | Criteri di ripetizione |
...
## <a name="azure-application-gateway"></a>Gateway applicazione Azure
...
> Al momento della stesura del documento, il livello di utilizzo è in anteprima nel cloud di Azure.
