...
Per gestire i dati nelle applicazioni Docker vengono usate le soluzioni seguenti:
...
I **montaggi di tipo tmpfs** sono essenzialmente cartelle virtuali presenti solo nella memoria dell'host e non vengono mai scritte nel file system. Sono veloci e sicure, ma usano la memoria e sono destinate solo a dati temporanei non persistenti.
