...
> [!NOTE]
> Blazer offre un'alternativa ai Framework JavaScript per la creazione di interfacce utente client avanzate e interattive. Il supporto del blazer sul lato client è ancora in anteprima, quindi per ora non rientra nell'ambito di questo capitolo.
