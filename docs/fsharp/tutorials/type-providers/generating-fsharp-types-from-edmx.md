...
Per ulteriori informazioni sulle stringhe di connessione EDMX, vedere [le stringhe di connessione](https://msdn.microsoft.com/library/ms254494.aspx).
...
2. Copiare e incollare il contenuto dello script del database viene creato il database di studenti, come descritto nel [documentazione di Entity Framework](http://msdn.microsoft.com/data/JJ614587.aspx) nel centro per sviluppatori di dati.
<br />
