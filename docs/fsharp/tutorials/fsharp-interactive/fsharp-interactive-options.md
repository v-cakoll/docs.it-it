...
|**--checked**[**+**&#124;**-**]|Stesso come il **fsc.exe** l'opzione del compilatore. Per altre informazioni, vedere [Opzioni del compilatore](../../language-reference/compiler-options.md).|
...
|**--debug**[**+**&#124;**-**]<br /><br />**--debug:**[**full**&#124;**pdbonly**]<br /><br />**-g**[**+**&#124;**-**]<br /><br />**-g:**[**full**&#124;**pdbonly**]|Stesso come il **fsc.exe** l'opzione del compilatore. Per altre informazioni, vedere [Opzioni del compilatore](../../language-reference/compiler-options.md).|
|**--define:&lt;string&gt;**|Stesso come il **fsc.exe** l'opzione del compilatore. Per altre informazioni, vedere [Opzioni del compilatore](../../language-reference/compiler-options.md).|
...
|**--lib:&lt;folder-list&gt;**<br /><br />**-I:&lt;folder-list&gt;**|Stesso come il **fsc.exe** l'opzione del compilatore. Per altre informazioni, vedere [Opzioni del compilatore](../../language-reference/compiler-options.md).|
...
|**--optimize**[**+**&#124;**-**]|Stesso come il **fsc.exe** l'opzione del compilatore. Per altre informazioni, vedere [Opzioni del compilatore](../../language-reference/compiler-options.md).|
