...
|Funzione|Matrice|Elenco|Sequence|Mappa|Imposta|Descrizione|
|--------|-----|----|--------|---|---|-----------|
...
|distinctBy|||O (1) &#42;|||Restituisce una sequenza che non contiene voci duplicate in base ai confronti di uguaglianza e hash generici alle chiavi che restituisce la funzione di generazione di chiavi specificata. Se un elemento è presente più volte nella sequenza, occorrenze successive vengono ignorate.|
