...
|**-riferimento:&lt;nome file di assembly&gt;**<br /><br />**-r** &lt; **nome file di assembly&gt;**|Rende codice da un assembly F # o .NET Framework disponibili per il codice in fase di compilazione.<br /><br />L'opzione del compilatore è equivalente all'opzione del compilatore c# con lo stesso nome. Per altre informazioni, vedere [ &#47;riferimenti &#40;C&#35; opzioni del compilatore&#41;](https://msdn.microsoft.com/library/yabyz3h4.aspx).|
...
|**-target**: [**exe** &#124; **winexe** &#124; **libreria** &#124; **modulo** ]  **&lt;nome file di output&gt;**|Specifica il tipo e il nome del codice compilato generato.<ul><li>**file exe** significa che un'applicazione console.<br /></li><li>**winexe** significa che un'applicazione Windows, che è diverso dall'applicazione console, in quanto non dispone di flussi di input/output standard (stdin, stdout e stderr) definiti.<br /></li><li>**libreria** è un assembly senza un punto di ingresso.<br /></li><li>**modulo** è un modulo .NET Framework (con estensione netmodule), che può essere combinato in un secondo momento con altri moduli in un assembly.<br /></li><ul/>L'opzione del compilatore è equivalente all'opzione del compilatore c# con lo stesso nome. Per altre informazioni, vedere [ &#47;destinazione &#40;C&#35; opzioni del compilatore&#41;](https://msdn.microsoft.com/library/6h25dztx.aspx).|
