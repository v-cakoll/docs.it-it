...
Per altre informazioni, vedere [Code Formatting Guidelines](../../style-guide/formatting.md) (Linee guida per la formattazione del codice) e [Verbose Syntax](../verbose-syntax.md) (Sintassi dettagliata).
