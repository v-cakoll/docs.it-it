...
|[Tipi di base](basic-types.md)|Descrive i tipi di base fondamentali usati nel linguaggio F #. Specifica anche i tipi .NET corrispondenti e i valori minimi e massimi per ogni tipo.|
