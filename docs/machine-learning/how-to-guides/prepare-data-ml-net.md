...
Normalizzare i dati usando la normalizzazione min-max e il metodo [`NormalizeMinMax`](xref:Microsoft.ML.NormalizationCatalog.NormalizeMinMax*).
...
|Transform | Description | Risultato
|--|--|--|
