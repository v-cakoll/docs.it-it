...
[.NET API per Windows Phone Silverlight](https://docs.microsoft.com/en-us/previous-versions/windows/apps/jj207211\(v=vs.105\))  
...
[Introduzione a siti Web ASP.NET](http://www.asp.net/get-started/websites)  
