---
title: "Errori di inizializzazione di .NET Framework: gestione dell'interfaccia utente"
ms.date: 03/30/2017
helpviewer_keywords:
...
Messaggio di errore tipico per errori di inizializzazione  
...
-   Per le applicazioni .NET Framework 3.5 e versioni precedenti: configurare l'applicazione per supportare .NET Framework 4 o 4.5. Vedere le [istruzioni](../../../docs/framework/migration-guide/how-to-configure-an-app-to-support-net-framework-4-or-4-5.md).  
...
## <a name="includewin8includeswin8-mdmd-behavior-and-ui"></a>Comportamento e interfaccia utente di [!INCLUDE[win8](../../../includes/win8-md.md)]  
...
Prompt per l'installazione di .NET Framework 3.5 su richiesta  
