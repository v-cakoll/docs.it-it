...
|Membro|Descrizione|  
|------------|-----------------|  
|`MDPreserveLocalRefsNone`|Non mantenere i riferimenti locali.|  
|`MDPreserveLocalTypeRef`|Mantenere i riferimenti al tipo locale.|  
|`MDPreserveLocalMemberRef`|Mantenere i riferimenti membro locale.|  
