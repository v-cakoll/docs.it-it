...
ms.locfileid: "33445144"
---
# <a name="iceegengetilsection-method"></a>Metodo ICeeGen::GetIlSection
Ottiene la sezione di codice Microsoft intermediate language base a cui fa riferimento l'handle specificato.  
...
#### <a name="parameters"></a>Parametri  
 `section`  
 [in] La sezione per ottenere l'handle.  
