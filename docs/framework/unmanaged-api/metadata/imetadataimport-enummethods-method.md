...
## <a name="parameters"></a>Parametri  
 ...
 `cMax`  
 in Dimensione massima della `rMethods` matrice MethodDef.  
...
|HRESULT|Descrizione|  
|-------------|-----------------|  
|`S_OK`|`EnumMethods`la restituzione è riuscita.|  
|`S_FALSE`|Nessun token MethodDef da enumerare. In tal caso, `pcTokens` è zero.|  
