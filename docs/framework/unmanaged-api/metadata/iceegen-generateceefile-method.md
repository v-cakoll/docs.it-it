...
Genera un file di base di codice che contiene il codice base attualmente caricato in [ICeeGen](../../../../docs/framework/unmanaged-api/metadata/iceegen-interface.md) interfaccia.  
