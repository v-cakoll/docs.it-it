...
#### <a name="parameters"></a>Parametri  
 ...
 `pcSignatures`  
 [out] Il numero di token di firma restituiti in `rSignatures`.  
...
|`S_FALSE`|Non sono presenti token da enumerare. In tal caso, `pcSignatures` è zero.|  
  
## <a name="remarks"></a>Note  
 Vengono creati i token di firma di [GetTokenFromSig](../../../../docs/framework/unmanaged-api/metadata/imetadataemit-gettokenfromsig-method.md) metodo.  
