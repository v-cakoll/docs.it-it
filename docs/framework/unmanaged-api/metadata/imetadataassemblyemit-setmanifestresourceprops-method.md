...
## <a name="parameters"></a>Parametri  
 `mr`  
 in Token che specifica la `ManifestResource` struttura dei metadati da modificare.  
  
 `tkImplementation`  
 in Token, di tipo `File` o `AssemblyRef` , che esegue il mapping al provider di risorse.  
...
## <a name="remarks"></a>Commenti  
 Per creare una `ManifestResource` struttura di metadati, usare il metodo [IMetaDataAssemblyEmit::D efinemanifestresource](imetadataassemblyemit-definemanifestresource-method.md) .  
