...
#### <a name="parameters"></a>Parametri  
 ...
 `td`  
 [in] Il token di TypeDef con token MethodDef che rappresentano le implementazioni di interfaccia sono da enumerare.  
 ...
 `pcImpls`  
 [out] Il numero effettivo di token restituiti in `rImpls`.  
