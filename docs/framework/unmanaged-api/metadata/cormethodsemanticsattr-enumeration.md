...
|Membro|Descrizione|  
|------------|-----------------|  
|`msSetter`|Specifica che il metodo è una funzione di accesso `set` per una proprietà.|  
|`msGetter`|Specifica che il metodo è una funzione di accesso `get` per una proprietà.|  
