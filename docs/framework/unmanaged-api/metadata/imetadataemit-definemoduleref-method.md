...
## <a name="parameters"></a>Parametri  
 `szName`  
 [in] Nome dell'altro file di metadati, in genere una DLL. Questo è solo il nome del file. Non utilizzare un nome di percorso completo.  
  
 `pmur`  
 [fuori] Token `mdModuleRef` assegnato.  
