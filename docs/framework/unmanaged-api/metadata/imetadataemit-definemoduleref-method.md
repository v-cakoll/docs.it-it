...
#### <a name="parameters"></a>Parametri  
 `szName`  
 [in] Il nome di altri file di metadati, in genere una DLL. Questo è solo il nome del file. Non utilizzare un nome e percorso completo.  
  
 `pmur`  
 [out] L'oggetto assegnato `mdModuleRef` token.  
