...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo GetFileMapping](../../../../docs/framework/unmanaged-api/metadata/imetadatainfo-getfilemapping-method.md)|Ottiene l'area della memoria del file mappato e il tipo di mapping.|  
