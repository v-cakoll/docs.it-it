...
## <a name="parameters"></a>Parametri  
 ...
 `eltInfo`  
 [in] Handle opaco che rappresenta le informazioni su un determinato stack frame. Il profiler deve fornire lo stesso `eltInfo` fornito dalla funzione [FunctionEnter3WithInfo](functionenter3withinfo-function.md) .  
