...
- [DoStackSnapshot](../../../../docs/framework/unmanaged-api/profiling/icorprofilerinfo2-dostacksnapshot-method.md)  
 ...
 Per ulteriori informazioni, vedere la voce relativa al [motivo della CORPROF_E_UNSUPPORTED_CALL_SEQUENCE](https://go.microsoft.com/fwlink/?LinkId=169156) nel Blog dell'API di profilatura CLR.  
