...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Alloc (metodo)](../../../../docs/framework/unmanaged-api/profiling/imethodmalloc-alloc-method.md)|Tenta di allocare una quantità di memoria specificata per il corpo di una nuova funzione MSIL.|  
