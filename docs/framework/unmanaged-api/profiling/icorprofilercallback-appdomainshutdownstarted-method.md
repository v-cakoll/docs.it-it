...
Notifica al profiler che un dominio applicazione viene scaricato da un processo.  
...
## <a name="remarks"></a>Osservazioni  
 Il valore di `appDomainId` non è valido per tutte le richieste di informazioni dopo la `AppDomainShutdownStarted` restituzione del metodo. si tratta dell'ultima possibilità del profiler di ottenere informazioni sul dominio applicazione.  
