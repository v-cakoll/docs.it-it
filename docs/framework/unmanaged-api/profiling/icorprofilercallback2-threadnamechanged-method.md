...
Notifica all'Code Profiler che il nome di un thread è stato modificato.  
...
## <a name="parameters"></a>Parametri  
 ...
 `cchName`  
 in Lunghezza del nuovo nome del thread.  
  
 `name`  
 in Nuovo nome del thread. Il nome non è con terminazione null.  
