...
#### <a name="parameters"></a>Parametri  
 ...
 `ppImportScope`  
 Riceve il puntatore a [interfaccia IMetaDataImport2](../../../../docs/framework/unmanaged-api/metadata/imetadataimport2-interface.md) interfaccia per l'ambito indicato.  
