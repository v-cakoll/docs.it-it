...
Chiamata eseguita per impostare gli attributi personalizzati a livello di assembly.  
...
#### <a name="parameters"></a>Parametri  
 ...
 `bAllowMulti`  
 TRUE se più attributi devono essere inviati.  
