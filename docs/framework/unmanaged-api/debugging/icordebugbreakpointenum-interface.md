...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](../../../../docs/framework/unmanaged-api/debugging/icordebugbreakpointenum-next-method.md)|Ottiene il numero specificato di `ICorDebugBreakpoint` istanze nell'enumerazione, a partire dalla posizione corrente.|  
