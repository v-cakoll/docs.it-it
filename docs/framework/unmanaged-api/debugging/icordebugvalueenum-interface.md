...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](../../../../docs/framework/unmanaged-api/debugging/icordebugvalueenum-next-method.md)|Ottiene il numero specificato di `ICorDebugValue` istanze dall'enumerazione, iniziando in corrispondenza della posizione corrente.|  
