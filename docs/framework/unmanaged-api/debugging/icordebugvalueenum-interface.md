...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](../../../../docs/framework/unmanaged-api/debugging/icordebugvalueenum-next-method.md)|Ottiene il numero specificato di `ICorDebugValue` istanze nell'enumerazione, a partire dalla posizione corrente.|  
