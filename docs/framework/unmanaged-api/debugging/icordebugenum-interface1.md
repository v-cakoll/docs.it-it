...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Clone (metodo)](../../../../docs/framework/unmanaged-api/debugging/icordebugenum-clone-method.md)|Crea una copia di questo `ICorDebugEnum` oggetto.|  
|[GetCount (metodo)](../../../../docs/framework/unmanaged-api/debugging/icordebugenum-getcount-method.md)|Ottiene il numero di elementi nell'enumerazione.|  
|[Reset (metodo)](../../../../docs/framework/unmanaged-api/debugging/icordebugenum-reset-method.md)|Sposta il cursore all'inizio dell'enumerazione.|  
