...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](../../../../docs/framework/unmanaged-api/debugging/icordebugstepperenum-next-method.md)|Ottiene il numero specificato di `ICorDebugStepper` istanze nell'enumerazione, a partire dalla posizione corrente.|  
