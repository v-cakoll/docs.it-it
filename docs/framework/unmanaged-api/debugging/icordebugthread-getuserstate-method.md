...
## <a name="remarks"></a>Note  
 Quando viene esaminato dal programma che viene eseguito il debug, lo stato utente del thread è lo stato del thread. Un thread può avere più bit di stato impostato.  
