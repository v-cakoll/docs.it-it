...
## <a name="parameters"></a>Parametri  
 `celt`  
 in Numero di `ICorDebugThread` istanze da recuperare.  
  
 `threads`  
 out Matrice di puntatori, ciascuno dei quali punta a un `ICorDebugThread` oggetto che rappresenta un thread.  
