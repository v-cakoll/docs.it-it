...
---
# <a name="icordebugeditandcontinuesnapshotgetrwdatarva-method"></a>Metodo ICorDebugEditAndContinueSnapshot::GetRwDataRVA
`GetRwDataRVA` è obsoleto. Non chiamare questo metodo.  
