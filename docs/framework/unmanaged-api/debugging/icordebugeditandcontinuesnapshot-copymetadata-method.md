...
---
# <a name="icordebugeditandcontinuesnapshotcopymetadata-method"></a>Metodo ICorDebugEditAndContinueSnapshot::CopyMetaData
`CopyMetaData` è obsoleto. Non chiamare questo metodo.  
