...
Notifica al debugger che è stato creato un dominio applicazione.  
...
#### <a name="parameters"></a>Parametri  
 ...
 `pAppDomain`  
 [in] Un puntatore a un oggetto ICorDebugAppDomain che rappresenta il dominio applicazione che è stato creato.  
