...
---
# <a name="icordebugeditandcontinuesnapshotsetilmap-method"></a>Metodo ICorDebugEditAndContinueSnapshot::SetILMap
`SetILMap` è obsoleto. Non chiamare questo metodo.  
