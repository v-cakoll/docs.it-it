...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo EnumerateVariableHomes](../../../../docs/framework/unmanaged-api/debugging/icordebugcode4-enumeratevariablehomes-method.md)|Ottiene un enumeratore per le variabili e gli argomenti locali in una funzione.|  
