...
## <a name="parameters"></a>Parametri  
 `celt`  
 in Numero di `ICorDebugProcess` istanze da recuperare.  
  
 `processes`  
 out Matrice di puntatori, ciascuno dei quali punta a un `ICorDebugProcess` oggetto che rappresenta un processo.  
