...
ms.locfileid: "73136596"
---
# <a name="icordebugmodulecreatebreakpoint-method"></a>Metodo ICorDebugModule::CreateBreakpoint
Questo metodo non è stato implementato nella versione corrente del .NET Framework.  
