...
---
# <a name="icordebugeditandcontinuesnapshot-interface"></a>Interfaccia ICorDebugEditAndContinueSnapshot

`ICorDebugEditAndContinueSnapshot` è obsoleto. Non usare questa interfaccia.  
