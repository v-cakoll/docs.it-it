...
|[Metodo GetCode](icordebugvariablehome-getcode-method.md)|Ottiene l'istanza "ICorDebugCode" che contiene questo oggetto `ICorDebugVariableHome`.|  
...
## <a name="example"></a>Esempio  
 Il frammento di codice seguente usa l'oggetto [interfacce icordebugcode4](icordebugcode4-interface.md) denominato `pCode4`.  
