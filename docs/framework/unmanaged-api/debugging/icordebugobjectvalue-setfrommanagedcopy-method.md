...
---
# <a name="icordebugobjectvaluesetfrommanagedcopy-method"></a>Metodo ICorDebugObjectValue::SetFromManagedCopy
`SetFromManagedCopy` è obsoleto. Non chiamare questo metodo.  
