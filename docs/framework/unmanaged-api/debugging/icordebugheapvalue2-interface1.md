...
|Metodo|Descrizione|  
|------------|-----------------|  
|[CreateHandle (metodo)](../../../../docs/framework/unmanaged-api/debugging/icordebugheapvalue2-createhandle-method.md)|Crea un handle del tipo specificato per questo `ICorDebugHeapValue2` oggetto.|  
