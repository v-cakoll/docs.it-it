...
## <a name="remarks"></a>Osservazioni  
 Questo metodo non viene chiamato fino a quando non viene inizializzata la Common Language Runtime. La maggior parte dei metodi [ICorDebug](icordebug-interface.md) restituirà CORDBG_E_NOTREADY prima del `CreateProcess` callback.  
