...
---
# <a name="icordebugeditandcontinueerrorinfogeterrorcode-method"></a>Metodo ICorDebugEditAndContinueErrorInfo::GetErrorCode
`GetErrorCode` è obsoleto. Non chiamare questo metodo.  
