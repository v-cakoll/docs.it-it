...
## <a name="parameters"></a>Parametri  
 ...
 Il `ofReadOnly` flag dell'enumerazione [CorOpenFlags](../metadata/coropenflags-enumeration.md) viene usato per richiedere l'accesso in sola lettura ai metadati in questo file.  
