...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](icordebugmoduleenum-next-method.md)|Ottiene il numero specificato di istanze di `ICorDebugModule` dall'enumerazione, a partire dalla posizione corrente.|  
