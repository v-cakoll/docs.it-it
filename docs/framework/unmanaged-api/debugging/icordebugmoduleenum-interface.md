...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](../../../../docs/framework/unmanaged-api/debugging/icordebugmoduleenum-next-method.md)|Ottiene il numero specificato di `ICorDebugModule` istanze nell'enumerazione, a partire dalla posizione corrente.|  
