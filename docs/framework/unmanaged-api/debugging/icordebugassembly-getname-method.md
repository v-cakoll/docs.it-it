...
Ottiene il nome dell'assembly rappresentato da questa `ICorDebugAssembly` istanza.  
...
## <a name="remarks"></a>Osservazioni  
 Il `GetName` metodo restituisce il percorso completo e il nome file dell'assembly.  
