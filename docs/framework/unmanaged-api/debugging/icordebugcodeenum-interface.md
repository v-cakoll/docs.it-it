...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](icordebugcodeenum-next-method.md)|Ottiene il numero specificato di istanze di `ICorDebugCode` dall'enumerazione, a partire dalla posizione corrente.|  
