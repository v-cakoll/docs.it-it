...
Ottiene un valore che indica se la catena è in esecuzione il codice gestito.  
...
#### <a name="parameters"></a>Parametri  
 `pManaged`  
 [out] `true` se la catena è in esecuzione il codice gestito; in caso contrario, `false`.  
