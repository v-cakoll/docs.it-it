...
|`ver_ICorDebugGenericValue`|[ICorDebugGenericValueICorDebugGenericValue](icordebuggenericvalue-interface.md)|1.0|  
...
|`ver_ICorDebugArrayValue`|[ICorDebugArrayValueICorDebugArrayValue](icordebugarrayvalue-interface.md)|1.0|  
...
|`ver_ICorDebugFrameEnum`|[ICorDebugFrameEnumICorDebugFrameEnum](icordebugframeenum-interface.md)|1.0|  
...
|`ver_ICorDebugEditAndContinueSnapshot`|[ICorDebugEditAndContinueSnapshotICorDebugEditAndContinueSnapshot](icordebugeditandcontinuesnapshot-interface.md)|1.0|  
...
|`ver_ICorDebugEval2`|Il "ICorDebugEval2".|2.0|  
...
|`ver_ICorDebugStackWalk`|[ICorDebugStackWalkICorDebugStackWalk](icordebugstackwalk-interface.md)|4|  
...
## <a name="remarks"></a>Osservazioni  
 Un debugger può `CorDebugInterfaceVersion` utilizzare l'enumerazione nella funzione [CreateDebuggingInterfaceFromVersion](../../../../docs/framework/unmanaged-api/hosting/createdebugginginterfacefromversion-function.md) per specificare la versione più recente di .NET Framework supportata dal debugger.  
...
- .NET Framework 4 introduce una combinazione di versioni dell'interfaccia. Ad esempio, sia `ICorDebugThread3` che `ICorDebugThread4` vengono visualizzate come terza e quarta versione dell'interfaccia `ICorDebugThread`. .NET Framework 4 introduce inoltre la `ICorDebugStackWalk` prima versione dell'interfaccia `ICorDebugNativeFrame` e`ICorDebugNativeFrame2`la seconda versione dell'interfaccia ( ).  
