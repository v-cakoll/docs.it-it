...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](icordebugframeenum-next-method.md)|Ottiene il numero specificato di `ICorDebugFrame` istanze dall'enumerazione, a partire dalla posizione corrente.|  
