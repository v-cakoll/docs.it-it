...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](../../../../docs/framework/unmanaged-api/debugging/icordebugframeenum-next-method.md)|Ottiene il numero specificato di `ICorDebugFrame` istanze nell'enumerazione, a partire dalla posizione corrente.|  
