...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](icordebugframeenum-next-method.md)|Ottiene il numero specificato di istanze di `ICorDebugFrame` dall'enumerazione, a partire dalla posizione corrente.|  
