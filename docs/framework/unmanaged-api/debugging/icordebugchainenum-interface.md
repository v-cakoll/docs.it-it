...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](icordebugchainenum-next-method.md)|Ottiene il numero specificato di istanze di `ICorDebugChain` dall'enumerazione, a partire dalla posizione corrente.|  
