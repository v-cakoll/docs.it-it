...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo Next](icordebugchainenum-next-method.md)|Ottiene il numero specificato di `ICorDebugChain` istanze dall'enumerazione, a partire dalla posizione corrente.|  
