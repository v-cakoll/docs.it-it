...
#### <a name="parameters"></a>Parametri  
 `ppChain`  
 [out] Un puntatore all'indirizzo di un oggetto ICorDebugChain che rappresenta la successiva catena di frame per il thread. Se si tratta dell'ultima catena `ppChain` è null.  
