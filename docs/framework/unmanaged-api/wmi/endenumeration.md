...
Una chiamata alla funzione `EndEnumeration` non è obbligatoria, ma è consigliabile perché rilascia le risorse associate all'enumerazione. Tuttavia, le risorse vengono deallocate automaticamente quando viene avviata l'enumerazione successiva o l'oggetto viene rilasciato.
