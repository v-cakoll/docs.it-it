...
Crea una nuova classe o ne aggiorna uno esistente.  
...
L'utente non può creare classi con nomi che iniziano o terminano con chacater un carattere di sottolineatura
