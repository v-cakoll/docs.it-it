...
`pInst`\
[in] Un puntatore all'istanza da scrivere.
...
|---------|---------|---------|
| `WBEM_FLAG_USE_AMENDED_QUALIFIERS` | 0x20000 | Se impostato, WMI non archivia i qualificatori con il **modificato** flavor. <br> Se non impostato, si presuppone che non viene localizzato con questo oggetto e tutti i qualificatori vengono archiviati con questa istanza. |
