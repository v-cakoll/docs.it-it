...
|---------|---------|
| [BeginEnumeration](beginenumeration.md) | Reimposta l'enumeratore all'inizio di un'enumerazione di proprietà dell'oggetto WMI. |
| [BeginMethodEnumeration](beginmethodenumeration.md) |  Avvia un'enumerazione dei metodi disponibili per un oggetto. |
| [BlessIWbemServices](blessiwbemservices.md) | Indica se le credenziali utente di consentono l'accesso a una classe IWbemServices specificata. |
| [BlessIWbemServicesObject](blessiwbemservicesobject.md) | Indica se le credenziali utente di consentono l'accesso a un oggetto servizio IWbem specificato. |
| [Clone](clone.md) | Restituisce un nuovo oggetto che è un clone completo dell'oggetto corrente. |
| [CloneEnumWbemClassObject](cloneenumwbemclassobject.md) | Crea una copia logica di un enumeratore, mantenendo la posizione corrente nell'enumerazione. |
| [CompareTo](compareto.md) | Confronta un oggetto a un altro oggetto di gestione di Windows. |
...
| [Delete](delete.md) | Elimina una proprietà specificata da una definizione di classe e tutti i relativi qualificatori. |
| [DeleteMethod](deletemethod.md) | Elimina un metodo specificato da una definizione di classe CIM. |
| [EndEnumeration](endenumeration.md) | Termina una sequenza di enumerazione. | 
| [EndMethodEnumeration](endmethodenumeration.md) | Termina una sequenza di enumerazione avviata chiamando il [BeginMethodEnumeration funzione](beginmethodenumeration.md). |
| [ExecNotificationQueryWmi](execnotificationquerywmi.md) | Esegue una query per la ricezione di eventi. |
| [ExecQueryWmi](execquerywmi.md) | Esegue una query per recuperare gli oggetti. |
| [FormatFromRawValue](formatfromrawvalue.md) | Converte un valore di dati delle prestazioni non elaborati nel formato specificato o due valori di tali dati se la conversione di formato è basato sul tempo. | 
| [Get](get.md) | Recupera un valore della proprietà specificata, se esistente. |
...
| [GetMethodQualifierSet](getmethodqualifierset.md) | Recupera il qualificatore impostato per un metodo specifico. |
