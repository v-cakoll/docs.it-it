...
|Metodo|Descrizione|  
|------------|-----------------|  
|[GetSymbolSearchInfo (metodo)](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedreadersymbolsearchinfo-getsymbolsearchinfo-method.md)|Ottiene informazioni sui simboli di ricerca.|  
|[GetSymbolSearchInfoCount (metodo)](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedreadersymbolsearchinfo-getsymbolsearchinfocount-method.md)|Ottiene un conteggio delle informazioni di ricerca di simboli.|  
