...
|[Metodo OpenMethod2](../../../../docs/framework/unmanaged-api/diagnostics/isymunmanagedwriter3-openmethod2-method.md)|Apre un metodo e fornisce l'offset di sezione reale nell'immagine.|  
