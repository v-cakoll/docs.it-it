...
Immette la sezione critica rappresentata dall'istanza corrente di [IHostCrst](ihostcrst-interface.md) .  
...
|HRESULT|Descrizione|  
|-------------|-----------------|  
|S_OK|`Enter`la restituzione è riuscita.|  
...
## <a name="remarks"></a>Osservazioni  
 `Enter`rispecchia la `EnterCriticalSection` funzione Win32.  
