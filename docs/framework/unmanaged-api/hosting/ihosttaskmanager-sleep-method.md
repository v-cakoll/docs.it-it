...
## <a name="parameters"></a>Parametri  
 ...
 `option`  
 in Uno dei valori di enumerazione [WAIT_OPTION](wait-option-enumeration.md) , che indica l'azione che l'host deve eseguire se questa azione si blocca.  
  
## <a name="return-value"></a>Valore restituito  
  
|HRESULT|Description|  
|-------------|-----------------|  
|S_OK|`Sleep`la restituzione è riuscita.|  
