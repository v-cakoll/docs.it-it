...
## <a name="parameters"></a>Parametri  
 `operation`  
 in Uno dei valori di [EClrOperation](../../../../docs/framework/unmanaged-api/hosting/eclroperation-enumeration.md) , che indica l'operazione di Common Language Runtime (CLR) per la quale impostare un timeout. Sono supportati i valori seguenti:  
...
|HRESULT|Descrizione|  
|-------------|-----------------|  
|S_OK|`SetTimeout` ha restituito un esito positivo.|  
