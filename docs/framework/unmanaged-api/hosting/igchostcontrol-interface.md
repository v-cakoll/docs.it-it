...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo RequestVirtualMemLimit](../../../../docs/framework/unmanaged-api/hosting/igchostcontrol-requestvirtualmemlimit-method.md)|Richiede all'host di modificare i limiti di memoria virtuale.|  
