...
ms.locfileid: "73133706"
---
# <a name="net-framework-4-hosting-global-static-functions"></a>Funzioni statiche globali di hosting di .NET Framework 4
Il .NET Framework 4 introduce un nuovo metodo esportato in MSCorEE. dll: [CLRCreateIntstance](../../../../docs/framework/unmanaged-api/hosting/clrcreateinstance-function.md).  
