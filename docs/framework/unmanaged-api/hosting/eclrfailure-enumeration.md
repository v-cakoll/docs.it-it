...
|`FAIL_AccessViolation`|È stato effettuato un tentativo di leggere o scrivere nella memoria protetta. Non supportato nel [!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)].|  
