...
Notifica al Common Language Runtime (CLR) che l'attività rappresentata dall'istanza corrente di [ICLRTask](iclrtask-interface.md) sta per terminare e tenta di arrestare normalmente l'attività.  
...
|HRESULT|Descrizione|  
|-------------|-----------------|  
|S_OK|`ExitTask`la restituzione è riuscita.|  
