...
Indica al Common Language Runtime (CLR) di associare il valore dell'identificatore specificato all'attività rappresentata dall'istanza di [ICLRTask](iclrtask-interface.md) corrente.  
...
## <a name="parameters"></a>Parametri  
 `Asked`  
 in Identificatore univoco per la Common Language Runtime da associare all'attività rappresentata dall' `ICLRTask` istanza corrente.  
  
## <a name="return-value"></a>Valore restituito  
  
|HRESULT|Descrizione|  
|-------------|-----------------|  
|S_OK|`SetTaskIdentifier`la restituzione è riuscita.|  
