...
## <a name="remarks"></a>Note  
 Un host potrebbe essere necessario controllo esclusivo del numero di thread allocato a servire le richieste dei / o, per motivi, ad esempio la scalabilità, prestazioni o implementazione. Per questo motivo, l'host non è necessaria per implementare `GetMinThreads`. In questo caso, l'host deve restituire E_NOTIMPL da questo metodo.  
