...
|HRESULT|Descrizione|  
|-------------|-----------------|  
|S_OK|`RevertToSelf` ha restituito un esito positivo.|  
...
## <a name="remarks"></a>Note  
 `RevertToSelf` viene chiamato per tornare al token del thread originale, dopo una chiamata precedente al metodo [ImpersonateLoggedOnUser](../../../../docs/framework/unmanaged-api/hosting/ihostsecuritymanager-impersonateloggedonuser-method.md) .  
