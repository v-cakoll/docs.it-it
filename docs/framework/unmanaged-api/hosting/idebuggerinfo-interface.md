...
|Metodo|Descrizione|  
|------------|-----------------|  
|[Metodo IsDebuggerAttached](../../../../docs/framework/unmanaged-api/hosting/idebuggerinfo-isdebuggerattached-method.md)|Ottiene un valore che indica se un debugger gestito è collegato a questo processo.|  
