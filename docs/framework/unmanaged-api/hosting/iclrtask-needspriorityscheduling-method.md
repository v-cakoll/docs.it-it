...
Ottiene un valore che indica se l'attività corrente, che viene disattivata, deve essere contrassegnata come priorità elevata per la ripianificazione.  
...
## <a name="parameters"></a>Parametri  
 ...
 [out] `true`, se l'host deve tentare di ripianificare l'istanza dell'attività corrente il prima possibile; in caso contrario, `false`.  
  
## <a name="return-value"></a>Valore restituito  
  
|HRESULT|Descrizione|  
|-------------|-----------------|  
|S_OK|`NeedsPriorityRescheduling` ha restituito un esito positivo.|  
