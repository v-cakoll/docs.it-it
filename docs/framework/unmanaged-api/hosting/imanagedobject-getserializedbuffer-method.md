...
Ottiene la rappresentazione di stringa di questo oggetto gestito.  
...
## <a name="remarks"></a>Osservazioni  
 Il `GetSerializedBuffer` metodo serializza l'oggetto in modo che possa essere sottoposto a marshalling nel client.  
