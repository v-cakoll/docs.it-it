...
ms.locfileid: "33428494"
---
# <a name="ehostapplicationpolicy-enumeration"></a>Enumerazione EHostApplicationPolicy
Indica come modificare un [IHostAssemblyManager](../../../../docs/framework/unmanaged-api/hosting/ihostassemblymanager-interface.md) oggetto di interfaccia. Questa enumerazione è stata deprecata.  
