...
Imposta l'istanza corrente di [IHostManualEvent](../../../../docs/framework/unmanaged-api/hosting/ihostmanualevent-interface.md) su uno stato segnalato.  
...
|HRESULT|Descrizione|  
|-------------|-----------------|  
|S_OK|`Set` ha restituito un esito positivo.|  
