...
Diverse estensioni di markup vengono implementate dai servizi XAML di .NET Framework per il supporto del linguaggio XAML. Le estensioni di markup corrispondono a parti della specifica di XAML come linguaggio. In genere, queste estensioni sono identificabili dal prefisso `x:` nella sintassi come illustrato nell'utilizzo comune. Le implementazioni dei servizi XAML .NET Framework per questi elementi del linguaggio XAML derivano tutte dalla classe base <xref:System.Windows.Markup.MarkupExtension>.
...
### <a name="the-parameterless-constructor"></a>Costruttore senza parametri
...
## <a name="attributing-for-a-custom-markup-extension"></a>Assegnazione di un'estensione di markup personalizzata
...
## <a name="serialization-of-markup-extension-usages"></a>Serializzazione degli utilizzi dell'estensione di markup
