...
Questo esempio usa la proprietà [DataTemplate. resources](xref:System.Windows.FrameworkTemplate.Resources%2A) . Le risorse definite in tale sezione vengono condivise dagli elementi all'interno del <xref:System.Windows.DataTemplate>.
