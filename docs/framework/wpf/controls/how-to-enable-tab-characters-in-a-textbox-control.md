...
In questo esempio viene illustrato come abilitare l'accettazione dei caratteri di tabulazione come input normale in un <xref:System.Windows.Controls.TextBox> controllo.  
  
## <a name="example"></a>Esempio  
 Per abilitare l'accettazione dei caratteri di tabulazione come input in un <xref:System.Windows.Controls.TextBox> , impostarne il <xref:System.Windows.Controls.Primitives.TextBoxBase.AcceptsTab%2A> dell'attributo **true**.  
