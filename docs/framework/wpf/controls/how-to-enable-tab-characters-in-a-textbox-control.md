...
In questo esempio viene illustrato come abilitare l'accettazione di caratteri di tabulazione come input normale in un <xref:System.Windows.Controls.TextBox> controllo.  
  
## <a name="example"></a>Esempio  
 Per abilitare l'accettazione di caratteri di tabulazione come input in un <xref:System.Windows.Controls.TextBox> di controllo, impostare il <xref:System.Windows.Controls.Primitives.TextBoxBase.AcceptsTab%2A> attributo **true**.  
