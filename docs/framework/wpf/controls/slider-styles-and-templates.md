...
## <a name="slider-parts"></a>Parti del controllo Slider  
 La tabella seguente elenca le parti denominate di <xref:System.Windows.Controls.Slider> controllo.  
...
|PART_SelectionRange|<xref:System.Windows.FrameworkElement>|L'elemento che viene visualizzato un intervallo di selezione lungo il <xref:System.Windows.Controls.Slider>.  L'intervallo di selezione è visibile solo se il <xref:System.Windows.Controls.Slider.IsSelectionRangeEnabled%2A> è di proprietà `true`.|  
  
## <a name="slider-states"></a>Stati di dispositivo di scorrimento  
 La tabella seguente elenca gli stati visivi il <xref:System.Windows.Controls.Slider> controllo.  
...
## <a name="slider-controltemplate-example"></a>Esempio di ControlTemplate dispositivo di scorrimento  
