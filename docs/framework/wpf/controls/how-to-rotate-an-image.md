...
---
# <a name="how-to-rotate-an-image"></a>Procedura: Ruotare un'immagine
Questo esempio illustra come ruotare un'immagine di 90 gradi tramite un <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> proprietà di un <xref:System.Windows.Media.Imaging.BitmapImage>.  
