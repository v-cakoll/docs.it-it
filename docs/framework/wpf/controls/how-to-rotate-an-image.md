...
In questo esempio viene illustrato come ruotare di 90 gradi un'immagine utilizzando un <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> proprietà di un <xref:System.Windows.Media.Imaging.BitmapImage>.  
