...
<xref:System.Windows.Controls.TabControl>elementi di visualizzare il contenuto in pagine discrete accessibile selezionando la scheda appropriata. Ogni scheda contiene un <xref:System.Windows.Controls.TabItem>.  
