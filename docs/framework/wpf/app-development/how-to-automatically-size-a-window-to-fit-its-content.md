...
In questo esempio viene illustrato come impostare il <xref:System.Windows.Window.SizeToContent%2A> proprietà per specificare come una finestra viene ridimensionata per adattarla al contenuto.  
