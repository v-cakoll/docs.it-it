...
## <a name="wpf-plug-in-for-firefox"></a>Plug-in per Firefox WPF  
 ...
 .NET Framework 4 non include il [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] plug-in per Firefox. Tuttavia, se entrambi i [!INCLUDE[net_v35_short](../../../../includes/net-v35-short-md.md)] e sono installati .NET Framework 4, il plug-in per Firefox WPF viene installato con il [!INCLUDE[net_v35_short](../../../../includes/net-v35-short-md.md)]. Pertanto le applicazioni .NET Framework 4 verranno eseguito comunque perché l'Host WPF caricherà la versione corretta del framework. Per altre informazioni, vedere [Host WPF (PresentationHost.exe)](wpf-host-presentationhost-exe.md).  
