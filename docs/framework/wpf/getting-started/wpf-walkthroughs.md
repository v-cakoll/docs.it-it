...
|Titolo|Descrizione|  
|-----------|-----------------|  
|[Procedura dettagliata: Creazione di un'applicazione WPF semplice con WPF Designer](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/bb546972(v=vs.100))|Viene illustrato come compilare un'applicazione WPF semplice con la [!INCLUDE[wpfdesigner_current_short](../../../../includes/wpfdesigner-current-short-md.md)].|  
|[Procedura dettagliata: Costruzione di un Layout dinamico](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/bb514519(v=vs.100))|Viene illustrato come creare un layout dinamico usando un <xref:System.Windows.Controls.Grid> controllo panel.|  
|[Procedura dettagliata: Creazione di un'applicazione ridimensionabile usando WPF Designer](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/bb546954(v=vs.100))|Viene illustrato come creare i layout delle finestre che sono ridimensionabili dall'utente in fase di esecuzione.|  
...
|Titolo|Descrizione|  
|-----------|-----------------|  
|[Procedure dettagliate di Visual Studio](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/szatc41e(v=vs.100))|Fornisce un elenco di procedure dettagliate per tutte le aree della programmazione in Visual Studio.|
