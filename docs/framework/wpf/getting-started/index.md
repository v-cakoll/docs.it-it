...
|Nuovi utenti di .NET?|[Cenni preliminari su .NET Framework](https://msdn.microsoft.com/en-us/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [Concetti di base sulle applicazioni .NET Framework](../../../../docs/standard/application-essentials.md)<br /><br /> [Getting Started with Visual C# and Visual Basic](https://msdn.microsoft.com/en-us/library/dd492171\(v=vs.140\).aspx) (Introduzione a Visual C# e Visual Basic)|  
|Ulteriori informazioni su WPF...|[Introduzione a WPF in Visual Studio 2015](../../../../docs/framework/wpf/getting-started/introduction-to-wpf-in-vs.md)<br /><br /> [Cenni preliminari su XAML (WPF)](../../../../docs/framework/wpf/advanced/xaml-overview-wpf.md)<br /><br /> [Controlli](../../../../docs/framework/wpf/controls/index.md)<br /><br /> [Cenni preliminari sull'associazione dati](../../../../docs/framework/wpf/data/data-binding-overview.md)|  
