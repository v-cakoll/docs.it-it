...
|<xref:System.Windows.Forms.MenuStrip>|<xref:System.Windows.Controls.Menu>|<xref:System.Windows.Controls.Menu>lo stile di controllo è simile al comportamento e l'aspetto della <xref:System.Windows.Forms.ToolStripProfessionalRenderer?displayProperty=nameWithType> classe.|  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Gli sviluppatori di WPF Designer per Windows Form](http://msdn.microsoft.com/en-us/47ad0909-e89b-4996-b4ac-874d929f94ca)  
