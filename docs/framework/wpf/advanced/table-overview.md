...
> [!NOTE]
>  <xref:System.Windows.Documents.TableCell> gli elementi non possono ospitare direttamente contenuto di testo. Per altre informazioni sulle regole di contenimento per il flusso, ad esempio gli elementi di contenuto <xref:System.Windows.Documents.TableCell>, vedere [Cenni preliminari sui documenti dinamici](../../../../docs/framework/wpf/advanced/flow-document-overview.md).  
...
>  <xref:System.Windows.Documents.Table> è simile al <xref:System.Windows.Controls.Grid> elemento ma offre maggiori funzionalità e, pertanto, comporta un sovraccarico di risorse superiore.  
 ...
 ![Schermata: Eseguire il rendering di una tabella di base](../../../../docs/framework/wpf/advanced/media/basictablerrender.png "BasicTablerRender")  
...
### <a name="row-groupings"></a>Raggruppamenti di righe  
 ...
 ![Schermata: Gruppi di righe di tabella](../../../../docs/framework/wpf/advanced/media/table-rowgroups.png "Table_RowGroups")  
...
5.  <xref:System.Windows.Documents.TableCell>  
 ...
 ![Schermata: Tabella z&#45;ordine](../../../../docs/framework/wpf/advanced/media/table-zorder.png "Table_ZOrder")  
...
### <a name="spanning-rows-or-columns"></a>Estensione su più righe o colonne  
 ...
 ![Schermata: Cella che si estende su tutte e tre colonne](../../../../docs/framework/wpf/advanced/media/table-columnspan.png "Table_ColumnSpan")  
