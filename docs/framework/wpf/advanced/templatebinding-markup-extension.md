...
## <a name="remarks"></a>Note  
 Oggetto `TemplateBinding` è una forma ottimizzata di un [associazione](binding-markup-extension.md) per gli scenari di modelli, analoghi a un `Binding` costruito con `{Binding RelativeSource={RelativeSource TemplatedParent}}`. 
