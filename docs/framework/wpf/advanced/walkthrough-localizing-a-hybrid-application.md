...
1. In **Esplora soluzioni**fare doppio clic su **SimpleControl. XAML** per aprirlo nella [!INCLUDE[wpfdesigner_current_short](../../../../includes/wpfdesigner-current-short-md.md)].
