...
ms.locfileid: "33544586"
---
# <a name="setfakeactivewindow-function-wpf-unmanaged-api-reference"></a>Funzione SetFakeActiveWindow (riferimenti alle API non gestita di WPF)
