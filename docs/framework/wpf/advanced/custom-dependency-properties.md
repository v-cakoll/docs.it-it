...
-   Si desidera supportano le proprietà di un controllo personalizzato per la ricezione di progettazione WPF di Visual Studio, ad esempio **proprietà** la modifica della finestra. Per altre informazioni, vedere [Cenni preliminari sulla modifica di controlli](../../../../docs/framework/wpf/controls/control-authoring-overview.md).
