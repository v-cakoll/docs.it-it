...
ms.locfileid: "61776181"
---
# <a name="how-to-drag-and-drop-ink"></a><span data-ttu-id="ce3e0-102">Procedura: Trascinare l'input penna</span><span class="sxs-lookup"><span data-stu-id="ce3e0-102">How to: Drag and Drop Ink</span></span>
## <a name="example"></a><span data-ttu-id="ce3e0-103">Esempio</span><span class="sxs-lookup"><span data-stu-id="ce3e0-103">Example</span></span>  
 <span data-ttu-id="ce3e0-104">L'esempio seguente crea un'applicazione che consente all'utente di trascinare i tratti selezionati da una <xref:System.Windows.Controls.InkCanvas> a altro.</span><span class="sxs-lookup"><span data-stu-id="ce3e0-104">The following example creates an application that enables the user to drag selected strokes from one <xref:System.Windows.Controls.InkCanvas> to the other.</span></span>  
