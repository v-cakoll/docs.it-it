...
- Creare una C# dll contenente tutte le [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] pagine come assembly compilato e quindi fare in modo che il C++ file eseguibile includa tale DLL come riferimento.  
  
- Creare un C# eseguibile per [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] il contenuto e fare in riferimento a C++ una dll che contiene [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] il contenuto.  
