...
In questo esempio viene illustrato come convertire un <xref:System.Windows.Media.Imaging.BitmapSource> oggetto (<xref:System.Windows.Media.Imaging.BitmapImage>) a una diversa <xref:System.Windows.Media.PixelFormat> tramite un <xref:System.Windows.Media.Imaging.FormatConvertedBitmap>.  
