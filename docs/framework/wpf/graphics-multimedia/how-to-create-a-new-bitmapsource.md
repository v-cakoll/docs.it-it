...
In questo esempio illustra come usare il <xref:System.Windows.Media.Imaging.BitmapSource.Create%2A> metodo di <xref:System.Windows.Media.Imaging.BitmapSource> per creare un nuovo <xref:System.Windows.Media.Imaging.BitmapSource> oggetto.  
