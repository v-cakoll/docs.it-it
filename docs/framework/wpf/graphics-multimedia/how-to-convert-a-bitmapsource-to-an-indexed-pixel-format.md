...
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="96381-102">Procedura: Convertire un oggetto BitmapSource in un formato a pixel indicizzato</span><span class="sxs-lookup"><span data-stu-id="96381-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="96381-103">In questo esempio viene illustrato come convertire un <xref:System.Windows.Media.Imaging.BitmapSource> in un formato a pixel indicizzato.</span><span class="sxs-lookup"><span data-stu-id="96381-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="96381-104">Esempio</span><span class="sxs-lookup"><span data-stu-id="96381-104">Example</span></span>  
