...
## <a name="what-is-a-geometry"></a>Definizione di Geometry  
 ...
 Poiché un <xref:System.Windows.Media.Geometry> è un tipo di <xref:System.Windows.Freezable>, <xref:System.Windows.Media.Geometry> oggetti forniscono diverse funzionalità speciali: possono essere dichiarati come [risorse](../../../../docs/framework/wpf/advanced/xaml-resources.md)condiviso tra più oggetti, impostati in sola lettura per migliorare le prestazioni, clonate, e resi thread-safe. Per altre informazioni sulle diverse funzionalità fornita da <xref:System.Windows.Freezable> oggetti, vedere la [Cenni preliminari sugli oggetti Freezable](../../../../docs/framework/wpf/advanced/freezable-objects-overview.md).  
...
Un oggetto LineGeometry disegnato da (10,20) a (100,130)  
 ...
 ![Un oggetto EllipseGeometry](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-ellipse.gif "graphicsmm_ellipse")  
...
Un oggetto RectangleGeometry tracciato a 50,50  
 ...
 ![Immagine con e senza ritaglio](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-clipexample.png "graphicsmm_clipexample")  
...
Un oggetto PathGeometry che contiene un singolo oggetto LineSegment  
 ...
 ![Un oggetto PathGeometry](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-path2.gif "graphicsmm_path2")  
PathGeometry  
 ...
 ![Un oggetto PathGeometry](../../../../docs/framework/wpf/graphics-multimedia/media/graphicsmm-path.gif "graphicsmm_path")  
...
### <a name="path-markup-syntax"></a>Sintassi di markup del percorso  
 Il <xref:System.Windows.Media.PathGeometry> e <xref:System.Windows.Media.StreamGeometry> i tipi supportano un [!INCLUDE[TLA#tla_xaml](../../../../includes/tlasharptla-xaml-md.md)] sintassi mediante una serie speciale di spostamento degli attributi e comandi di disegno. Per altre informazioni, vedere [Sintassi di markup del tracciato](../../../../docs/framework/wpf/graphics-multimedia/path-markup-syntax.md).  
...
-   Il <xref:System.Windows.Media.GeometryGroup> classe crea una combinazione del <xref:System.Windows.Media.Geometry> gli oggetti che contiene senza combinarne l'area. Un numero qualsiasi di <xref:System.Windows.Media.Geometry> gli oggetti possono essere aggiunti a un <xref:System.Windows.Media.GeometryGroup>. Per un esempio, vedere [Creare una forma composta](../../../../docs/framework/wpf/graphics-multimedia/how-to-create-a-composite-shape.md).  
...
## <a name="freezable-features"></a>Funzionalità di Freezable  
 Poiché eredita dal <xref:System.Windows.Freezable> (classe), il <xref:System.Windows.Media.Geometry> classe fornisce diverse funzionalità speciali: <xref:System.Windows.Media.Geometry> gli oggetti possono essere dichiarati come [risorse XAML](../../../../docs/framework/wpf/advanced/xaml-resources.md)condiviso tra più oggetti, sola lettura per migliorare le prestazioni, clonati e resi thread-safe. Per altre informazioni sulle diverse funzionalità fornita da <xref:System.Windows.Freezable> oggetti, vedere la [Cenni preliminari sugli oggetti Freezable](../../../../docs/framework/wpf/advanced/freezable-objects-overview.md).  
