...
|`HKEY_CURRENT_USER\SOFTWARE\Microsoft\Avalon.Graphics\MaxMultisampleType`|DWORD|  
 ...
 Il **valore multisample massimo** consente di regolare la quantità massima di anti-aliasing del contenuto 3D. Utilizzare questo livello per disabilitare l'anti-aliasing 3D in Windows Vista.  
  
 Il **valore massimo di multicampionamento** è un valore DWORD che va da 0 a 16. Il valore 0 indica che l'anti-aliasing di multicampionamento del contenuto 3D deve essere disabilitato e un valore pari a 16 tenterà di utilizzare fino a 16x anti-aliasing, se supportato dalla scheda video. Tenere presente che l'impostazione di questo valore della chiave del registro di sistema nei computer che usano driver XPDM provocherà l'uso di una grande quantità di memoria video aggiuntiva, riducendo le prestazioni del rendering 3D e presentando la possibilità di introdurre errori di rendering e problemi di stabilità.  
