...
In questo esempio viene illustrato come animare la <xref:System.Windows.Media.ArcSegment.Size%2A> proprietà di un <xref:System.Windows.Media.ArcSegment>.  
  
## <a name="example"></a>Esempio  
 Nell'esempio seguente viene creato un <xref:System.Windows.Media.ArcSegment> che aggiunge un'animazione relativo <xref:System.Windows.Media.ArcSegment.Size%2A> quando viene caricato sullo schermo.  
 ...
 Per la geometria aggiuntiva e gli esempi di animazione, vedere il [geometrie esempio](http://go.microsoft.com/fwlink/?LinkID=159989).  
