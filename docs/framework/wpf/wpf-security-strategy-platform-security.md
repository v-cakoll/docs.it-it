...
#### <a name="gs-compilation"></a>Compilazione /GS  
 ...
 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] viene compilato con il flag /GS per aggiungere un ulteriore livello di difesa alle [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] applicazioni.  
  
#### <a name="microsoft-windows-update-enhancements"></a>Miglioramenti a Microsoft Windows Update  
 [!INCLUDE[TLA#tla_win_update](../../../includes/tlasharptla-win-update-md.md)] è stato anche migliorato in [!INCLUDE[TLA2#tla_winxpsp2](../../../includes/tla2sharptla-winxpsp2-md.md)] per semplificare il processo per il download e installazione degli aggiornamenti. Queste modifiche migliorano in modo sostanziale la sicurezza per i clienti [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] in quanto contribuiscono a garantire che i sistemi siano sempre aggiornati, in modo specifico per quanto riguarda la sicurezza.  
  
<a name="Windows_Vista"></a>   
### <a name="windows-vista"></a>Windows Vista  
 [!INCLUDE[TLA2#tla_wpf](../../../includes/tla2sharptla-wpf-md.md)] gli utenti su [!INCLUDE[TLA#tla_longhorn](../../../includes/tlasharptla-longhorn-md.md)] trarranno numerosi vantaggi dai miglioramenti apportati alla sicurezza aggiuntiva del sistema operativo, inclusi il "Accesso utente con privilegi minimi", controlli di integrità del codice e isolamento dei privilegi.  
...
#### <a name="code-integrity-checks"></a>Controlli di integrità del codice  
 [!INCLUDE[TLA#tla_longhorn](../../../includes/tlasharptla-longhorn-md.md)] incorpora controlli di integrità di codice più accurati per impedire che codice dannoso che venga introdotto in file system o nel kernel in fase di esecuzione/caricamento. Questo va oltre la protezione dei file di sistema.  
...
### <a name="validation-and-verification"></a>Convalida e verifica  
 Per garantire l'integrità e l'isolamento degli assembly, [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] si basa su un processo di convalida. [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] la convalida garantisce che gli assembly vengano isolati convalidando il loro formato di file eseguibile portabile (PE) per gli indirizzi che puntano all'esterno dell'assembly. [!INCLUDE[TLA2#tla_clr](../../../includes/tla2sharptla-clr-md.md)] la convalida consente inoltre di verificare l'integrità dei metadati incorporato all'interno di un assembly.  
