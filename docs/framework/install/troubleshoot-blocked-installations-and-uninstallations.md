...
È possibile determinare le versioni di .NET Framework installate in un sistema. Vedere [Procedura: Determinare le versioni di .NET Framework installate](../migration-guide/how-to-determine-which-versions-are-installed.md) per altre informazioni.
...
|.NET Framework 4.5.x è già incluso nel sistema operativo in uso, ma è attualmente disabilitato (solo [!INCLUDE[winserver8](../../../includes/winserver8-md.md)]).|Vedere [Attivare o disattivare le funzionalità di Windows](https://go.microsoft.com/fwlink/p/?LinkId=248438) nel sito Web di Windows.|  
