...
Quando si esegue il [web o programma di installazione offline](../../../docs/framework/install/guide-for-developers.md) per .NET Framework 4.5 o versioni successive, potrebbe verificarsi un problema che impedisce o blocca l'installazione di .NET Framework. Nella tabella seguente sono elencati i possibili problemi di blocco e i collegamenti a informazioni sulla risoluzione dei problemi.
...
> [!IMPORTANT]
> Poiché le versioni 4. x di .NET Framework sono aggiornamenti sul posto, è possibile installare una versione precedente di .NET Framework 4. x in un sistema a cui è già presente una versione successiva. Ad esempio, in un sistema con Windows 10 rientrano creatori di aggiornamento, è possibile installare .NET Framework 4.6.2, poiché .NET Framework 4.7.1 è preinstallato con il sistema operativo.
...
In questa tabella 4.5. *x* si riferisce a .NET Framework 4.5 e alle versioni intermedie, 4.5.1 e 4.5.2, 4.6. *x* si riferisce a .NET Framework 4.6 e alle versioni intermedie, 4.6.1 e 4.6.2 e 4.7. *x* si intende il 4.7 di .NET Framework e rilascio punto, 4.7.1.
...
|.NET Framework 4.5*x*/4.6*x*/4,7*x* ridistribuibile non si applica a questo sistema operativo. È possibile scaricare .NET Framework 4.5*x*/4.6*x*/4,7*x* per il sistema operativo da Microsoft Download Center.|Si desidera installare il [!INCLUDE[net_v451](../../../includes/net-v451-md.md)], 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7, o 4.7.1 su una piattaforma che non è supportata o è stato scelto il pacchetto di installazione che non include i componenti per tutti i sistemi operativi supportati. Eseguire nuovamente l'installazione tramite il programma di installazione offline ([per 4.5.1](http://go.microsoft.com/fwlink/p/?LinkId=309493), [per 4.5.2](http://go.microsoft.com/fwlink/p/?LinkId=397706), [per 4.6](http://go.microsoft.com/fwlink/p/?LinkId=528233), [per 4.6.1](http://go.microsoft.com/fwlink/p/?LinkId=671744), per [ 4.6.2](http://go.microsoft.com/fwlink/p/?LinkId=780604), per [4.7](http://go.microsoft.com/fwlink/p/?LinkId=825306)), o per [4.7.1](http://go.microsoft.com/fwlink/p/?LinkId=852090). Per altre informazioni, vedere la [Guida all'installazione](../../../docs/framework/install/guide-for-developers.md) e i [requisiti di sistema](../../../docs/framework/get-started/system-requirements.md) per i sistemi operativi supportati.|  
...
|.NET Framework 4.5. *x*/4.6*x*/4,7*x* fa già parte del sistema operativo. Non è necessario installare .NET Framework 4.5*x*/4.6*x*/4,7*x* ridistribuibile.|Nessuna azione.<br /><br /> Per determinare le versioni di .NET Framework installate in un sistema, vedere [Procedura: Determinare le versioni di .NET Framework installate](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md). Per i sistemi operativi supportati, vedere [Requisiti di sistema](../../../docs/framework/get-started/system-requirements.md).|  
...
1. Nella colonna Nome cercare i [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 o 4.7.1 i nomi di download, a seconda della versione che si sta installando ed eliminare queste voci. Per i nomi di download, vedere [Installare .NET Framework per sviluppatori](../../../docs/framework/install/guide-for-developers.md).

1. Eseguire nuovamente il programma di installazione di .NET Framework versione 4.5, 4.5.1, 4.5.2 o 4.6, 4.6.1, 4.6.2, 4.7 o 4.7.1.
