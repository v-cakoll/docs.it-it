...
In questa tabella, 4.5.*x* fa riferimento a .NET Framework 4.5 e alle relative versioni intermedie, 4.5.1, 4.5.2, 4.6.*x* fa riferimento a .NET Framework 4.6 e alle relative versioni intermedie, 4.6.1 e 4.6.2 e 4.7.*x* indica .NET Framework 4.7 e la relativa versione intermedia 4.7.1.
...
1. Nella colonna Nome cercare i nomi di download di [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 o 4.7.1, a seconda della versione che si sta installando ed eliminare queste voci. Per i nomi di download, vedere [Installare .NET Framework per sviluppatori](../../../docs/framework/install/guide-for-developers.md).

1. Eseguire nuovamente il programma di installazione di .NET Framework per la versione 4.5, 4.5.1, 4.5.2, 4.6, 4.6.1, 4.6.2, 4.7 o 4.7.1.
