---
title: Esecuzione di applicazioni console in Docker | Microsoft Docs
...
# Esecuzione di applicazioni console in contenitori Windows
...
## Creazione del documento Dockerfile
...
### Esecuzione del contenitore tramite PowerShell
