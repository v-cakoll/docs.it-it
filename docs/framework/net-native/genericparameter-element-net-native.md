...
## <a name="remarks"></a>Note  
 L'elemento `<GenericParameter>` è figlio dell'elemento [\<Method>](method-element-net-native.md) o [\<Type>](type-element-net-native.md) ed è usato per applicare i criteri a un determinato parametro di tipo generico, specificato mediante il nome nella firma del tipo o del metodo generico.  
