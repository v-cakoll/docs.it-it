...
---
# <a name="library-element-net-native"></a>Elemento > della libreria \<(.NET Native)
...
## <a name="remarks"></a>Note  
 ...
 Le direttive `<Library>` possono essere usate in modo condizionale. Se il nome dell'elemento `<Library>` inizia e termina con un asterisco (\*), la direttiva `<Library>` avrà effetto solo se l'app fa riferimento all'assembly specificato tra gli asterischi. Ad esempio, la direttiva di runtime seguente si applica solo se l'app fa riferimento all'assembly Utilities. dll.  
