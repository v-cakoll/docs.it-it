...
## <a name="in-this-section"></a>In questa sezione  
 ...
 [Aggiunta di un oggetto DataTable a un dataset](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/adding-a-datatable-to-a-dataset.md)  
 ...
 [Copia di contenuti di dataset](../../../../../docs/framework/data/adonet/dataset-datatable-dataview/copying-dataset-contents.md)  
