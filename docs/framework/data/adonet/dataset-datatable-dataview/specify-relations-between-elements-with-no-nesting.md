...
Se gli elementi non sono annidati, non viene creata alcuna relazione implicita. È tuttavia possibile specificare in modo esplicito le relazioni tra elementi che non sono annidati utilizzando l'annotazione **msdata:Relationship.You can, however,** explicitly specify relations between elements that are not nested by using the msdata:Relationship annotation.  
