...
ms.locfileid: "54662179"
---
# <a name="navigation-property"></a>proprietà di navigazione
Oggetto *proprietà di navigazione* è una proprietà facoltativa su un [tipo di entità](../../../../docs/framework/data/adonet/entity-type.md) che consente la navigazione da uno [end](../../../../docs/framework/data/adonet/association-end.md) di un [associazione](../../../../docs/framework/data/adonet/association-type.md) a l'altra estremità. A differenza di altri [proprietà](../../../../docs/framework/data/adonet/property.md), le proprietà di navigazione non contengono dati.  
