...
```  
 ...
 Questo metodo restituirà oggetti Product ma non la raccolta di oggetti Order_Detail associati a ogni oggetto Product. Usare l'oggetto <xref:System.Data.Linq.DataLoadOptions> per modificare questo comportamento predefinito. Per ulteriori informazioni, vedere [procedura: controllo come molto correlati i dati vengono recuperati](../../../../../../docs/framework/data/adonet/sql/linq/how-to-control-how-much-related-data-is-retrieved.md).  
...
-   Concorrenza ottimistica basata sulle entità complete originali o modificate.  
 ...
 Per ulteriori informazioni sulla concorrenza ottimistica, vedere [la concorrenza ottimistica: Panoramica](../../../../../../docs/framework/data/adonet/sql/linq/optimistic-concurrency-overview.md). Per informazioni dettagliate sulla risoluzione di concorrenza ottimistica i conflitti di modifiche, vedere [procedura: gestire i conflitti di modifica](../../../../../../docs/framework/data/adonet/sql/linq/how-to-manage-change-conflicts.md).  
