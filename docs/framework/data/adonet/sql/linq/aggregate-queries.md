...
- Le query di aggregazione restituiscono in genere un numero anziché una raccolta.  
     ...
     Per altre informazioni, vedere [operazioni](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2013/bb546138(v=vs.120))di aggregazione.  
  
- Non è possibile chiamare aggregati per tipi anonimi.  
  
 Gli esempi negli argomenti riportati di seguito derivano dal database di esempio Northwind. Per ulteriori informazioni, vedere [download di database di esempio](../../../../../../docs/framework/data/adonet/sql/linq/downloading-sample-databases.md).  
