...
> [!NOTE]
> Le query precompilate non restituiranno oggetti dalla cache delle identità. Per ulteriori informazioni sulle query precompilate, vedere <xref:System.Data.Linq.CompiledQuery> e [procedura: Archiviare e riutilizzare](how-to-store-and-reuse-queries.md)le query.  
