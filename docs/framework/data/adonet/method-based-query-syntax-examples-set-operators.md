...
---
# <a name="method-based-query-syntax-examples-set-operators-linq-to-dataset"></a>Esempi di sintassi di Query basate sul metodo: Operatori sui set (LINQ to DataSet)
