...
---
# <a name="how-to-implement-copytodatatablelttgt-where-the-generic-type-t-is-not-a-datarow"></a>Procedura: Implementazione di CopyToDataTable&lt;T&gt; quando il tipo generico T non è un DataRow
