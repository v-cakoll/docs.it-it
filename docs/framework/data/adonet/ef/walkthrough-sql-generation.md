...
Trovato il primo simbolo da rinominare è \<symbol_OrderID >. Il nuovo nome assegnato è "OrderID1", dove 1 è contrassegnato come ultimo suffisso usato per "OrderID" e il simbolo è contrassegnato come da non rinominare. Successivamente, il primo utilizzo di \<symbol_OrderID_2 > viene trovato. Quest'ultimo viene rinominato in modo da usare il successivo suffisso disponibile ("OrderID2") e nuovamente contrassegnato come da non rinominare, in modo che non venga rinominato al successivo utilizzo. Questa operazione viene eseguita \<symbol_OrderID_3 > troppo.
