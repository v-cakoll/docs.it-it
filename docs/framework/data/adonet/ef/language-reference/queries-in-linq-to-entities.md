...
- [Esempi di sintassi di espressione di query: Ordinare](query-expression-syntax-examples-ordering.md)  
...
- [Esempi di sintassi di query basate sul metodo: Ordinare](method-based-query-syntax-examples-ordering.md)  
