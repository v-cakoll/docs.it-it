...
## <a name="immediate-query-execution"></a>Esecuzione di query immediata  
...
### <a name="casting-literals-on-the-client"></a>Esecuzione del cast di valori letterali nel client  
...
### <a name="constructors-for-literals"></a>Costruttori per i valori letterali  
...
## <a name="store-exceptions"></a>Eccezioni nell'archivio  
