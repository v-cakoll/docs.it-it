...
## <a name="datetime"></a>DateTime  
 ...
 Il formato della parte della data deve essere: `YYYY` - `MM` - `DD`, dove `YYYY` è un valore di anno a quattro cifre compreso tra 0001 e 9999, `MM` è il mese compreso tra 1 e 12 e `DD` è il valore del giorno è valido per il mese specificato `MM`.  
