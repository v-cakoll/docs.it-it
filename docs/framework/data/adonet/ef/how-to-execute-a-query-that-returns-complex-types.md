...
3.  Fare doppio clic sul file edmx per visualizzare il modello nella [finestra Browser modello](http://msdn.microsoft.com/library/94e836e8-a5ea-47ff-aa3e-599d8a02ebfd) di Entity Designer. Nell'area di Entity Designer, selezionare il `Email` e `Phone` le proprietà del `Contact` tipo di entità, quindi fare clic e scegliere **effettuare il refactoring in nuovo tipo complesso**.  
