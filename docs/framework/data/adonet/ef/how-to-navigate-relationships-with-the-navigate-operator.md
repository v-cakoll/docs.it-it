...
---
# <a name="how-to-navigate-relationships-with-the-navigate-operator"></a>Procedura: esplorare relazioni con l'operatore NAVIGATE
...
## <a name="example"></a>Esempio  
 Nell'esempio seguente viene illustrato come spostarsi tra relazioni in [!INCLUDE[esql](../../../../../includes/esql-md.md)] utilizzando il [NAVIGA](../../../../../docs/framework/data/adonet/ef/language-reference/navigate-entity-sql.md) operatore. Il `Navigate` operatore accetta i parametri seguenti: un'istanza di un'entità, il tipo di relazione, la fine della relazione e l'inizio della relazione. Facoltativamente, è possibile passare solo un'istanza di un'entità e il tipo di relazione per il `Navigate` operatore.  
