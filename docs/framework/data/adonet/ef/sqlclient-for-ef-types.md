...
|`varbinary(max)`<br /><br /> Nota: Questo tipo non è supportato in SQL Server 2000.|N/D|`Edm.Binary`|MaxLength:<br /><br /> -Il valore predefinito: 214748364780<br /><br /> -Costante: True<br /><br /> FixedLength:<br /><br /> -Il valore predefinito: False<br /><br /> -Costante: True|  
