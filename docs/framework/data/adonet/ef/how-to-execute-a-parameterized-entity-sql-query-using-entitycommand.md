...
---
# <a name="how-to-execute-a-parameterized-entity-sql-query-using-entitycommand"></a>Procedura: Eseguire una Query SQL di entità con parametri tramite EntityCommand
