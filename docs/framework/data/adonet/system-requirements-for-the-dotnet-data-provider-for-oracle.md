...
Di seguito è riportato un elenco di problemi correlati a Unicode da tenere in considerazione quando si utilizza il .NET Framework provider di dati per le librerie client Oracle e Oracle. Per altre informazioni, vedere la documentazione di Oracle.  
