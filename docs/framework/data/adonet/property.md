...
- Set di [facet](facet.md). (facoltativo)  
 ...
 Una proprietà può contenere dati primitivi (ad esempio una stringa, un Integer o un valore booleano) o dati strutturati (ad esempio un tipo complesso). Le proprietà di tipo primitivo sono dette anche proprietà scalari. Per ulteriori informazioni, vedere [Entity Data Model: Tipi](entity-data-model-primitive-data-types.md)di dati primitivi.  
