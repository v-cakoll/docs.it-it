...
## <a name="adonet-components"></a>Componenti di ADO.NET  
 I due componenti principali di ADO.NET per l'accesso e la <xref:System.Data.DataSet>manipolazione dei dati sono i provider di dati .NET Framework e.  
...
### <a name="the-dataset"></a>Il DataSet  
 ...
 Nel diagramma seguente viene illustrata la relazione tra un provider di dati .NET Framework `DataSet`e un oggetto.  
