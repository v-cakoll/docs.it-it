...
## <a name="sql-server-decimal-type"></a>Tipo decimal di SQL Server  
 ...
 In ADO.NET 2,0 è stato introdotto <xref:System.Data.SqlTypes> un `DataSet`supporto migliorato per nel. Per altre informazioni, vedere [SqlTypes and the DataSet](./sql/sqltypes-and-the-dataset.md).  
...
- [MARS (Multiple Active Result Set)](./sql/multiple-active-result-sets-mars.md)
