...
## <a name="specifying-parameter-data-types"></a>Specifica di un tipo di dati per i parametri  
...
## <a name="using-parameters-with-an-oledbcommand-or-odbccommand"></a>Uso di parametri con OleDbCommand o OdbcCommand  
