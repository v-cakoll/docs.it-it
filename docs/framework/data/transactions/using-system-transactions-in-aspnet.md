...
## <a name="enable-distributedtransactionpermission-in-aspnet"></a>Abilitare DistributedTransactionPermission in ASP.NET
 ...
 Per modificare i file dei criteri, aggiungere un elemento **SecurityClass** per **DistributedTransactionPermission** all'elemento **SecurityClasses** nell'elemento **PolicyLevel** e aggiungere un elemento **IPermission** corrispondente in **NamedPermissionSet** ASP.NET per System. Transactions. Queste modifiche vengono mostrate nel file di configurazione seguente.
