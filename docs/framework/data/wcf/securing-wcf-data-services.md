...
OData e autenticazione-parte 7: autenticazione basata su Form] (https://devblogs.microsoft.com/odata/odata-and-authentication-part-7-forms-authentication/).|  
...
OData e autenticazione-parte 8: OAuth WRAP] (https://devblogs.microsoft.com/odata/odata-and-authentication-part-8-oauth-wrap/).|  
