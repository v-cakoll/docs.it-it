...
[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] Consente di definire un modello di dati basato su classi arbitrarie, purché tali classi siano esposte come oggetti che implementano il <xref:System.Linq.IQueryable%601> interfaccia. Per altre informazioni, vedere [provider di servizi dati](../../../../docs/framework/data/wcf/data-services-providers-wcf-data-services.md).  
