...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene illustrato come usare versioni diverse di [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)].  
 ...
 Vengono descritte le funzionalità facoltative del protocollo [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] che non sono attualmente implementate da WCF Data Services.  
