...
-   **Atom** -codifica di messaggi basati su XML definita da [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] come un'estensione per il protocollo di pubblicazione Atom (AtomPub) per lo scambio di dati su HTTP per feed Web, podcast, Wiki e funzionalità Internet basate su XML. Per ulteriori informazioni, vedere [OData: formato Atom](http://go.microsoft.com/fwlink/?LinkId=185794).  
