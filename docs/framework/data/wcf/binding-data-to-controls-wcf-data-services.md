...
## <a name="binding-data-to-windows-presentation-foundation-elements"></a>Associazione di dati a elementi di Windows Presentation Foundation  
 ...
 Per ulteriori informazioni, vedere [procedura: associare dati a elementi Windows Presentation Foundation](../../../../docs/framework/data/wcf/bind-data-to-wpf-elements-wcf-data-services.md).  
...
## <a name="binding-paged-data"></a>Associazione di dati di paging  
 ...
 Gli oggetti correlati vengono caricati in modo analogo. Per ulteriori informazioni, vedere [procedura: associare dati a elementi Windows Presentation Foundation](../../../../docs/framework/data/wcf/bind-data-to-wpf-elements-wcf-data-services.md).  
...
>  [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] non esegue alcuna convalida dei comportamenti personalizzati implementati in questi delegati.  
 ...
 Per ulteriori informazioni, vedere [procedura: personalizzare i comportamenti di associazione di dati](../../../../docs/framework/data/wcf/how-to-customize-data-binding-behaviors-wcf-data-services.md).  
...
## <a name="data-binding-with-custom-client-data-classes"></a>Associazione dati con classi di dati client personalizzate  
 Per essere in grado di caricare oggetti in <xref:System.Data.Services.Client.DataServiceCollection%601>, gli oggetti stessi devono implementare l'interfaccia <xref:System.ComponentModel.INotifyPropertyChanged>. Le classi di client che vengono generate quando si utilizza del servizio dati di **Aggiungi riferimento al servizio** la finestra di dialogo o [DataSvcUtil.exe](../../../../docs/framework/data/wcf/wcf-data-service-client-utility-datasvcutil-exe.md) strumento implementare questa interfaccia. Se si forniscono classi di dati client personalizzate, sarà necessario usare un altro tipo di raccolta per il data binding. Quando gli oggetti vengono modificati, è necessario gestire gli eventi nei controlli associati ai dati per chiamare i metodi della classe <xref:System.Data.Services.Client.DataServiceContext> seguenti:  
...
-   <xref:System.Data.Services.Client.DataServiceContext.SetLink%2A>: quando un oggetto viene aggiunto a una raccolta di oggetti correlati.  
 ...
 Per ulteriori informazioni, vedere [l'aggiornamento del servizio dati](../../../../docs/framework/data/wcf/updating-the-data-service-wcf-data-services.md).  
