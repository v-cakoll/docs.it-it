...
> [!NOTE]
> Quando si utilizza la finestra di dialogo **Aggiungi riferimento al servizio** o lo strumento [DataSvcUtil. exe](wcf-data-service-client-utility-datasvcutil-exe.md) con l' `/dataservicecollection` opzione per generare le classi del servizio dati client, le classi di <xref:System.ComponentModel.INotifyPropertyChanged> dati generate implementano l'interfaccia. Per altre informazioni, vedere [Procedura: Generare manualmente classi](how-to-manually-generate-client-data-service-classes-wcf-data-services.md)del servizio dati client.  
...
## <a name="binding-data-to-windows-presentation-foundation-elements"></a>Associazione di dati a elementi di Windows Presentation Foundation  
 ...
 Per altre informazioni, vedere [Procedura: Associare i dati agli elementi](bind-data-to-wpf-elements-wcf-data-services.md)Windows Presentation Foundation.  
...
## <a name="binding-paged-data"></a>Associazione di dati di paging  
 ...
 Gli oggetti correlati vengono caricati in modo analogo. Per altre informazioni, vedere [Procedura: Associare i dati agli elementi](bind-data-to-wpf-elements-wcf-data-services.md)Windows Presentation Foundation.  
...
> [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] non esegue alcuna convalida dei comportamenti personalizzati implementati in questi delegati.  
 ...
 Per altre informazioni, vedere [Procedura: Personalizzare i comportamenti](how-to-customize-data-binding-behaviors-wcf-data-services.md)di associazione dati.  
