...
#### <a name="tryresolveserviceaction"></a>TryResolveServiceAction
 Questo metodo cerca un [oggetto ServiceAction](https://docs.microsoft.com/previous-versions/dotnet/wcf-data-services/hh544089(v=vs.103)) specificato e restituisce `true` se il [oggetto ServiceAction](https://docs.microsoft.com/previous-versions/dotnet/wcf-data-services/hh544089(v=vs.103)) viene trovato. Se viene trovato, il [oggetto ServiceAction](https://docs.microsoft.com/previous-versions/dotnet/wcf-data-services/hh544089(v=vs.103)) viene restituito nel parametro `serviceAction` `out`.
