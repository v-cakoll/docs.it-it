...
- Aggiungere un riferimento all'assembly System.ComponentModel.Composition in cui risiede MEF.

- Aprire Module1.vb o Program.cs e aggiungere istruzioni `Imports` o `using` per System.ComponentModel.Composition e System.ComponentModel.Composition.Hosting. Questi due spazi dei nomi contengono i tipi MEF che saranno necessari per sviluppare un'applicazione estensibile.
