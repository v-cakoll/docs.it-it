...
## <a name="import-and-export-basics"></a>Nozioni fondamentali su importazione ed esportazione  
...
### <a name="importing-and-exporting-a-method"></a>Importazione ed esportazione di un metodo  
...
### <a name="lazy-imports"></a>Importazioni differite  
...
### <a name="prerequisite-imports"></a>Importazioni essenziali  
...
### <a name="optional-imports"></a>Importazioni facoltative  
...
### <a name="importing-multiple-objects"></a>Importazione di più oggetti  
...
## <a name="avoiding-discovery"></a>Evitare l'individuazione  
...
## <a name="metadata-and-metadata-views"></a>Metadati e viste dei metadati  
...
## <a name="import-and-export-inheritance"></a>Eredità di importazione ed esportazione  
...
## <a name="custom-export-attributes"></a>Attributi di esportazione personalizzati  
...
## <a name="creation-policies"></a>Criteri di creazione  
...
## <a name="life-cycle-and-disposing"></a>Ciclo di vita ed eliminazione  
...
## <a name="see-also"></a>Vedere anche  
 [Video su Channel 9: Aprire le applicazioni con Managed Extensibility Framework](http://channel9.msdn.com/events/TechEd/NorthAmerica/2009/DTL328)  
 [Video su Channel 9: Managed Extensibility Framework (MEF) 2.0](http://channel9.msdn.com/posts/NET-45-Oleg-Lvovitch-and-Kevin-Ransom-Managed-Extensibility-Framework-MEF-20)
