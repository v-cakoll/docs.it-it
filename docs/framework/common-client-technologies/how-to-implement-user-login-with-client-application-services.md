---
title: 'Procedura: Implementare l&quot;accesso utente con i servizi dell&quot;applicazione client | Documentazione Microsoft'
ms.custom: 
ms.date: 03/30/2017
...
-   Chiamare il metodo `static` <xref:System.Web.Security.Membership.ValidateUser%2A?displayProperty=fullName> e passare i valori di nome utente e password recuperati dall'utente.  
