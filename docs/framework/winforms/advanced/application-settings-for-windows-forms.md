...
[Windows Forms sezione di configurazione](../../configure-apps/file-schema/winforms/index.md)    
Documenta le impostazioni per abilitare il supporto DPI elevato nell'applicazione Windows Forms a partire dal .NET Framework 4,7.
