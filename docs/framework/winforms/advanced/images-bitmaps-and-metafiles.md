...
## <a name="in-this-section"></a>In questa sezione  
 ...
 [Metafile in GDI+](../../../../docs/framework/winforms/advanced/metafiles-in-gdi.md)  
 Descrive il supporto [!INCLUDE[ndptecgdiplus](../../../../includes/ndptecgdiplus-md.md)] per i metafile.  
  
 [Disegno, posizionamento e clonazione delle immagini in GDI+](../../../../docs/framework/winforms/advanced/drawing-positioning-and-cloning-images-in-gdi.md)  
