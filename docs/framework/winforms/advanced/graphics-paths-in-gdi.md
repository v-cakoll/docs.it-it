...
ms.locfileid: "54685648"
---
# <a name="graphics-paths-in-gdi"></a>Percorsi di oggetti Graphics in GDI+
I percorsi sono costituiti dalla combinazione di linee, rettangoli e le curve semplice. Si ricorderà dal [Cenni preliminari sulla grafica vettoriale](../../../../docs/framework/winforms/advanced/vector-graphics-overview.md) che i blocchi predefiniti seguenti hanno dimostrato di essere particolarmente utile per il disegno di immagini:  
