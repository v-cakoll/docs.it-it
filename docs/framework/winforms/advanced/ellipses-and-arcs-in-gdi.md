...
## <a name="drawing-an-ellipse"></a>Disegnare un'ellisse  
 ...
 <xref:System.Drawing.Graphics.DrawEllipse%2A> è un metodo di overload del <xref:System.Drawing.Graphics> classe, pertanto vi sono diversi modi, è possibile fornire argomenti. Ad esempio, è possibile costruire un <xref:System.Drawing.Rectangle> e passare il <xref:System.Drawing.Rectangle> per il <xref:System.Drawing.Graphics.DrawEllipse%2A> metodo come argomento:  
