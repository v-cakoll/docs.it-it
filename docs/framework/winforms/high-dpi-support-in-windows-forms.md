...
A partire dal 4.7 di .NET Framework, Windows Form include miglioramenti per valori DPI alti comuni e scenari di risoluzione dinamici. tra cui: 
...
Il 4.7 di .NET Framework aggiunge anche il numero di nuovi metodi di supporto e le proprietà che forniscono informazioni sul ridimensionamento DPI e consentono di eseguire il ridimensionamento DPI. tra cui:
