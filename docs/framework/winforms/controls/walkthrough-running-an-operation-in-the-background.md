...
1. Con il modulo attivo in Progettazione Windows Form in Visual Studio, trascinare due <xref:System.Windows.Forms.Button> dei controlli il **casella degli strumenti** al form e quindi impostare il `Name` e <xref:System.Windows.Forms.Control.Text%2A> le proprietà dei pulsanti in base al Nella tabella seguente.
...
16. Fare clic sui **avviare** pulsante per eseguire un'operazione asincrona e quindi fare clic sui **Annulla** sul pulsante per arrestare l'esecuzione dell'operazione asincrona.
