...
2.  Selezionare il modello di progetto **Libreria di controlli Windows Forms** dall'elenco dei progetti di [!INCLUDE[csprcs](../../../../includes/csprcs-md.md)], quindi digitare `ValueButtonLib` nella casella **Nome**.  
