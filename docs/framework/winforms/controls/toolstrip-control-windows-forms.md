...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 Viene descritto come utilizzare la classe <xref:System.Windows.Forms.ToolStripProfessionalRenderer> per creare un controllo composito che simula il **riquadro di spostamento** fornito da Microsoft® Outlook®.  
...
- [Procedura: creare una Windows Forms ToolStrip di base con elementi standard utilizzando la finestra di progettazione](create-a-basic-wf-toolstrip-with-standard-items-using-the-designer.md)  
