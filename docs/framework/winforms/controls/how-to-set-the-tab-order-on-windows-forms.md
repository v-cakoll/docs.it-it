...
---
# <a name="how-to-set-the-tab-order-on-windows-forms"></a>Procedura: Imposta l'ordine di tabulazione in Windows Forms
...
Impostare la <xref:System.Windows.Forms.Control.TabStop%2A> proprietà del controllo su **false** nella finestra **Proprietà** .
