...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Vedere [sistemi di Guida nelle applicazioni Windows Forms](../../../../docs/framework/winforms/advanced/help-systems-in-windows-forms-applications.md).  
...
## <a name="related-sections"></a>Sezioni correlate  
 ...
 Vedere anche [sistemi di Guida nelle applicazioni Windows Forms](http://msdn.microsoft.com/library/55dct0a1\(v=vs.110\)).
