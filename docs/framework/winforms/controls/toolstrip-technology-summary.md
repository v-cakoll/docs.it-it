...
-   [MenuStrip (editor della raccolta Items)](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/ms233625(v=vs.100))  
  
-   [StatusStrip (editor della raccolta Items)](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/ms233631(v=vs.100))  
  
-   [ContextMenuStrip (editor della raccolta Items)](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/ms233641(v=vs.100))  
  
-   [Editor della raccolta Items di ToolStrip](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/ms233643(v=vs.100))  
...
## <a name="rendering"></a>Rendering  
 <xref:System.Windows.Forms.ToolStrip> le classi implementano uno schema di rendering molto diverso da altri controlli Windows Form. Con questo schema, è possibile applicare facilmente stili e temi.  
...
## <a name="styles-and-themes"></a>Stili e temi  
 <xref:System.Windows.Forms.ToolStrip> e classi associate forniscono un modo semplice per supportare gli stili di visualizzazione e un aspetto personalizzato che non richiedono l'override di <xref:System.Windows.Forms.ToolStripItem.OnPaint%2A> metodi per ogni elemento. Usare le proprietà <xref:System.Windows.Forms.ToolStripItem.DisplayStyle%2A>, <xref:System.Windows.Forms.ToolStrip.RenderMode%2A> e <xref:System.Windows.Forms.ToolStrip.Renderer%2A>.  
  
## <a name="rafting-and-docking"></a>Raggruppamento e ancoraggio  
 È possibile raggruppare, ancorare o posizionare in modo assoluto i controlli <xref:System.Windows.Forms.ToolStrip>. <xref:System.Windows.Forms.ToolStrip> gli elementi vengono disposti in base il <xref:System.Windows.Forms.ToolStrip.LayoutEngine%2A> del contenitore.  
