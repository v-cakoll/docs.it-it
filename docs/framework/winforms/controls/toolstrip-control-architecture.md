...
#### <a name="core-events"></a>Eventi di base  
 <xref:System.Windows.Forms.ToolStripItem> controlli ricevano le proprie risorse fare clic su, mouse e gli eventi di disegno e possono eseguire alcuni tasti anche di pre-elaborazione.  
...
-   <xref:System.Windows.Forms.ToolStripRenderer> Consente di applicare uno stile particolare o un tema a un <xref:System.Windows.Forms.ToolStrip> facilmente.  
  
-   <xref:System.Windows.Forms.ToolStripProfessionalRenderer> crea penne e pennelli in base a una tabella a colori sostituibili (<xref:System.Windows.Forms.ProfessionalColorTable>).  
