...
1. In Visual Studio, creare un progetto applicazione Windows denominato **MDI** (**File** > **nuovo** > **progetto**  >  **Visual C#**  oppure **Visual Basic** > **Desktop classico**  >   **Windows Forms Application**).
...
## <a name="create-the-main-menu"></a>Creare menu principale
...
## <a name="add-the-toolstrippanel-control-to-the-toolbox"></a>Aggiungere il controllo ToolStripPanel nella casella degli strumenti
...
## <a name="add-toolstrip-support"></a>Aggiungere il supporto di ToolStrip
...
## <a name="arrange-toolstrippanel-controls-by-z-order"></a>Disporre i controlli ToolStripPanel l'ordine Z
