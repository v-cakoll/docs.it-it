...
> [!IMPORTANT]
>  Il <xref:System.Windows.Forms.ToolStripLabel> controllo sostituisce e aggiunge la funzionalità per il <xref:System.Windows.Forms.Label> controllo. È possibile utilizzare il <xref:System.Windows.Forms.ToolStripLabel> con altri nuovi controlli, ad esempio il <xref:System.Windows.Forms.ToolStripDropDown>. Tuttavia, il <xref:System.Windows.Forms.Label> controllo viene mantenuto per compatibilità con le versioni precedenti e per utilizzo futuro, se si sceglie.  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene descritto come utilizzare un'etichetta per definire una chiave di accesso per un altro controllo.  
