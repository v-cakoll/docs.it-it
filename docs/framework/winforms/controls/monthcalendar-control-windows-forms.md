...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene descritto come configurare il `MonthCalendar` controllo per visualizzare più mesi contemporaneamente.  
...
## <a name="related-sections"></a>Sezioni correlate  
 ...
 Viene descritto un controllo simile a <xref:System.Windows.Forms.MonthCalendar>, sebbene il <xref:System.Windows.Forms.DateTimePicker> controllo inoltre consente di selezionare un'ora e non consente di selezionare un intervallo di date.
