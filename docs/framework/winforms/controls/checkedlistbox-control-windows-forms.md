...
I moduli di Windows `CheckedListBox` controllo Visualizza un elenco di elementi, ad esempio il <xref:System.Windows.Forms.ListBox> controllano e può anche visualizzare un segno di spunta accanto agli elementi nell'elenco.  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene descritto come esaminare un elenco per determinare quali elementi vengono controllati.  
