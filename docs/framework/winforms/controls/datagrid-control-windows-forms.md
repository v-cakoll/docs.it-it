...
## <a name="in-this-section"></a>In questa sezione  
 ...
 [Procedura: Aggiungere tabelle e colonne al controllo DataGrid Windows Form usando la finestra di progettazione](add-tables-and-columns-to-wf-datagrid-control-using-the-designer.md)  
 ...
 [Procedura: Associare il controllo DataGrid di Windows Form a un'origine dati tramite la finestra di progettazione](bind-wf-datagrid-control-to-a-data-source-using-the-designer.md)  
 ...
 [Procedura: Creare elenchi Master-Details con il controllo di controllo DataGrid Windows Form usando la finestra di progettazione](create-master-details-lists-with-wf-datagrid-control-using-the-designer.md)  
 ...
 [Procedura: Formattare il controllo di DataGrid Windows Form usando la finestra di progettazione](how-to-format-the-windows-forms-datagrid-control-using-the-designer.md)  
 ...
 [Procedura: Convalidare l'Input con il controllo DataGrid di Windows Form](how-to-validate-input-with-the-windows-forms-datagrid-control.md)  
