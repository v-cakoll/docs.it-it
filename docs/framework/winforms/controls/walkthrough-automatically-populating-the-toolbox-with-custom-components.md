...
> [!NOTE]
> Il **casella degli strumenti** non rispetta le catene di riferimento, in modo che non verrà visualizzati gli elementi che non vengono compilati da un progetto nella soluzione.
...
1. In Visual Studio, creare un progetto di applicazione basata su Windows denominato `ToolboxExample` (**File** > **New** > **progetto**  >  **Visual C#**  oppure **Visual Basic** > **Desktop classico** > **Windows Form Applicazione**).
...
- [Procedura: modificare le schede della Casella degli strumenti](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/66kwe227(v=vs.100))
