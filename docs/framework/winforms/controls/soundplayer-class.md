...
## <a name="related-sections"></a>Sezioni correlate  
 ...
 Vedere anche [HYPERLINK "http://msdn.microsoft.com/library/11bxex12(v=vs.110)" oggetto My. computer](http://msdn.microsoft.com/library/11bxex12\(v=vs.110\)) o [oggetto My. computer](http://msdn.microsoft.com/library/11bxex12\(v=vs.120\)).
