...
---
# <a name="how-to-autogenerate-columns-in-a-data-bound-windows-forms-datagridview-control"></a>Procedura: Generare automaticamente le colonne in un controllo DataGridView di Windows associato a dati form
