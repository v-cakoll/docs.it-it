...
Per standardizzare il layout dell'interfaccia utente (UI) di un'applicazione basata su Windows, è possibile posizionare gruppi di controlli con un unico comando.  
...
1.  Aprire il modulo che contiene i controlli che si desidera posizionare il **Progettazione Windows Form**.  
  
2.  Selezionare i controlli che si desidera allineare in modo che il primo controllo selezionato è il controllo primario a cui gli altri devono essere allineati.  
