...
## <a name="in-this-section"></a>In questa sezione  
 ...
 [Procedura: Impostare e restituire valori numerici con il controllo NumericUpDown di Windows Form](set-and-return-numeric-values-with-wf-numericupdown-control.md)  
...
## <a name="related-sections"></a>Sezioni correlate  
 ...
 Introduce un controllo simile <xref:System.Windows.Forms.NumericUpDown>, ad eccezione del fatto che il <xref:System.Windows.Forms.DomainUpDown> controllo consente di visualizzare stringhe invece di valori numerici.
