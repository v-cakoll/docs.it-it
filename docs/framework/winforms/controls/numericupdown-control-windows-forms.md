...
## <a name="in-this-section"></a>In questa sezione  
 ...
 [Procedura: Impostare e restituire valori numerici con il controllo NumericUpDown Windows Form](../../../../docs/framework/winforms/controls/set-and-return-numeric-values-with-wf-numericupdown-control.md)  
...
## <a name="related-sections"></a>Sezioni correlate  
 ...
 Viene presentato un controllo simile a <xref:System.Windows.Forms.NumericUpDown>, ad eccezione del fatto che il <xref:System.Windows.Forms.DomainUpDown> controllo Visualizza una stringa anziché valori numerici.
