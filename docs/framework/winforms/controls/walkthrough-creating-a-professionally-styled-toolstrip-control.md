...
1. In Visual Studio, creare un nuovo progetto di libreria di controlli di Windows denominato `StackViewLibrary`.
...
## <a name="handle-events"></a>Gestione degli eventi
...
## <a name="define-icons"></a>Definire le icone
...
1. Premere **F5** per compilare il progetto e avviare la **UserControl Test Container**.
