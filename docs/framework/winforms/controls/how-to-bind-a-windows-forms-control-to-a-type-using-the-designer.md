...
---
# <a name="how-to-bind-a-windows-forms-control-to-a-type-using-the-designer"></a>Procedura: Associare un controllo di Windows Form a un tipo usando la finestra di progettazione
