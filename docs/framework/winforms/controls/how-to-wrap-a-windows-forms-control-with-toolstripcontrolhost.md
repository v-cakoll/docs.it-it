...
---
# <a name="how-to-wrap-a-windows-forms-control-with-toolstripcontrolhost"></a>Procedura: Eseguire il wrapping di un controllo di Windows Form con ToolStripControlHost
