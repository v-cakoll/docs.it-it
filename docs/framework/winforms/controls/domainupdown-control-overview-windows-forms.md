...
## <a name="key-properties"></a>Proprietà chiave  
 ...
 Questo controllo consente di visualizzare solo le stringhe di testo. Se si vuole un controllo che Visualizza i valori numerici, <xref:System.Windows.Forms.NumericUpDown> usare il controllo. Per altre informazioni, vedere [Cenni preliminari sul controllo NumericUpDown](numericupdown-control-overview-windows-forms.md).  
