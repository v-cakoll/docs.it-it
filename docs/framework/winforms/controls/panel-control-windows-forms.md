...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene descritto come raggruppare i controlli con un pannello con la finestra di progettazione.  
 ...
 Viene descritto come visualizzare un colore di sfondo e un'immagine di sfondo di un pannello con la finestra di progettazione.  
  
 [Procedura: Impostare lo sfondo di un controllo Panel](how-to-set-the-background-of-a-windows-forms-panel.md)  
 Viene descritto come visualizzare un colore di sfondo e un'immagine di sfondo di un pannello.  
...
## <a name="related-sections"></a>Sezioni correlate  
 ...
 Viene descritto come aggiungere e rimuovere controlli da un controllo contenitore sui form.
