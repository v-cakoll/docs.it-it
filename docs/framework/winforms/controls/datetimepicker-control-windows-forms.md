...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene illustrato come usare le stringhe di formato per visualizzare le date in un formato che preferisci.  
 ...
 Viene descritta la procedura per impostare la data nel controllo e l'accesso alla data selezionato dall'utente.  
