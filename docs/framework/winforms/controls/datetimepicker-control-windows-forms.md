...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene illustrato come utilizzare le stringhe di formato per visualizzare le date nel formato desiderato.  
 ...
 Viene descritta la procedura per impostare la data nel controllo e l'accesso alla data in cui che l'utente ha selezionato.  
