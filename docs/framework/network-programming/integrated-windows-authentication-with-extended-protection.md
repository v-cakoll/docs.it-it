...
## <a name="extended-protection-for-server-applications"></a>Protezione estesa per applicazioni server  
 <xref:System.Net.HttpListener> fornisce automaticamente i meccanismi per la convalida dei binding di servizi durante l'autenticazione HTTP.  
