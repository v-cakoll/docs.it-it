...
|ThreadWave|win:Double|Riservato a un uso interno.|  
|ThroughputWave|win:Double|Riservato a un uso interno.|  
|ThroughputErrorEstimate|win:Double|Riservato a un uso interno.|  
|AverageThroughputErrorEstimate|win:Double|Riservato a un uso interno.|  
...
|Confidence|win:Double|Una misura della validità del campo ThroughputRatio.|  
