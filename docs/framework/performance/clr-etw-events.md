...
## <a name="see-also"></a>Vedere anche  
 [Improve Debugging And Performance Tuning With ETW](http://go.microsoft.com/fwlink/?LinkId=179696)  (Migliorare il debug e l'ottimizzazione delle prestazioni con ETW)  
