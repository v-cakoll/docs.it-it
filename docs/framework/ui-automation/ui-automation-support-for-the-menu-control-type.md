...
|---------------------------------------------------------------------------------|--------------------|-----------|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.MenuOpenedEvent>|Obbligatoria|Nessuna|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.MenuClosedEvent>|Obbligatoria|Nessuna|  
