...
In questa sezione vengono fornite informazioni sul supporto di per [!INCLUDE[TLA#tla_uiautomation](../../../includes/tlasharptla-uiautomation-md.md)]i tipi di controllo in.
