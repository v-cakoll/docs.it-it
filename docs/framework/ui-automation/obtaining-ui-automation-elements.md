...
### <a name="from-an-event"></a>Da un evento  
 ...
 Per altre informazioni, vedere [Subscribe to UI Automation Events](subscribe-to-ui-automation-events.md).  
