...
## <a name="splitbutton-control-example"></a>Esempio di controllo SplitButton  
 ...
 ![Pulsante di menu combinato](./media/uiauto-splitbutton-detailed.gif "uiauto_splitbutton_detailed")  
