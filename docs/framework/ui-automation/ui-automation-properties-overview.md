...
## <a name="property-identifiers"></a>Identificatori di proprietà  
 ...
 La tabella seguente classifica le proprietà in base alle classi che contengono <xref:System.Windows.Automation.AutomationProperty>gli ID.  
