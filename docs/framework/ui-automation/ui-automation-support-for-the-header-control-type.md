...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.LabeledByProperty>|[https://login.microsoftonline.com/consumers/](`Null`).|I controlli intestazione in genere non hanno un'etichetta statica.|  
