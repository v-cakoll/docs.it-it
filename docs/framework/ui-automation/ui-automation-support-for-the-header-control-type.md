...
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.ITransformProvider>|Dipende da|Implementare questo pattern di controllo se il controllo intestazione può essere ridimensionato.|  
