...
## <a name="example"></a>Esempio  
 ...
 La prima tecnica tende a essere più veloce per i controlli [!INCLUDE[TLA2#tla_win32](../../../includes/tla2sharptla-win32-md.md)], ma la seconda è più veloce per i controlli Windows Presentation Foundation (WPF).  
