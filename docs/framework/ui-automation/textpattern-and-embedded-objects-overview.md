 ...
 **Esempio 2: intervallo di testo che si estende parzialmente su un collegamento ipertestuale con testo incorporato**  
 ...
 Il `https://{[www]}` URL è incorporato nel testo.  
