...
|<xref:System.Windows.Automation.Provider.ITransformProvider>|Obbligatoria|Abilita lo spostamento, il ridimensionamento o la rotazione della finestra sullo schermo.|  
|<xref:System.Windows.Automation.Provider.IWindowProvider>|Obbligatoria|Abilita operazioni specifiche per la finestra.|  
...
|---------------------------------------------------------------------------------|-------------|-----------|  
|<xref:System.Windows.Automation.AutomationElementIdentifiers.AsyncContentLoadedEvent>|Obbligatoria|Nessuna|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.LayoutInvalidatedEvent>|Obbligatoria|Nessuna|  
...
|<xref:System.Windows.Automation.WindowPatternIdentifiers.WindowClosedEvent>|Obbligatoria|Nessuna|  
|<xref:System.Windows.Automation.WindowPatternIdentifiers.WindowOpenedEvent>|Obbligatoria|Nessuna|  
