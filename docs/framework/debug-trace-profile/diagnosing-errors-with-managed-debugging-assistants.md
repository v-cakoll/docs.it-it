...
## <a name="enabling-and-disabling-mdas"></a>Abilitazione e disabilitazione di assistenti al debug gestito  
...
```  
 ...
 Per altre informazioni, vedere [Abilitazione e disabilitazione di assistenti al debug gestito tramite impostazioni di configurazione specifiche dell'applicazione](#appConfig). L'impostazione del Registro di sistema può essere sostituita dalla variabile di ambiente COMPLUS_MDA. Per altre informazioni, vedere [Abilitazione e disabilitazione di assistenti al debug gestito tramite una variabile di ambiente](#envVariable).  
...
<a name="appConfig"></a>   
### <a name="enabling-and-disabling-mdas-by-using-application-specific-configuration-settings"></a>Abilitazione e disabilitazione di assistenti al debug gestito tramite impostazioni di configurazione specifiche dell'applicazione  
