---
title: Modifiche di runtime per la migrazione da .NET Framework 4.5.1 a 4.6.2
description: Trovare informazioni sui problemi di compatibilità delle applicazioni dalle modifiche di runtime che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.5.1 a 4.6.2.
ms.date: 07/10/2019
ms.assetid: ef399d2f-c2dc-49e4-a14d-4a5612550a12
author: chlowell
ms.openlocfilehash: b1c2a853aef561d2458ef92581475532dd7fb0bd
ms.sourcegitcommit: 2543a78be6e246aa010a01decf58889de53d1636
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 07/17/2020
ms.locfileid: "86443546"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-462"></a><span data-ttu-id="d6d3c-103">Modifiche di runtime per la migrazione da .NET Framework 4.5.1 a 4.6.2</span><span class="sxs-lookup"><span data-stu-id="d6d3c-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="d6d3c-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5.1 a 4.6.2, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="d6d3c-104">If you are migrating from the .NET Framework 4.5.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="d6d3c-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="d6d3c-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="d6d3c-106">Core</span><span class="sxs-lookup"><span data-stu-id="d6d3c-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="d6d3c-107">Dati</span><span class="sxs-lookup"><span data-stu-id="d6d3c-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="d6d3c-108">Debugger</span><span class="sxs-lookup"><span data-stu-id="d6d3c-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="d6d3c-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="d6d3c-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="d6d3c-110">Globalizzazione</span><span class="sxs-lookup"><span data-stu-id="d6d3c-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="d6d3c-111">Rete</span><span class="sxs-lookup"><span data-stu-id="d6d3c-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="d6d3c-112">Security</span><span class="sxs-lookup"><span data-stu-id="d6d3c-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="d6d3c-113">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="d6d3c-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="d6d3c-114">Installazione e distribuzione</span><span class="sxs-lookup"><span data-stu-id="d6d3c-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="d6d3c-115">Strumenti</span><span class="sxs-lookup"><span data-stu-id="d6d3c-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="d6d3c-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="d6d3c-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="d6d3c-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="d6d3c-117">Windows Presentation Foundation (WPF)</span></span>
