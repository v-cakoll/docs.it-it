...
ms.locfileid: "42935776"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="a1583-102">Modifiche di runtime per la migrazione da .NET Framework 4.5.2 a 4.6</span><span class="sxs-lookup"><span data-stu-id="a1583-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a1583-103">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5.2 a 4.6, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="a1583-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a1583-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a1583-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a1583-105">Base</span><span class="sxs-lookup"><span data-stu-id="a1583-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a1583-106">Dati</span><span class="sxs-lookup"><span data-stu-id="a1583-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a1583-107">Debugger</span><span class="sxs-lookup"><span data-stu-id="a1583-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="a1583-108">Servizi di rete</span><span class="sxs-lookup"><span data-stu-id="a1583-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a1583-109">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="a1583-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a1583-110">Installazione e distribuzione</span><span class="sxs-lookup"><span data-stu-id="a1583-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a1583-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a1583-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a1583-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a1583-112">Windows Presentation Foundation (WPF)</span></span>
