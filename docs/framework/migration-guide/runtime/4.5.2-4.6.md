---
title: Modifiche al runtime per la migrazione da .NET Framework 4.5.2 per 4.6
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="62c60-102">Modifiche al runtime per la migrazione da .NET Framework 4.5.2 per 4.6</span><span class="sxs-lookup"><span data-stu-id="62c60-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="62c60-103">Se si esegue la migrazione da .NET Framework 4.5.2 a 4.6, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:</span><span class="sxs-lookup"><span data-stu-id="62c60-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="62c60-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="62c60-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="62c60-105">Base</span><span class="sxs-lookup"><span data-stu-id="62c60-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="62c60-106">Dati</span><span class="sxs-lookup"><span data-stu-id="62c60-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="62c60-107">Debugger</span><span class="sxs-lookup"><span data-stu-id="62c60-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="62c60-108">Rete</span><span class="sxs-lookup"><span data-stu-id="62c60-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="62c60-109">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="62c60-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="62c60-110">Installazione e distribuzione</span><span class="sxs-lookup"><span data-stu-id="62c60-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="62c60-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="62c60-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="62c60-112">Windows Form</span><span class="sxs-lookup"><span data-stu-id="62c60-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="62c60-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="62c60-113">Windows Presentation Foundation (WPF)</span></span>
