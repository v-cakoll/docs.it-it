---
title: Modifiche di runtime per la migrazione da .NET Framework 4.7.2 a 4.8
description: Trovare informazioni sui problemi di compatibilità delle applicazioni dalle modifiche di runtime che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.7.2 a 4,8.
ms.date: 07/10/2019
...
ms.locfileid: "86443819"
---
# <a name="runtime-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="b92ea-103">Modifiche di runtime per la migrazione da .NET Framework 4.7.2 a 4.8</span><span class="sxs-lookup"><span data-stu-id="b92ea-103">Runtime Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b92ea-104">Se si esegue la migrazione da .NET Framework 4.7.2 a 4.8, rivedere gli argomenti seguenti per problemi di compatibilità delle applicazioni che possono influire sull'app:</span><span class="sxs-lookup"><span data-stu-id="b92ea-104">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="b92ea-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b92ea-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b92ea-106">Core</span><span class="sxs-lookup"><span data-stu-id="b92ea-106">Core</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b92ea-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b92ea-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b92ea-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b92ea-108">Windows Presentation Foundation (WPF)</span></span>
