---
title: Modifiche di runtime per la migrazione da .NET Framework 4.6.1 a 4.7
description: Trovare informazioni sui problemi di compatibilità delle applicazioni dalle modifiche di runtime che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.6.1 a 4,7.
ms.date: 07/10/2019
...
ms.locfileid: "86443949"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="1b8a5-103">Modifiche di runtime per la migrazione da .NET Framework 4.6.1 a 4.7</span><span class="sxs-lookup"><span data-stu-id="1b8a5-103">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="1b8a5-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.6.1 a 4.7, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="1b8a5-104">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="1b8a5-105">Dati</span><span class="sxs-lookup"><span data-stu-id="1b8a5-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="1b8a5-106">Globalizzazione</span><span class="sxs-lookup"><span data-stu-id="1b8a5-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="1b8a5-107">JIT</span><span class="sxs-lookup"><span data-stu-id="1b8a5-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="1b8a5-108">Security</span><span class="sxs-lookup"><span data-stu-id="1b8a5-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="1b8a5-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="1b8a5-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1b8a5-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1b8a5-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="1b8a5-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="1b8a5-111">Windows Workflow Foundation (WF)</span></span>
