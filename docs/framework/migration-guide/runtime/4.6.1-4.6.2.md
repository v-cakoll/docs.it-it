---
title: Modifiche al runtime per la migrazione da .NET Framework 4.6.1 per 4.6.2
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="74dc7-102">Modifiche al runtime per la migrazione da .NET Framework 4.6.1 per 4.6.2</span><span class="sxs-lookup"><span data-stu-id="74dc7-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="74dc7-103">Se si esegue la migrazione da .NET Framework 4.6.1 per 4.6.2, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:</span><span class="sxs-lookup"><span data-stu-id="74dc7-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="74dc7-104">Base</span><span class="sxs-lookup"><span data-stu-id="74dc7-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="74dc7-105">Dati</span><span class="sxs-lookup"><span data-stu-id="74dc7-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="74dc7-106">Globalizzazione</span><span class="sxs-lookup"><span data-stu-id="74dc7-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="74dc7-107">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="74dc7-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="74dc7-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="74dc7-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="74dc7-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="74dc7-109">Windows Presentation Foundation (WPF)</span></span>
