...
ms.locfileid: "66379392"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="7b1c1-102">Modifiche di runtime per la migrazione da .NET Framework 4.5 a 4.5.2</span><span class="sxs-lookup"><span data-stu-id="7b1c1-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="7b1c1-103">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5 a 4.5.2, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="7b1c1-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="7b1c1-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="7b1c1-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="7b1c1-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="7b1c1-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="7b1c1-106">Base</span><span class="sxs-lookup"><span data-stu-id="7b1c1-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="7b1c1-107">Dati</span><span class="sxs-lookup"><span data-stu-id="7b1c1-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="7b1c1-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="7b1c1-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="7b1c1-109">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="7b1c1-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7b1c1-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="7b1c1-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7b1c1-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="7b1c1-111">Windows Presentation Foundation (WPF)</span></span>
