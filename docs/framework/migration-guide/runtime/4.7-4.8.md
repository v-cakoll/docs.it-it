...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-48"></a>Modifiche di runtime per la migrazione da .NET Framework 4.7 a 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Se si esegue la migrazione da .NET Framework 4.7 a 4.8, rivedere gli argomenti seguenti per problemi di compatibilità delle applicazioni che potrebbero influire sull'app:
