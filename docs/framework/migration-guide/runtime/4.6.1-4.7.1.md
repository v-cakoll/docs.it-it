---
title: Modifiche di runtime per la migrazione da .NET Framework 4.6.1 a 4.7.1 | Microsoft Docs
ms.date: 10/09/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-471"></a><span data-ttu-id="2e053-102">Modifiche di runtime per la migrazione da .NET Framework 4.6.1 a 4.7.1</span><span class="sxs-lookup"><span data-stu-id="2e053-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="2e053-103">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.6.1 a 4.7.1, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="2e053-103">If you are migrating from the .NET Framework 4.6.1 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="2e053-104">Base</span><span class="sxs-lookup"><span data-stu-id="2e053-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="2e053-105">Dati</span><span class="sxs-lookup"><span data-stu-id="2e053-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="2e053-106">Globalizzazione</span><span class="sxs-lookup"><span data-stu-id="2e053-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="2e053-107">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="2e053-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="2e053-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="2e053-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2e053-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2e053-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="2e053-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="2e053-110">Windows Workflow Foundation (WF)</span></span>
