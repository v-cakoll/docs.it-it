...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a>Modifiche al runtime per la migrazione da .NET Framework 4.5 a 4.6.

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Se si esegue la migrazione da .NET Framework 4.5 a 4.6, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:
