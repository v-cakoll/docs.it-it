---
title: Modifiche di runtime per la migrazione da .NET Framework 4.0 a 4.5
description: Trovare informazioni sui problemi di compatibilità delle applicazioni dalle modifiche di runtime che potrebbero incidere sull'app durante la migrazione da .NET Framework 4,0 a 4,5.
ms.date: 07/10/2019
ms.assetid: 1b91cbf2-00f6-41ac-ad7e-9a56a0be6e63
author: chlowell
ms.openlocfilehash: 132a9ca5052d1ae28522b1f6f55b77c8f47c7fca
ms.sourcegitcommit: 2543a78be6e246aa010a01decf58889de53d1636
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 07/17/2020
ms.locfileid: "86443624"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="e7a7b-103">Modifiche di runtime per la migrazione da .NET Framework 4.0 a 4.5</span><span class="sxs-lookup"><span data-stu-id="e7a7b-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="e7a7b-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.0 a 4.5, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="e7a7b-104">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="e7a7b-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e7a7b-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e7a7b-106">Core</span><span class="sxs-lookup"><span data-stu-id="e7a7b-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e7a7b-107">Dati</span><span class="sxs-lookup"><span data-stu-id="e7a7b-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="e7a7b-108">Debugger</span><span class="sxs-lookup"><span data-stu-id="e7a7b-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e7a7b-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e7a7b-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="e7a7b-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="e7a7b-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="e7a7b-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="e7a7b-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="e7a7b-112">Rete</span><span class="sxs-lookup"><span data-stu-id="e7a7b-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="e7a7b-113">Stampa</span><span class="sxs-lookup"><span data-stu-id="e7a7b-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e7a7b-114">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="e7a7b-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="e7a7b-115">Applicazioni Web</span><span class="sxs-lookup"><span data-stu-id="e7a7b-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e7a7b-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e7a7b-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="e7a7b-117">Windows Form</span><span class="sxs-lookup"><span data-stu-id="e7a7b-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e7a7b-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e7a7b-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="e7a7b-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="e7a7b-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="e7a7b-120">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="e7a7b-120">XML, XSLT</span></span>
