...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a>Modifiche al runtime per la migrazione da .NET Framework 4.7 per 4.7.1

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Se si esegue la migrazione dal 4.7 di .NET Framework per 4.7.1, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:
