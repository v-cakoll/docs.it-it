---
title: Modifiche al runtime per la migrazione da .NET Framework 4.7 per 4.7.1 | Documenti Microsoft
ms.date: 10/09/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a><span data-ttu-id="aa401-102">Modifiche al runtime per la migrazione da .NET Framework 4.7 per 4.7.1</span><span class="sxs-lookup"><span data-stu-id="aa401-102">Runtime Changes for Migration from .NET Framework 4.7 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="aa401-103">Se si esegue la migrazione dal 4.7 di .NET Framework per 4.7.1, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:</span><span class="sxs-lookup"><span data-stu-id="aa401-103">If you are migrating from the .NET Framework 4.7 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="jit"></a><span data-ttu-id="aa401-104">JIT</span><span class="sxs-lookup"><span data-stu-id="aa401-104">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="aa401-105">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="aa401-105">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="aa401-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="aa401-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="aa401-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="aa401-107">Windows Presentation Foundation (WPF)</span></span>
