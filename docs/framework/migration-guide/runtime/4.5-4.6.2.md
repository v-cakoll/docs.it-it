---
title: Modifiche al runtime per la migrazione da .NET Framework 4.5 per 4.6.2
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="a5c3a-102">Modifiche al runtime per la migrazione da .NET Framework 4.5 per 4.6.2</span><span class="sxs-lookup"><span data-stu-id="a5c3a-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a5c3a-103">Se si esegue la migrazione da .NET Framework 4.5 per 4.6.2, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:</span><span class="sxs-lookup"><span data-stu-id="a5c3a-103">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="a5c3a-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="a5c3a-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="a5c3a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a5c3a-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a5c3a-106">Base</span><span class="sxs-lookup"><span data-stu-id="a5c3a-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a5c3a-107">Dati</span><span class="sxs-lookup"><span data-stu-id="a5c3a-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a5c3a-108">Debugger</span><span class="sxs-lookup"><span data-stu-id="a5c3a-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a5c3a-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a5c3a-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="a5c3a-110">Globalizzazione</span><span class="sxs-lookup"><span data-stu-id="a5c3a-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="a5c3a-111">Rete</span><span class="sxs-lookup"><span data-stu-id="a5c3a-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="a5c3a-112">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="a5c3a-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a5c3a-113">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="a5c3a-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a5c3a-114">Installazione e distribuzione</span><span class="sxs-lookup"><span data-stu-id="a5c3a-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a5c3a-115">Strumenti</span><span class="sxs-lookup"><span data-stu-id="a5c3a-115">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a5c3a-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a5c3a-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="a5c3a-117">Windows Form</span><span class="sxs-lookup"><span data-stu-id="a5c3a-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a5c3a-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a5c3a-118">Windows Presentation Foundation (WPF)</span></span>
