...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="362ca-102">Modifiche di runtime per la migrazione da .NET Framework 4.0 a 4.5.1</span><span class="sxs-lookup"><span data-stu-id="362ca-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="362ca-103">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.0 a 4.5.1, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="362ca-103">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="362ca-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="362ca-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="362ca-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="362ca-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="362ca-106">Base</span><span class="sxs-lookup"><span data-stu-id="362ca-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="362ca-107">Dati</span><span class="sxs-lookup"><span data-stu-id="362ca-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="362ca-108">Debugger</span><span class="sxs-lookup"><span data-stu-id="362ca-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="362ca-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="362ca-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="362ca-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="362ca-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="362ca-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="362ca-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="362ca-112">Servizi di rete</span><span class="sxs-lookup"><span data-stu-id="362ca-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="362ca-113">Stampa</span><span class="sxs-lookup"><span data-stu-id="362ca-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="362ca-114">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="362ca-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="362ca-115">Applicazioni Web</span><span class="sxs-lookup"><span data-stu-id="362ca-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="362ca-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="362ca-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="362ca-117">Windows Form</span><span class="sxs-lookup"><span data-stu-id="362ca-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="362ca-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="362ca-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="362ca-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="362ca-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="362ca-120">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="362ca-120">XML, XSLT</span></span>
