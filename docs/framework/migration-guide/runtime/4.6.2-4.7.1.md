...
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-471"></a>Modifiche al runtime per la migrazione da .NET Framework 4.6.2 per 4.7.1

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

Se si esegue la migrazione da .NET Framework 4.6.2 per 4.7.1, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:
