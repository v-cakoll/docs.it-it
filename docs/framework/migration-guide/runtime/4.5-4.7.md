---
title: Modifiche di runtime per la migrazione da .NET Framework 4.5 a 4.7
description: Trovare informazioni sui problemi di compatibilità delle applicazioni dalle modifiche di runtime che potrebbero incidere sull'app durante la migrazione da .NET Framework 4,5 a 4,7.
ms.date: 07/10/2019
...
ms.locfileid: "86443585"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="feb97-103">Modifiche di runtime per la migrazione da .NET Framework 4.5 a 4.7</span><span class="sxs-lookup"><span data-stu-id="feb97-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="feb97-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5 a 4.7, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="feb97-104">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="feb97-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="feb97-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="feb97-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="feb97-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="feb97-107">Core</span><span class="sxs-lookup"><span data-stu-id="feb97-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="feb97-108">Dati</span><span class="sxs-lookup"><span data-stu-id="feb97-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="feb97-109">Debugger</span><span class="sxs-lookup"><span data-stu-id="feb97-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="feb97-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="feb97-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="feb97-111">Globalizzazione</span><span class="sxs-lookup"><span data-stu-id="feb97-111">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="feb97-112">JIT</span><span class="sxs-lookup"><span data-stu-id="feb97-112">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="feb97-113">Rete</span><span class="sxs-lookup"><span data-stu-id="feb97-113">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="feb97-114">Security</span><span class="sxs-lookup"><span data-stu-id="feb97-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="feb97-115">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="feb97-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="feb97-116">Installazione e distribuzione</span><span class="sxs-lookup"><span data-stu-id="feb97-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="feb97-117">Strumenti</span><span class="sxs-lookup"><span data-stu-id="feb97-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="feb97-118">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="feb97-118">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="feb97-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="feb97-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="feb97-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="feb97-120">Windows Workflow Foundation (WF)</span></span>
