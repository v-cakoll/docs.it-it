---
title: Modifiche di runtime per la migrazione da .NET Framework 4.5.2 a 4.6.1
description: Trovare informazioni sui problemi di compatibilità delle applicazioni dalle modifiche del runtime che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.5.2 a 4.6.1.
ms.date: 07/10/2019
ms.assetid: 3db16068-c859-45fa-b259-ea36c2bdea77
author: chlowell
ms.openlocfilehash: 6736814c1a13e89af621cc97fa9c14861999ce07
ms.sourcegitcommit: 2543a78be6e246aa010a01decf58889de53d1636
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 07/17/2020
ms.locfileid: "86443442"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="ce9e2-103">Modifiche di runtime per la migrazione da .NET Framework 4.5.2 a 4.6.1</span><span class="sxs-lookup"><span data-stu-id="ce9e2-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="ce9e2-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5.2 a 4.6.1, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="ce9e2-104">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="ce9e2-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ce9e2-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ce9e2-106">Core</span><span class="sxs-lookup"><span data-stu-id="ce9e2-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="ce9e2-107">Dati</span><span class="sxs-lookup"><span data-stu-id="ce9e2-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="ce9e2-108">Debugger</span><span class="sxs-lookup"><span data-stu-id="ce9e2-108">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="ce9e2-109">Rete</span><span class="sxs-lookup"><span data-stu-id="ce9e2-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ce9e2-110">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="ce9e2-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="ce9e2-111">Installazione e distribuzione</span><span class="sxs-lookup"><span data-stu-id="ce9e2-111">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="ce9e2-112">Strumenti</span><span class="sxs-lookup"><span data-stu-id="ce9e2-112">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ce9e2-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ce9e2-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ce9e2-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ce9e2-114">Windows Presentation Foundation (WPF)</span></span>
