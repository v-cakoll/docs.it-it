...
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-472"></a>Modifiche di runtime per la migrazione da .NET Framework 4.6 a 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.6 a 4.7.2, consultare gli argomenti seguenti:
