---
title: Modifiche di runtime per la migrazione da .NET Framework 4.5.2 a 4.7
description: Trovare informazioni sui problemi di compatibilità delle applicazioni dalle modifiche di runtime che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.5.2 a 4,7.
ms.date: 07/10/2019
ms.assetid: 5d1f4b3f-aaff-4638-bdc1-cbb74fdd028d
author: chlowell
ms.openlocfilehash: d9bf4c16546daae9557fa0b39115d581fa4b988d
ms.sourcegitcommit: 2543a78be6e246aa010a01decf58889de53d1636
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 07/17/2020
ms.locfileid: "86442299"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-47"></a><span data-ttu-id="3958a-103">Modifiche di runtime per la migrazione da .NET Framework 4.5.2 a 4.7</span><span class="sxs-lookup"><span data-stu-id="3958a-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="3958a-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5.2 a 4.7, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="3958a-104">If you are migrating from the .NET Framework 4.5.2 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="3958a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3958a-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3958a-106">Core</span><span class="sxs-lookup"><span data-stu-id="3958a-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="3958a-107">Dati</span><span class="sxs-lookup"><span data-stu-id="3958a-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="3958a-108">Debugger</span><span class="sxs-lookup"><span data-stu-id="3958a-108">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="3958a-109">Globalizzazione</span><span class="sxs-lookup"><span data-stu-id="3958a-109">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="3958a-110">JIT</span><span class="sxs-lookup"><span data-stu-id="3958a-110">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="3958a-111">Rete</span><span class="sxs-lookup"><span data-stu-id="3958a-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="3958a-112">Security</span><span class="sxs-lookup"><span data-stu-id="3958a-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="3958a-113">Serializzazione</span><span class="sxs-lookup"><span data-stu-id="3958a-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="3958a-114">Installazione e distribuzione</span><span class="sxs-lookup"><span data-stu-id="3958a-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="3958a-115">Strumenti</span><span class="sxs-lookup"><span data-stu-id="3958a-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3958a-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3958a-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3958a-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3958a-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3958a-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3958a-118">Windows Workflow Foundation (WF)</span></span>
