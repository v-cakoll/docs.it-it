---
title: Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5 a 4.7
description: Trovare informazioni sui problemi di compatibilità delle applicazioni che potrebbero incidere sull'app durante la migrazione da .NET Framework 4,5 a 4,7.
ms.date: 07/10/2019
ms.assetid: 74119a7c-8c43-49ee-a5a4-290ede240741
author: chlowell
ms.openlocfilehash: edfa45d67f868edd88eba77993288f5c27d192d5
ms.sourcegitcommit: 2543a78be6e246aa010a01decf58889de53d1636
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 07/17/2020
ms.locfileid: "86444339"
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="d069f-103">Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5 a 4.7</span><span class="sxs-lookup"><span data-stu-id="d069f-103">Retargeting Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="d069f-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5 a 4.7, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="d069f-104">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="d069f-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="d069f-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="d069f-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="d069f-106">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="d069f-107">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="d069f-107">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="d069f-108">Core</span><span class="sxs-lookup"><span data-stu-id="d069f-108">Core</span></span>
...
## <a name="jit"></a><span data-ttu-id="d069f-109">JIT</span><span class="sxs-lookup"><span data-stu-id="d069f-109">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="d069f-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="d069f-110">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="d069f-111">Rete</span><span class="sxs-lookup"><span data-stu-id="d069f-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="d069f-112">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="d069f-112">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="d069f-113">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="d069f-113">Visual Basic .NET</span></span>

[!INCLUDE[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="d069f-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="d069f-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="d069f-115">Windows Form</span><span class="sxs-lookup"><span data-stu-id="d069f-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="d069f-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="d069f-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="d069f-117">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="d069f-117">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="d069f-118">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="d069f-118">XML, XSLT</span></span>
