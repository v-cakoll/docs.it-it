---
title: Modifiche di reindirizzamento per la migrazione da .NET Framework 4.6 a 4.7.1
description: Trovare informazioni sui problemi di compatibilità delle applicazioni che potrebbero incidere sull'app durante la migrazione da .NET Framework 4,6 a 4.7.1.
ms.date: 07/10/2019
ms.assetid: 4f64e84a-eee3-4613-a2b9-317724a0f82e
author: chlowell
ms.openlocfilehash: bf5f3f08bb70f364986a1e3cc70761ba6314efe1
ms.sourcegitcommit: 2543a78be6e246aa010a01decf58889de53d1636
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 07/17/2020
ms.locfileid: "86444196"
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-471"></a><span data-ttu-id="4046a-103">Modifiche di reindirizzamento per la migrazione da .NET Framework 4.6 a 4.7.1</span><span class="sxs-lookup"><span data-stu-id="4046a-103">Retargeting Changes for Migration from .NET Framework 4.6 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="4046a-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.6 a 4.7.1, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="4046a-104">If you are migrating from the .NET Framework 4.6 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="4046a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="4046a-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="4046a-106">Core</span><span class="sxs-lookup"><span data-stu-id="4046a-106">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="4046a-107">Rete</span><span class="sxs-lookup"><span data-stu-id="4046a-107">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="4046a-108">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="4046a-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4046a-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4046a-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="4046a-110">Windows Form</span><span class="sxs-lookup"><span data-stu-id="4046a-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4046a-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4046a-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="4046a-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="4046a-112">Windows Workflow Foundation (WF)</span></span>
