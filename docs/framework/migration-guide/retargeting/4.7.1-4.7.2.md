...
description: Trovare informazioni sui problemi di compatibilità delle applicazioni che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.7.1 a 4.7.2.
ms.date: 07/10/2019
...
ms.locfileid: "86444066"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-472"></a><span data-ttu-id="1c12a-103">Modifiche di reindirizzamento per la migrazione da .NET Framework 4.7.1 a 4.7.2</span><span class="sxs-lookup"><span data-stu-id="1c12a-103">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="1c12a-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.7.1 a 4.7.2, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="1c12a-104">If you are migrating from the .NET Framework 4.7.1 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="1c12a-105">Core</span><span class="sxs-lookup"><span data-stu-id="1c12a-105">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="1c12a-106">Windows Form</span><span class="sxs-lookup"><span data-stu-id="1c12a-106">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1c12a-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1c12a-107">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="1c12a-108">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="1c12a-108">Windows Workflow Foundation (WF)</span></span>
