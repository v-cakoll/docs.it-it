...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-48"></a>Modifiche di reindirizzamento per la migrazione da .NET Framework 4.6 a 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Se si esegue la migrazione da .NET Framework 4.6 a 4.8, rivedere gli argomenti seguenti per problemi di compatibilità delle applicazioni che potrebbero influire sull'app:
