...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a>Le modifiche di reindirizzamento per la migrazione da .NET Framework 4.0 a 4.5

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Se si esegue la migrazione da .NET Framework 4.0 a 4.5, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:
