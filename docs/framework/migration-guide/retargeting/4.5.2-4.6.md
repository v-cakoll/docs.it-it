...
description: Trovare informazioni sui problemi di compatibilità delle applicazioni che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.5.2 a 4,6.
ms.date: 07/10/2019
ms.assetid: 7512a59c-a479-42da-9490-9ff398e7fabc
author: chlowell
ms.openlocfilehash: 7841eb5015b0c710d5371a76079a29e541a7f565
ms.sourcegitcommit: 2543a78be6e246aa010a01decf58889de53d1636
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 07/17/2020
ms.locfileid: "86443741"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="001af-103">Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5.2 a 4.6</span><span class="sxs-lookup"><span data-stu-id="001af-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="001af-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5.2 a 4.6, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="001af-104">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="001af-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="001af-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="001af-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="001af-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="001af-107">Core</span><span class="sxs-lookup"><span data-stu-id="001af-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="001af-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="001af-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="001af-109">JIT</span><span class="sxs-lookup"><span data-stu-id="001af-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="001af-110">Rete</span><span class="sxs-lookup"><span data-stu-id="001af-110">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="001af-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="001af-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="001af-112">Windows Form</span><span class="sxs-lookup"><span data-stu-id="001af-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="001af-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="001af-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="001af-114">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="001af-114">XML, XSLT</span></span>
