---
title: Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5.2 a 4.6.1
description: Trovare informazioni sui problemi di compatibilità delle applicazioni che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.5.2 a 4.6.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443767"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="afe3a-103">Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5.2 a 4.6.1</span><span class="sxs-lookup"><span data-stu-id="afe3a-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="afe3a-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5.2 a 4.6.1, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="afe3a-104">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="afe3a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="afe3a-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="afe3a-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="afe3a-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="afe3a-107">Core</span><span class="sxs-lookup"><span data-stu-id="afe3a-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="afe3a-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="afe3a-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="afe3a-109">JIT</span><span class="sxs-lookup"><span data-stu-id="afe3a-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="afe3a-110">Rete</span><span class="sxs-lookup"><span data-stu-id="afe3a-110">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="afe3a-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="afe3a-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="afe3a-112">Windows Form</span><span class="sxs-lookup"><span data-stu-id="afe3a-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="afe3a-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="afe3a-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="afe3a-114">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="afe3a-114">XML, XSLT</span></span>
