---
title: Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5.2 a 4.7.2
description: Trovare informazioni sui problemi di compatibilità delle applicazioni che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.5.2 a 4.7.2.
ms.date: 07/10/2019
ms.assetid: b4911bd2-cc6d-4a14-9753-28d90d880948
author: chlowell
ms.openlocfilehash: b5186e62bfd3e1b89722ea58b254ac32fe3c93de
ms.sourcegitcommit: 2543a78be6e246aa010a01decf58889de53d1636
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 07/17/2020
ms.locfileid: "86443754"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-472"></a><span data-ttu-id="877e2-103">Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5.2 a 4.7.2</span><span class="sxs-lookup"><span data-stu-id="877e2-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="877e2-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5.2 a 4.7.2, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="877e2-104">If you are migrating from the .NET Framework 4.5.2 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="877e2-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="877e2-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="877e2-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="877e2-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="877e2-107">Core</span><span class="sxs-lookup"><span data-stu-id="877e2-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="877e2-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="877e2-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="877e2-109">JIT</span><span class="sxs-lookup"><span data-stu-id="877e2-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="877e2-110">Rete</span><span class="sxs-lookup"><span data-stu-id="877e2-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="877e2-111">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="877e2-111">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="877e2-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="877e2-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="877e2-113">Windows Form</span><span class="sxs-lookup"><span data-stu-id="877e2-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="877e2-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="877e2-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="877e2-115">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="877e2-115">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="877e2-116">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="877e2-116">XML, XSLT</span></span>
