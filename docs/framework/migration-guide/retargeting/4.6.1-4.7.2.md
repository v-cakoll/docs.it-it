...
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-472"></a>Modifiche di reindirizzamento per la migrazione da .NET Framework 4.6.1 a 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da .NET Framework 4.6.1 a 4.7.2, consultare gli argomenti seguenti:
