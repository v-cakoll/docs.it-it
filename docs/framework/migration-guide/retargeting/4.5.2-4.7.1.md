---
title: Le modifiche di reindirizzamento per la migrazione da .NET Framework 4.5.2 per 4.7.1 | Documenti Microsoft
ms.date: 10/09/2017
...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="c40ba-102">Le modifiche di reindirizzamento per la migrazione da .NET Framework 4.5.2 per 4.7.1</span><span class="sxs-lookup"><span data-stu-id="c40ba-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="c40ba-103">Se si esegue la migrazione da .NET Framework 4.5.2 per 4.7.1, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:</span><span class="sxs-lookup"><span data-stu-id="c40ba-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c40ba-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c40ba-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="c40ba-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="c40ba-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="c40ba-106">Base</span><span class="sxs-lookup"><span data-stu-id="c40ba-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c40ba-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c40ba-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="c40ba-108">JIT</span><span class="sxs-lookup"><span data-stu-id="c40ba-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="c40ba-109">Rete</span><span class="sxs-lookup"><span data-stu-id="c40ba-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="c40ba-110">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="c40ba-110">Security</span></span>
...
## <a name="wpf"></a><span data-ttu-id="c40ba-111">WPF</span><span class="sxs-lookup"><span data-stu-id="c40ba-111">WPF</span></span>

[!include[Accessibility improvements in WPF](~/includes/migration-guide/retargeting/wpf/accessibility-improvements-wpf.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c40ba-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c40ba-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="c40ba-113">Windows Form</span><span class="sxs-lookup"><span data-stu-id="c40ba-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c40ba-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c40ba-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c40ba-115">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="c40ba-115">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="c40ba-116">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="c40ba-116">XML, XSLT</span></span>
