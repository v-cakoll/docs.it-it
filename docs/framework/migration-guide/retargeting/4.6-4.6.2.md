...
ms.locfileid: "59193031"
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-462"></a><span data-ttu-id="e9678-102">Modifiche di reindirizzamento per la migrazione da .NET Framework 4.6 a 4.6.2</span><span class="sxs-lookup"><span data-stu-id="e9678-102">Retargeting Changes for Migration from .NET Framework 4.6 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="e9678-103">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.6 a 4.6.2, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="e9678-103">If you are migrating from the .NET Framework 4.6 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="e9678-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e9678-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e9678-105">Base</span><span class="sxs-lookup"><span data-stu-id="e9678-105">Core</span></span>
...
## <a name="security"></a><span data-ttu-id="e9678-106">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="e9678-106">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e9678-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e9678-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="e9678-108">Windows Form</span><span class="sxs-lookup"><span data-stu-id="e9678-108">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e9678-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e9678-109">Windows Presentation Foundation (WPF)</span></span>
