...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-462"></a>Le modifiche di reindirizzamento per la migrazione da .NET Framework 4.6 per 4.6.2

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

Se si esegue la migrazione da .NET Framework 4.6 per 4.6.2, esaminare gli argomenti seguenti per i problemi di compatibilità delle applicazioni che potrebbero incidere sull'app:
