---
title: Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5.2 a 4.6.2
description: Trovare informazioni sui problemi di compatibilità delle applicazioni che potrebbero incidere sull'app durante la migrazione da .NET Framework 4.5.2 a 4.6.2.
ms.date: 07/10/2019
...
ms.locfileid: "86444235"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-462"></a><span data-ttu-id="caf27-103">Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5.2 a 4.6.2</span><span class="sxs-lookup"><span data-stu-id="caf27-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="caf27-104">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5.2 a 4.6.2, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="caf27-104">If you are migrating from the .NET Framework 4.5.2 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="caf27-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="caf27-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="caf27-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="caf27-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="caf27-107">Core</span><span class="sxs-lookup"><span data-stu-id="caf27-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="caf27-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="caf27-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="caf27-109">JIT</span><span class="sxs-lookup"><span data-stu-id="caf27-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="caf27-110">Rete</span><span class="sxs-lookup"><span data-stu-id="caf27-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="caf27-111">Sicurezza</span><span class="sxs-lookup"><span data-stu-id="caf27-111">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="caf27-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="caf27-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="caf27-113">Windows Form</span><span class="sxs-lookup"><span data-stu-id="caf27-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="caf27-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="caf27-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="caf27-115">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="caf27-115">XML, XSLT</span></span>
