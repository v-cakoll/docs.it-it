...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="b042f-102">Modifiche di reindirizzamento per la migrazione da .NET Framework 4.5 a 4.5.1</span><span class="sxs-lookup"><span data-stu-id="b042f-102">Retargeting Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="b042f-103">Per problemi di compatibilità delle applicazioni che potrebbero incidere sull'app se si esegue la migrazione da NET Framework 4.5 a 4.5.1, consultare gli argomenti seguenti:</span><span class="sxs-lookup"><span data-stu-id="b042f-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b042f-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b042f-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b042f-105">Base</span><span class="sxs-lookup"><span data-stu-id="b042f-105">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b042f-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b042f-106">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="b042f-107">MSBuild</span><span class="sxs-lookup"><span data-stu-id="b042f-107">MSBuild</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b042f-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b042f-108">Windows Presentation Foundation (WPF)</span></span>
