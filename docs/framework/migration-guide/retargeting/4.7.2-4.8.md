...
ms.locfileid: "68238231"
---
# <a name="retargeting-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="3d196-102">Modifiche di ridestinazione per la migrazione da .NET Framework 4.7.2 a 4.8</span><span class="sxs-lookup"><span data-stu-id="3d196-102">Retargeting Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="3d196-103">Se si esegue la migrazione da .NET Framework 4.7.2 a 4.8, rivedere gli argomenti seguenti per problemi di compatibilità delle applicazioni che possono influire sull'app:</span><span class="sxs-lookup"><span data-stu-id="3d196-103">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="3d196-104">Base</span><span class="sxs-lookup"><span data-stu-id="3d196-104">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3d196-105">Windows Form</span><span class="sxs-lookup"><span data-stu-id="3d196-105">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3d196-106">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3d196-106">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3d196-107">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3d196-107">Windows Workflow Foundation (WF)</span></span>
