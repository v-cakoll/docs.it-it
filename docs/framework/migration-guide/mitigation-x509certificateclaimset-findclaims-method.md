...
## <a name="impact"></a>Impatto  
 ...
 Per le app destinate a versioni precedenti di .NET Framework, il metodo <xref:System.IdentityModel.Claims.X509CertificateClaimSet.FindClaims%2A?displayProperty=fullName> cerca di far corrispondere l'argomento `claimType` solo con l'ultima voce DNS.  
