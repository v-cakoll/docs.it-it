...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 Vengono offerte indicazioni sull'uso dell'evento <xref:System.AppDomain.AssemblyResolve?displayProperty=fullName> per risolvere gli errori di caricamento di assembly.  
