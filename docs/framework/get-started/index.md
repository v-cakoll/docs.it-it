...
> [!NOTE]
> .NET Framework è disponibile solo su sistemi Windows. È possibile usare [.NET Core](../../core/index.md) per eseguire app in Windows, MacOS e Linux.
...
- [Guida di .NET Framework](../index.md)
