...
- Nella documentazione di Windows SDK, vedere la sezione di [guida alla programmazione per Windows a 64 bit](https://go.microsoft.com/fwlink/p/?LinkId=253512).  
