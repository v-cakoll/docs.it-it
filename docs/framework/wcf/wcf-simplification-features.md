...
|receiveTimeout|SMSvcHost.exe|30 secondi|Questa proprietà specifica il timeout per la lettura dei dati sui frame TCP e per l'esecuzione dell'invio della connessione dalle connessioni sottostanti. Questa proprietà è utile per applicare un limite al tempo in cui il servizio SMSvcHost.exe viene utilizzato per leggere i dati del preambolo da una connessione in ingresso. [!INCLUDE[crdefault](../../../includes/crdefault-md.md)][Configurazione il servizio di condivisione delle porte Net.TCP](http://msdn.microsoft.com/en-us/b6dd81fa-68b7-4e1b-868e-88e5901b7ea0).|  
