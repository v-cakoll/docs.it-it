...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Illustra gli scenari di associazione dati WCF.  
 ...
 Viene illustrato come consentire agli sviluppatori WCF di utilizzare oggetti arbitrari deserializzati JSON, senza creare tipi definiti dall'utente.  
  
 [Servizio facciata attendibile](../../../../docs/framework/wcf/samples/trusted-facade-service.md)  
 Viene illustrato come propagare le informazioni di identità del chiamante da un servizio in un altro usando un'infrastruttura di sicurezza WCF.  
