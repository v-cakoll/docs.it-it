...
In questa sezione è inclusi esempi che descrivono i trasporti personalizzati in Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 In questo esempio viene illustrato come implementare una sessione duplex TCP come un trasporto personalizzato di Windows Communication Foundation (WCF).
