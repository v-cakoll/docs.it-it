...
Contenuto della sezione sono inclusi esempi che descrivono i servizi [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].  
...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 [Codice imperativo](../../../../docs/framework/wcf/samples/imperative.md)  
 ...
 [Contratti multipli](../../../../docs/framework/wcf/samples/multiple-contracts.md)  
 ...
 [Più endpoint in un solo ListenUri](../../../../docs/framework/wcf/samples/multiple-endpoints-at-a-single-listenuri.md)  
