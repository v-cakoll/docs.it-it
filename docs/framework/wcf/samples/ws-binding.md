...
Questa sezione include esempi che illustrano l'associazione di servizi Windows in [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)].  
...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 [Associazione di sicurezza messaggio](../../../../docs/framework/wcf/samples/message-security-binding.md)  
 Viene illustrato l'utilizzo della sicurezza dei messaggi in [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
  
 [Trasporto WS con credenziali messaggio](../../../../docs/framework/wcf/samples/ws-transport-with-message-credential.md)  
