...
In questo esempio viene illustrato come implementare e configurare un servizio tipico e un client con Windows Communication Foundation (WCF). Questo esempio è la base per tutti gli altri esempi di tecnologia di base.  
