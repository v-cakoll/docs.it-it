...
In questa sezione è contenuti esempi che illustrano i comportamenti del servizio Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 [Comportamento predefinito del servizio](../../../../docs/framework/wcf/samples/default-service-behavior.md)  
 ...
 [Comportamento delle transazioni di un servizio](../../../../docs/framework/wcf/samples/service-transaction-behavior.md)  
 ...
 [Limitazione](../../../../docs/framework/wcf/samples/throttling.md)  
 Viene illustrato l'utilizzo dei controlli di limitazione.  
  
 [Sicurezza dei comportamenti](../../../../docs/framework/wcf/samples/behavior-security.md)  
