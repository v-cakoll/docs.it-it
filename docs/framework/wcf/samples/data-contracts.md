...
ms.locfileid: "33499836"
---
# <a name="data-contracts"></a>Contratti dati
In questa sezione è contenuti esempi che illustrano i contratti dati in Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Illustra la classe <xref:System.Runtime.Serialization.DataContractSerializer>, che esegue servizi generali di serializzazione e di deserializzazione per le classi del contratto dati.  
  
 [Tipi conosciuti](../../../../docs/framework/wcf/samples/known-types.md)  
 Illustra come specificare informazioni sui tipi derivati in un contratto dati.  
