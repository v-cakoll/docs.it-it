...
## <a name="service-configuration"></a><span data-ttu-id="a20d1-110">Service Configuration</span><span class="sxs-lookup"><span data-stu-id="a20d1-110">Service Configuration</span></span>  
