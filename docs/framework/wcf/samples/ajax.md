...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene illustrato come usare WCF per creare un servizio ASP.NET Asynchronous JavaScript and XML (AJAX) base.  
  
 [Servizio AJAX con il protocollo HTTP POST](../../../../docs/framework/wcf/samples/ajax-service-using-http-post.md)  
 Viene illustrato come usare WCF per creare un [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] servizio Asynchronous JavaScript and XML (AJAX) che utilizza HTTP POST.  
 ...
 Viene illustrato come usare WCF per creare un servizio ASP.NET Asynchronous JavaScript and XML (AJAX) che crea istanze di tipi complessi.  
  
 [Servizio AJAX con esempi JSON e XML](../../../../docs/framework/wcf/samples/ajax-service-with-json-and-xml-sample.md)  
 Viene illustrato come usare WCF per creare un servizio Asynchronous JavaScript and XML (AJAX) che restituisce dati JavaScript Object Notation (JSON) o XML.
