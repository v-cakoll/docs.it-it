...
> La procedura di installazione e le istruzioni di compilazione per questo esempio si trovano alla fine di questo argomento.  
 ...
 Questo esempio espone il `ICalculator` contratto [ \<utilizzando wsHttpBinding >](../../../../docs/framework/configure-apps/file-schema/wcf/wshttpbinding.md). La configurazione di questa associazione è stata espansa nel file Web.config.  
...
```  
 ...
 Nell'elemento [> ReliableSession,ilvalorebooleanoEnabledconfigurasesonoabilitatelesessioniaffidabili.\<](../../../../docs/framework/configure-apps/file-schema/wcf/reliablesession.md) Il valore `ordered` configura se l'ordinamento dei messaggi viene mantenuto. Il valore `inactivityTimeout` configura per quanto tempo una sessione può essere inattiva prima che venga generato un errore.  
  
 `mode` [ Nel>disicurezza,ilvaloreconfiguralamodalitàdi\<](../../../../docs/framework/configure-apps/file-schema/wcf/security-of-wshttpbinding.md)sicurezza da utilizzare. In questo esempio viene utilizzata la sicurezza dei messaggi, motivo per cui il [ \<messaggio >](../../../../docs/framework/configure-apps/file-schema/wcf/message-of-wshttpbinding.md) viene specificato all'interno del [ \<> di sicurezza](../../../../docs/framework/configure-apps/file-schema/wcf/security-of-wshttpbinding.md).  
