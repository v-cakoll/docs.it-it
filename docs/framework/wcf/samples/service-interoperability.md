...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 Viene descritto come creare un servizio utilizzando [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] e quindi accedere al servizio da un client non [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)], ad esempio un client ASMX.
