...
In questa sezione è contenuti esempi che illustrano l'hosting dei servizi Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene descritta l'attivazione dei servizi WCF senza richiedere un file con estensione svc.  
