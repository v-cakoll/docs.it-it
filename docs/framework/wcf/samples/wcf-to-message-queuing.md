...
> [!NOTE]
>  Questo esempio richiede l'installazione di accodamento messaggi. Vedere le istruzioni di installazione in [Accodamento](http://go.microsoft.com/fwlink/?LinkId=94968).  
