...
```  
 ...
 L'elemento `<in-reply-to>` specifica tre attributi obbligatori (`ref`, `type` e `href`), consentendo anche la presenza di attributi di estensione ed elementi di estensione aggiuntivi.  
