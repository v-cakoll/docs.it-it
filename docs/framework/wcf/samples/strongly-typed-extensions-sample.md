...
```  
 ...
 L' `<in-reply-to>` elemento specifica tre attributi obbligatori`ref`( `type` , `href`e), consentendo anche la presenza di attributi di estensione ed elementi di estensione aggiuntivi.  
