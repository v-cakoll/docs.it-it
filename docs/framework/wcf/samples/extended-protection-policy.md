...
1.  Installare Internet Information Services da **Pannello di controllo**, **Aggiungi/Rimuovi programmi**, **le funzionalità di Windows**.  
  
2.  Installare **l'autenticazione di Windows** in **le funzionalità di Windows**, **Internet Information Services**, **servizi World Wide Web**,  **Sicurezza**, e **l'autenticazione di Windows**.  
  
3.  Installare **Windows Communication Foundation HTTP Activation** in **le funzionalità di Windows**, **Microsoft .NET Framework 3.5.1**, e **comunicazione Windows Attivazione HTTP Foundation**.  
...
4.  In questo esempio il client deve stabilire un canale protetto con il server, di conseguenza è necessario che sia presente un certificato del server che può essere installato da Gestione Internet Information Services.  
    ...
    1.  Aprire Gestione IIS. Aprire **certificati Server**, che viene visualizzato il **funzionalità** scheda quando è selezionato il nodo radice (nome del computer).  
...
7.  Aprire Gestione IIS. Fare clic sulla directory virtuale (**ExtendedProtection**), che è stato creato nel passaggio precedente. Selezionare **Converti in applicazione**.  
  
8.  Aprire il **autenticazione** modulo in Gestione IIS per questa directory virtuale e abilitare **l'autenticazione di Windows**.  
  
9. Aprire **impostazioni avanzate** in **l'autenticazione di Windows** per questa directory virtuale e impostarlo su **necessari**.  
