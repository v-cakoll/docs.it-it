...
3. Nel computer client configurare MSDTC per consentire le transazioni di rete in uscita.  
    ...
    1. Dal menu **Start** passare a, quindi `Control Panel`strumenti di **Amministrazione**e quindi **Servizi componenti**.  
