...
## <a name="using-the-wcf-client"></a>Utilizzo del client WCF  
 Per utilizzare il client di WCF, creare un'istanza del client WCF e quindi chiamarne i metodi, come illustrato nel codice seguente.  
