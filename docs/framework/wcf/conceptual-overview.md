...
In questo argomento riepiloga le informazioni su Windows Communication Foundation (WCF) sistema e le classi che ne supportano l'utilizzo di messaggistica.  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Una struttura dei concetti principali del modello di programmazione WCF.  
  
 [Architettura di Windows Communication Foundation](../../../docs/framework/wcf/architecture.md)  
 Rappresentazione grafica dell'architettura di WCF.  
