...
## <a name="description"></a>Descrizione  
 L'operazione Request/Reply non ha un Reply Message.  
  
 Questa operazione bidirezionale non presenta alcuna risposta da inviare al client. Questa traccia può essere utilizzata per l'esecuzione del debug in fase di sviluppo.  
