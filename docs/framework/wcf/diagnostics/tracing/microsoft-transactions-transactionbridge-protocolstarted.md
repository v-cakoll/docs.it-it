...
ms.locfileid: "54531995"
---
# <a name="microsofttransactionstransactionbridgeprotocolstarted"></a>Microsoft.Transactions.TransactionBridge.ProtocolStarted
Il servizio del protocollo WS-Atomic Transaction è stato avviato.  
  
## <a name="description"></a>Descrizione  
 Viene tracciato durante l'avvio del gestore transazioni per indicare quale protocollo è stato avviato correttamente.  
