...
## <a name="description"></a>Descrizione  
 Si sono verificati errori su ServiceHost durante la chiamata di ReleasePerformanceCounters. Questa traccia può essere utilizzata per determinare gli errori quando vengono rilasciati i contatori delle prestazioni.  
