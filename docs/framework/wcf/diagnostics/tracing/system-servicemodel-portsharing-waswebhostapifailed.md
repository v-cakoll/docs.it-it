...
## <a name="description"></a>Descrizione  
 La chiamata dell'API del servizio di attivazione dei processo di Windows (WAS, Windows Process Activation Service) non è riuscita e ha generato il codice di errore specificato.  
