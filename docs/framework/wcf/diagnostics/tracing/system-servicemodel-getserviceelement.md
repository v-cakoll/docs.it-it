...
## <a name="description"></a>Descrizione  
 Questa traccia viene emessa quando si costruisce un host del servizio, al livello delle informazioni. Fornisce una descrizione dell'associazione e del contratto di servizio.  
