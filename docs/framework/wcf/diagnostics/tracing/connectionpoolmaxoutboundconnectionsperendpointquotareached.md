...
## <a name="description"></a>Descrizione  
 È stata raggiunta la quota di MaxOutboundConnectionsPerEndpoint, pertanto la connessione è stata chiusa e non è stata memorizzata in questo pool di connessioni.  
