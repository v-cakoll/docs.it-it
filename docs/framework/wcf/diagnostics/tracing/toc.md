# [Traccia](index.md)
## [Configurazione della traccia](configuring-tracing.md)
## [Traccia end-to-End](end-to-end-tracing.md)
### [Attività](activity.md)
### [Trasferimento](transfer.md)
### [Propagazione](propagation.md)
### [Riepilogo del tipo di traccia](trace-type-summary.md)
## [Utilizzo delle tracce per risolvere i problemi dell'applicazione](using-tracing-to-troubleshoot-your-application.md)
...
### [Scenari di traccia end-To-End](end-to-end-tracing-scenarios.md)
#### [Elenco attività](activity-list.md)
#### [Propagazione dell'ID attività](activity-id-propagation.md)
#### [Scenari sincroni con HTTP, TCP o Named Pipe](synchronous-scenarios-using-http-tcp-or-named-pipe.md)
#### [Scenari asincroni con HTTP, TCP o Named Pipe](asynchronous-scenarios-using-http-tcp-or-named-pipe.md)
#### [Traccia attività relative alla sicurezza dei messaggi](activity-tracing-in-message-security.md)
#### [MSMQ](msmq.md)
#### [COM+](com.md)
### [Tracce significative](significant-traces.md)
### [Il debug sul Client](debugging-on-the-client.md)
### [Creazione di tracce di codice utente](emitting-user-code-traces.md)
## [Impostazioni consigliate per la traccia e registrazione dei messaggi](recommended-settings-for-tracing-and-message-logging.md)
