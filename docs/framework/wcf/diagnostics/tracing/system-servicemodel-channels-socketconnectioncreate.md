...
## <a name="description"></a>Descrizione  
 Questa traccia viene generata nella prima attività ProcessAction eseguita dal client e nell'attività ReceiveBytes del servizio. Fornisce gli indirizzi IP locali e remoti. Inoltre, viene generata al livello delle informazioni.  
