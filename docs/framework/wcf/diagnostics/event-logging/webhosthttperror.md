...
## <a name="description"></a>Descrizione  
 Questo evento indica che si è verificata un'eccezione HTTP WebHost. Vengono indicati informazioni sul mittente, HtmlErrorMessage, eccezione, nome e ID del processo.  
