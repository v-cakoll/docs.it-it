...
## <a name="description"></a>Descrizione  
 Questo evento indica che si verifica un errore durante l'avvio dell'inizializzatore DllHost. Viene elencato l'AppID, l'eccezione, il nome e l'ID del processo.  
