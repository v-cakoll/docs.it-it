...
## <a name="description"></a>Descrizione  
 Questo evento indica che l'avvio e il recupero del servizio del protocollo WS-AtomicTransaction sono stati completati correttamente. Vengono indicati l'ID e il nome del protocollo e del processo.  
