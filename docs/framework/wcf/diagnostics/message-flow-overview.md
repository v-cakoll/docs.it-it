...
-   Modello di attività end-to-end per i servizi WCF/WF: questa funzionalità supporta la correlazione di tracce generate dagli spazi dei nomi <xref:System.ServiceModel> e <xref:System.Workflow.ComponentModel>.  
...
10. Aggiornare ed esaminare il **analitico** log.  Cercare gli eventi con ID evento 220.  Selezionare l'evento, quindi scegliere il **dettagli** scheda nel riquadro di anteprima. Questo evento conterrà l'ID di correlazione per l'attività chiamante.  
