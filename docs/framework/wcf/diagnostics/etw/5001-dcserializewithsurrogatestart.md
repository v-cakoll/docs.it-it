...
## <a name="description"></a>Descrizione  
 Questo evento viene generato all'avvio della serializzazione di DataContract con surrogati.  
  
## <a name="message"></a>Messaggio  
 Avvio serializzazione di %1 da parte di DataContract con surrogati.  
