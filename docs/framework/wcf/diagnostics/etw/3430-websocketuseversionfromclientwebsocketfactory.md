...
## <a name="description"></a>Descrizione  
 Questo evento viene generato durante l'uso di WebSocketVersion da una factory WebSocket client.  
  
## <a name="message"></a>Messaggio  
 Uso di WebSocketVersion da una factory WebSocket client di tipo '%1'.  
