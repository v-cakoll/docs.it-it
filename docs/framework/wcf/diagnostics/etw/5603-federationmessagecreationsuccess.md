...
## <a name="description"></a>Descrizione  
 Questo evento viene generato al completamento della creazione del messaggio federato dal Post del form.  
  
## <a name="message"></a>Messaggio  
 Creazione messaggio della federazione dal Post del form completata.  
