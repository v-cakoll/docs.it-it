...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando la sicurezza del flusso di Windows accetta l'aggiornamento di sicurezza.  
  
## <a name="message"></a>Messaggio  
 Sicurezza flusso Windows all'accettazione dell'aggiornamento.  
