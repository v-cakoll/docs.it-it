...
## <a name="description"></a>Descrizione  
 Questo evento viene generato all'avvio dell'ascolto del listener di trasporto della pipe.  
  
## <a name="message"></a>Messaggio  
 Avvio dell'ascolto del listener di trasporto della pipe sull'URI:%1.  
