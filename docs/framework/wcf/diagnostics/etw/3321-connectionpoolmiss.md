...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando il pool non ha connessioni disponibili.  
  
## <a name="message"></a>Messaggio  
 Il pool per %1 non ha nessuna connessione disponibile e %2 connessioni occupate.  
