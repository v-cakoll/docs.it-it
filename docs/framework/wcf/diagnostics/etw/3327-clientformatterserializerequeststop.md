...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando il client completa la serializzazione del messaggio di richiesta.  
  
## <a name="message"></a>Messaggio  
 Il cliente ha completato la serializzazione del messaggio di richiesta.  
