...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando il servizio di routing chiama un'interruzione su un canale specifico.  
  
## <a name="message"></a>Messaggio  
 Il servizio di routing richiede l'interruzione sul canale: '%1'.  
