...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando non viene usata la channel factory dalla cache.  
  
## <a name="message"></a>Messaggio  
 Channel factory non utilizzata dalla cache, ad esempio la memorizzazione nella cache disattivata.  
