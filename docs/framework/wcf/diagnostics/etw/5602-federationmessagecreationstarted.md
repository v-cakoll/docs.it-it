...
## <a name="description"></a>Descrizione  
 Questo evento viene generato all'avvio della creazione del messaggio federato dal Post del form.  
  
## <a name="message"></a>Messaggio  
 Creazione messaggio della federazione dal Post del form avviata.  
