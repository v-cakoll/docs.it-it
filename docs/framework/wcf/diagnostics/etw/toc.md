# [Traccia analitica con ETW](index.md)
...
## [Configurazione di traccia del flusso di messaggi](configuring-message-flow-tracing.md)
## [Riferimento all'evento di traccia analitica](analytic-trace-event-reference.md)
...
### [57399 - occasione di TraceCodeEventLogCritical](57399-tracecodeeventlogcritical.md)
...
## [Monitoraggio errori nelle operazioni di servizio](monitoring-service-operation-failures.md)
