...
## <a name="description"></a>Descrizione  
 Questo evento viene generato per fornire le informazioni sulla percentuale di messaggi in sospeso per canale.  
  
## <a name="message"></a>Messaggio  
 Percentuale messaggi in sospeso per canale: %1/%2  
