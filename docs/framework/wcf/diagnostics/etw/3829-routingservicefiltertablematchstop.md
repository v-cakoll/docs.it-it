...
## <a name="description"></a>Descrizione  
 Questo evento viene generato all'arresto della corrispondenza di MessageFilterTable del servizio di routing.  
  
## <a name="message"></a>Messaggio  
 Arresto corrispondenza MessageFilterTable servizio di routing.  
