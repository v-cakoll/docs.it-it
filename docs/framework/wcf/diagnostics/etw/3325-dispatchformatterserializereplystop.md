...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando il dispatcher completa la serializzazione del messaggio di risposta.  
  
## <a name="message"></a>Messaggio  
 Il dispatcher ha completato la serializzazione del messaggio di risposta.  
