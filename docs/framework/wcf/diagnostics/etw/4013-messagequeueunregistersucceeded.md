...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando l'annullamento della registrazione della coda di messaggi è stato completato.  
  
## <a name="message"></a>Messaggio  
 Annullamento della registrazione della coda di messaggi completato per l'URI:'%1'.  
