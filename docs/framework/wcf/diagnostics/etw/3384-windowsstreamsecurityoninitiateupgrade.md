...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando WindowsStreamSecurity avvia l'aggiornamento di sicurezza.  
  
## <a name="message"></a>Messaggio  
 Avvio dell'aggiornamento di sicurezza da parte di WindowsStreamSecurity.  
