...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando la quota massima di connessioni server in pool viene raggiunta.  
  
## <a name="message"></a>Messaggio  
 Quota massima connessioni server in pool di server raggiunta.  
