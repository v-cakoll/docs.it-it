...
## <a name="description"></a>Descrizione  
 Questo evento viene generato al completamento dell'impostazione dell'entità dal token di sessione.  
  
## <a name="message"></a>Messaggio  
 Impostazione principale dal token di sessione completata.  
