...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando il servizio di routing esegue il commit di un messaggio.  
  
## <a name="message"></a>Messaggio  
 Servizio di routing: è in corso il commit di una transazione con ID '%1'.  
