...
## <a name="description"></a>Descrizione  
 Questo evento viene generato quando il client avvia la deserializzazione del messaggio di risposta.  
  
## <a name="message"></a>Messaggio  
 Il client ha avviato la deserializzazione del messaggio di risposta.  
