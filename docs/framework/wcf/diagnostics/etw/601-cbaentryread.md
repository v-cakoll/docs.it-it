...
## <a name="description"></a>Descrizione  
 Questo evento viene generato con lettura di CBAEntry.  
  
## <a name="message"></a>Messaggio  
 Indirizzo relativo dell'elemento ServiceActivation elaborato:'%1', indirizzo relativo normalizzato '%2'.  
