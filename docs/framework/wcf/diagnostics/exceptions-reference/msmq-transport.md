...
|MsmqReceiveError|Errore durante la ricezione di un messaggio dalla coda. Verificare che MSMQ sia installato e in esecuzione. e che la coda sia disponibile per la ricezione.|  
