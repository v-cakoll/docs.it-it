...
|IIS 5.1, [!INCLUDE[iis601](../../../includes/iis601-md.md)]|-Esecuzione di un servizio WCF side-by-side con contenuto ASP.NET su Internet utilizzando il protocollo HTTP.|-Riciclo del processo.<br />-Arresto inattivo.<br />-Elaborare il monitoraggio dell'integrità.<br />-Attivazione basata su messaggi.<br />-Solo HTTP.|  
