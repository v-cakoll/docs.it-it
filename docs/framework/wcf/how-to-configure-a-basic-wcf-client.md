...
Per altre informazioni su come usare il client generato con questa configurazione, vedere [procedura: usare un Client](../../../docs/framework/wcf/how-to-use-a-wcf-client.md).
