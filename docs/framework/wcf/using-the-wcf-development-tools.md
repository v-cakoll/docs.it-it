...
```  
 ...
 [!INCLUDE[crabout](../../../includes/crabout-md.md)] Netsh.exe, vedere [come utilizzare lo strumento di Netsh.exe e opzioni della riga di comando](http://go.microsoft.com/fwlink/?LinkId=97877).  
