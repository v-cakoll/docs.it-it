...
|WS-Addressing 2004/08|[Indirizzamento (WS-Addressing) di servizi Web](http://go.microsoft.com/fwlink/?LinkId=81239)|  
...
|Associazione WSDL SOAP1.2|[Estensione 1.1 associazione WSDL per SOAP 1.2](http://go.microsoft.com/fwlink/?LinkId=96691)|  
...
|Associazione MTOM + SOAP1.2|[SOAP Message Transmission Optimization Mechanism](http://go.microsoft.com/fwlink/?LinkId=96713)|  
...
|WSS: SOAP Message Security 1.1|[Web Services Security: Sicurezza dei messaggi SOAP 1.1](http://go.microsoft.com/fwlink/?LinkId=91240)|  
