...
### <a name="how-to-configure-an-application-to-use-constrained-delegation"></a>Procedura: configurare un'applicazione per utilizzare una delega vincolata.  
 Prima di utilizzare una delega vincolata, è necessario che il mittente, il destinatario e il controller di dominio siano configurati per raggiungere tale obiettivo. La procedura riportata di seguito elenca i passaggi che consentono la delega vincolata. Per informazioni dettagliate sulle differenze tra la delega e la delega vincolata, vedere la parte [Windows Server 2003 Kerberos Extensions](https://go.microsoft.com/fwlink/?LinkId=100194) che descrive gli argomenti vincolati nella pagina sulle.  
...
-   [Risoluzione dei problemi della delega Kerberos](https://go.microsoft.com/fwlink/?LinkId=36724)  
  
-   [Transizione al protocollo Kerberos e delega vincolata](https://go.microsoft.com/fwlink/?LinkId=36725)  
