...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene descritto come un servizio Windows Communication Foundation (WCF) è ospitato in Internet Information Services o [di Windows Server AppFabric](http://go.microsoft.com/fwlink/?LinkId=196496).  
 ...
 Viene descritto come un servizio WCF è ospitato da un servizio Windows.  
