...
Gli argomenti di questa sezione riguardano l'architettura client, come per accedere a servizi Windows Communication Foundation (WCF), come configurare un client WCF e alcune considerazioni di sicurezza per i client WCF.  
...
## <a name="see-also"></a>Vedere anche  
 [Esempi di client](http://msdn.microsoft.com/library/849fc452-8718-4d4e-ba57-905eed943f63)
