...
Quando si sviluppa un servizio di diffusione Windows Communication Foundation (WCF), è possibile creare feed ed elementi utilizzando le classi seguenti:  
