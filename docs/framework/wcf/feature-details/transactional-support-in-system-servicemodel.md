...
Gli argomenti in questa sezione descrivono le funzionalità transazionali fornisce Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene descritto come utilizzare la funzionalità di diagnostica e gestione in WCF per risolvere i problemi dell'applicazione transazionale.  
