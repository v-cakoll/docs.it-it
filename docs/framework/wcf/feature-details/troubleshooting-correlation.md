...
```  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]correlazione basata sul contenuto, vedere [in base al contenuto](../../../../docs/framework/wcf/feature-details/content-based-correlation.md) e [calcolatrice correlata](../../../../docs/framework/windows-workflow-foundation/samples/correlated-calculator.md) esempio.
