...
### <a name="all-bindings"></a>Tutte le associazioni  
 Le [\<basicHttpBinding>](../../configure-apps/file-schema/wcf/basichttpbinding.md) [\<wsHttpBinding>](../../configure-apps/file-schema/wcf/wshttpbinding.md) associazioni, e [\<ws2007HttpBinding>](../../configure-apps/file-schema/wcf/ws2007httpbinding.md) supportano i protocolli seguenti.  
...
```  
 ...
 Per ulteriori informazioni, vedere [Federazione](federation.md) .  
...
### <a name="mexhttpbinding"></a>mexHttpBinding  
 L' [\<mexHttpBinding>](../../configure-apps/file-schema/wcf/mexhttpbinding.md) associazione supporta i protocolli seguenti. Per ulteriori informazioni sull'utilizzo di questa associazione, vedere [pubblicazione di metadati](publishing-metadata.md).  
...
### <a name="mexhttpsbinding"></a>mexHttpsBinding  
 [\<mexHttpsBinding>](../../configure-apps/file-schema/wcf/mexhttpsbinding.md)supporta i protocolli seguenti. Per ulteriori informazioni sull'utilizzo di questa associazione, vedere [pubblicazione di metadati](publishing-metadata.md).  
