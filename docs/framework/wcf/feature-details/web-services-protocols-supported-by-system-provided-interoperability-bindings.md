...
|Sicurezza|Profilo token di certificato WSS SOAP Security X.509 1.0|[Profilo token di certificato WSS SOAP Security X.509 1.0](http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-x509-token-profile-1.0.pdf)<br /><br /> `<basicHttpBinding>   <security mode="Message"> <message clientCredentialType="Certificate"/> </security> </basicHttpBinding>`|  
