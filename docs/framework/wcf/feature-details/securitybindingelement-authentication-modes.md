...
3. Utilizzare l'elemento di associazione per creare l'associazione personalizzata. Per ulteriori informazioni, vedere [associazioni personalizzate](../../../../docs/framework/wcf/extending/custom-bindings.md).  
