...
```  
 ...
 Per ulteriori informazioni su come rendere asincrona trovare chiamate, vedere [trovare asincrona](../../../../docs/framework/wcf/samples/asynchronous-find-sample.md).  
