...
#### <a name="ntlm"></a>NTLM  
 Consente al server di utilizzare NTLM per l'autenticazione se il protocollo Kerberos ha esito negativo. Per altre informazioni sulla configurazione di IIS in IIS 6.0, vedere [forzatura dell'autenticazione NTLM](https://go.microsoft.com/fwlink/?LinkId=88598). Per [!INCLUDE[iisver](../../../../includes/iisver-md.md)], l'autenticazione di Windows include l'autenticazione NTLM. Per altre informazioni, vedere [IIS 7.0 Beta: Configurazione dei certificati del Server in IIS 7.0](https://go.microsoft.com/fwlink/?LinkID=88595).  
