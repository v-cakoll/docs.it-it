...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Il moniker del servizio WCF supporta la `IChannelCredentials` interfaccia che consente a un intervallo di metodi alternativi per la specifica di credenziali del canale.  
