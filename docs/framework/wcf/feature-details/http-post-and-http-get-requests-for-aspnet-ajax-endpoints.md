...
---
# <a name="how-to-choose-between-http-post-and-http-get-requests-for-aspnet-ajax-endpoints"></a>Procedura: Scegliere tra HTTP POST e HTTP GET richieste per gli endpoint ASP.NET AJAX
