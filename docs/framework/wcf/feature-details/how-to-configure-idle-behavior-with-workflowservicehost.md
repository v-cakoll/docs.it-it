...
1. Aggiungere un `workflowIdle` elemento> `behavior` <all'elemento `serviceBehaviors`> <<all'interno dell'elemento <>, come illustrato nell'esempio seguente.  
