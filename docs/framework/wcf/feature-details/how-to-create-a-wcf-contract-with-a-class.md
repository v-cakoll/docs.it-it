...
> [!WARNING]
>  `[ServiceContract]` e `[ServiceContractAttribute]` eseguire la stessa operazione. La stessa cosa vale per `[OperationContract]` e `[OperationContractAttribute]`. In ogni caso, il primo è l'abbreviazione del secondo.  
