...
> [!NOTE]
>  Per l'individuazione di WCF per funzionare correttamente, tutte le schede NIC (Network Interface Controller) deve avere solo 1 indirizzo IP.
