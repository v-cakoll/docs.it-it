...
description: Informazioni sulle funzionalità dei certificati digitali X. 509 e su come usarle in WCF. Le risorse di questo articolo possono spiegare ulteriormente questi concetti.
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
