...
9. <xref:System.ServiceModel.Channels.TransportSecurityBindingElement>  
 ...
 Sono supportate sia la codifica testo sia quella binaria. Inoltre, sono supportate tutte le modalità di trasferimento WCF. Per altre informazioni, vedere [Streaming Message Transfer](streaming-message-transfer.md).  
