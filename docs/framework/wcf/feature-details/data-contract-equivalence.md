...
>  Sia per i nomi e gli spazi dei nomi dei contratti dati sia per i nomi dei membri dati viene fatta distinzione tra maiuscole e minuscole.  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]spazi dei nomi e nomi di contratto dati, nonché i nomi dei membri dati, vedere [nomi di contratto dati](../../../../docs/framework/wcf/feature-details/data-contract-names.md).  
