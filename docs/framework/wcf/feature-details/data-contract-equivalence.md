...
> Sia per i nomi e gli spazi dei nomi dei contratti dati sia per i nomi dei membri dati viene fatta distinzione tra maiuscole e minuscole.  
 ...
 Per ulteriori informazioni sui nomi e sugli spazi dei nomi dei contratti dati, nonché sui nomi dei membri dati, vedere [nomi di contratto dati](../../../../docs/framework/wcf/feature-details/data-contract-names.md).  
