...
Questa sezione vengono trattati interoperabilità e integrazione con Windows Communication Foundation (WCF).  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Vengono illustrati i vari metodi per le applicazioni COM di chiamare servizi WCF.  
 ...
 Viene descritto come è possibile utilizzare WCF con [!INCLUDE[dnprdnshort](../../../../includes/dnprdnshort-md.md)] la comunicazione remota.  
 ...
 Viene descritto come utilizzare WCF con servizi Web implementati con Web Services Enhancements (WSE) 3.0.  
 ...
 Viene descritto come WCF può interagire con [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] servizi Web.  
  
 [Migrazione di servizi Web ASP.NET in WCF](../../../../docs/framework/wcf/feature-details/migrating-aspnet-web-services-to-wcf.md)  
 Viene descritto come eseguire la migrazione di un [!INCLUDE[vstecasp](../../../../includes/vstecasp-md.md)] Web servizio a un servizio WCF.  
