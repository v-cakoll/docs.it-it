...
- Il servizio WCF deve eseguire in Windows Server 2003 e usare trasporti diversi da HTTP. In Windows Server 2003, l'ambiente di hosting di IIS 6.0 è limitato alla sola comunicazione HTTP. Le applicazioni del servizio Windows non sono soggetti a questa restrizione e possono usare qualsiasi trasporto WCF supporta, inclusi NET. TCP, NET. pipe e NET. MSMQ.  
