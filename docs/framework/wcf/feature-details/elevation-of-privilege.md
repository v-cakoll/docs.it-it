...
## <a name="switching-identity-without-a-security-context"></a>Cambio di identità senza un contesto di sicurezza  
 ...
 Quando viene stabilita una connessione tra un client e server, l'identità del client non cambia, tranne che in una situazione: dopo l'apertura di client di WCF, se sono vere tutte le condizioni seguenti:  
