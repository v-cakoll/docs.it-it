...
1.  Eseguire il [strumento ServiceModel Metadata Utility Tool (Svcutil.exe)](../../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md) strumento con il `/async` opzione come illustrato nel comando seguente.  
...
## <a name="see-also"></a>Vedere anche  
 [Contratto di servizio: Esempio asincrono](http://msdn.microsoft.com/library/833db946-f511-4f64-a26f-2759a11217c7)
