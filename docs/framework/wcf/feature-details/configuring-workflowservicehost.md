...
In questa sezione contiene una serie di brevi "come" argomenti che descrivono brevemente come configurare diverse funzionalità del <xref:System.ServiceModel.Activities.WorkflowServiceHost> classe nella configurazione. Questi argomenti sono incentrati sulla configurazione specifica del servizio del flusso di lavoro, tutte le altre opzioni di configurazione viene eseguita nello stesso modo come un normale servizio WCF.  
