...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene illustrata la corrispondenza tra le codifiche di JavaScript Object Notation (JSON) e l'infoset XML, che viene utilizzata internamente da Windows Communication Foundation (WCF) per rappresentare documenti e dati con codifica JSON.  
