...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 Viene illustrata la corrispondenza tra le codifiche JSON (JavaScript Object Notation) e l'infoset XML, che viene utilizzato internamente da [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] per rappresentare dati e documenti con codifica JSON.  
