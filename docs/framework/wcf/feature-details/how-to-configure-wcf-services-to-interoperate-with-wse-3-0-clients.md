...
Servizi Windows Communication Foundation (WCF) sono compatibili a livello di rete con Web Services Enhancements 3.0 per i client di Microsoft .NET (WSE) quando i servizi WCF vengono configurati per utilizzare la versione dell'agosto 2004 della specifica WS-Addressing.  
