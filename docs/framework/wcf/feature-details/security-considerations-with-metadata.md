...
ms.locfileid: "33498543"
---
# <a name="security-considerations-with-metadata"></a>Considerazioni sulla sicurezza con metadati
Quando si usano le funzionalità dei metadati in Windows Communication Foundation (WCF), considerare le implicazioni di sicurezza della pubblicazione, il recupero e l'utilizzo dei metadati del servizio.  
