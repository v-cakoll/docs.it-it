...
---
# <a name="queues-overview"></a>Cenni preliminari sulle code

Contenuto della sezione vengono introdotti i concetti generali e fondamentali alla base delle comunicazioni in coda. Le sezioni successive illustrano in dettaglio il modo in cui vengono illustrati i concetti di accodamento descritti in Windows Communication Foundation (WCF).  
...
## <a name="basic-queuing-concepts"></a>Concetti di base dell'accodamento  
 ...
 ![Modello di comunicazione in coda](media/qconceptual-figure1c.gif "QConceptual-Figure1c")  
...
## <a name="queues-and-transactions"></a>Code e transazioni  
 Le transazioni consentono di raggruppare un set di operazioni in modo che se si verifica un errore in un'operazione, tutte le operazioni avranno esito negativo. Un esempio di come usare le transazioni è quando un utente usa un ATM per trasferire $1.000 dal proprio account di risparmio al proprio account di controllo. Questo passaggio comporta le operazioni seguenti:  
...
- Deposito di 1.000 euro nel conto corrente.  
 ...
 ![Coda con transazioni](media/qwithtransactions-figure3.gif "QWithTransactions-Figure3")  
...
## <a name="asynchronous-communication-using-queues"></a>Comunicazione asincrona mediante le code  
...
## <a name="dead-letter-queue-programming"></a>Programmazione della coda dei messaggi non recapitabili  
