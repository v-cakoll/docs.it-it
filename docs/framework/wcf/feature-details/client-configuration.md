...
description: Informazioni su come usare la configurazione client WCF per specificare l'indirizzo, l'associazione, il comportamento e il contratto per un endpoint, usato per connettersi a un servizio.
ms.date: 03/30/2017
