...
ms.locfileid: "33498010"
---
# <a name="wcf-web-http-programming-model"></a>Modello di programmazione HTTP Web WCF
Il modello di programmazione HTTP di Windows Communication Foundation (WCF) Web consente agli sviluppatori di esporre operazioni del servizio WCF per gli endpoint non SOAP. Negli argomenti di questa sezione viene illustrata in dettaglio la funzionalità.  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene fornita una panoramica del modello di programmazione di Windows Communication Foundation (WCF) Web HTTP.  
 ...
 Viene illustrato il modello di programmazione HTTP di Windows Communication Foundation (WCF) Web e il relativo funzionamento.  
 ...
 [Supporto della memorizzazione nella cache per servizi HTTP Web WCF](../../../../docs/framework/wcf/feature-details/caching-support-for-wcf-web-http-services.md)  
