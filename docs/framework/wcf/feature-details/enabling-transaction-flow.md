...
## <a name="security"></a>Sicurezza  
 ...
 Quando si generano client WCF per servizi Web ignoti lo scambio di metadati o non attendibili, le chiamate alle operazioni in questi servizi Web devono sopprimere la transazione corrente se possibile. Nell'esempio riportato di seguito viene illustrato come procedere.  
