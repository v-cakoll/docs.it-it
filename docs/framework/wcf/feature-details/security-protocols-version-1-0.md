...
### <a name="24-algorithm-suite"></a>Gruppo di algoritmi 2.4  
 WCF supporta tutti i gruppi di algoritmi elencati nella specifica Security Policy 1.1.  
