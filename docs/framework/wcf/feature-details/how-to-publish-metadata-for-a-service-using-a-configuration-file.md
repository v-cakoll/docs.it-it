...
---
# <a name="how-to-publish-metadata-for-a-service-using-a-configuration-file"></a>Procedura: Pubblicare i metadati per un servizio utilizzando un File di configurazione
