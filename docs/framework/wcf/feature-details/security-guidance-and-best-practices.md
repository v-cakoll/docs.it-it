...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Questo argomento descrive i concetti da tenere presente durante la creazione di un'applicazione [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)].  
  
 [Considerazioni sulle prestazioni](../../../../docs/framework/wcf/feature-details/performance-considerations.md)  
