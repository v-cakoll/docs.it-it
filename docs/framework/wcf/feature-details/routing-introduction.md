...
|Bidirezionale|![Segno di spunta](../../../../docs/framework/wcf/feature-details/media/checkmark.gif "segno di spunta")|||Sì|Inviare tutti i messaggi nel canale a una destinazione di backup.  Dopo che un canale restituisce un messaggio di risposta, viene restituita la risposta al client originale.|  
...
|Duplex|![Segno di spunta](../../../../docs/framework/wcf/feature-details/media/checkmark.gif "segno di spunta")|||Sì|Inviare a una destinazione di backup.|  
