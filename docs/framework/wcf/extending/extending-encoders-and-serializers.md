...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Vengono descritti i formattatori dei messaggi personalizzato, che possono essere usate per controllare la serializzazione e deserializzazione di un messaggio WCF in tipi CLR.
