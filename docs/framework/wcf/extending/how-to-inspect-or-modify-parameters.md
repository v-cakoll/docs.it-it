...
## <a name="see-also"></a><span data-ttu-id="18891-116">Vedere anche</span><span class="sxs-lookup"><span data-stu-id="18891-116">See also</span></span>

- [<span data-ttu-id="18891-117">Configurazione ed estensione del runtime con i comportamenti</span><span class="sxs-lookup"><span data-stu-id="18891-117">Configuring and Extending the Runtime with Behaviors</span></span>](../../../../docs/framework/wcf/extending/configuring-and-extending-the-runtime-with-behaviors.md)
