...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 [Procedura: creare un'identità di entità personalizzata](../../../../docs/framework/wcf/extending/how-to-create-a-custom-principal-identity.md)  
