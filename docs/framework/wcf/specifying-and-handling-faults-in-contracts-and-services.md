...
Per ulteriori informazioni su questo passaggio dello sviluppo del servizio o del client, vedere [definizione e specifica degli errori](defining-and-specifying-faults.md).
