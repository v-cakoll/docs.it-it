...
## <a name="map-exceptions-to-soap-faults"></a>Eseguire il mapping delle eccezioni a errori SOAP  
 ...
 Per altre informazioni su questo passaggio dello sviluppo del servizio o client, vedere [definizione e specifica gli errori](../../../docs/framework/wcf/defining-and-specifying-faults.md).  
