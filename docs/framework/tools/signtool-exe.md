...
|`/p7` *Path*|Specifica di produrre un file PKCS (Public Key Cryptography Standards) #7 per ogni file di contenuto specificato. Ai file PKCS #7 viene assegnato un nome corrispondente a *percorso*\\*nomefile*.p7.|  
