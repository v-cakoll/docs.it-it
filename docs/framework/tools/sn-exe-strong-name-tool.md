...
|`-TS assembly infile`|Test: firma l' *assembly* firmato o parzialmente firmato con la coppia di chiavi in *infile*.|  
|`-TSc assembly container`|Test: firma l' *assembly* firmato o parzialmente firmato con la coppia di chiavi nel *contenitore*del contenitore di chiavi.| 
