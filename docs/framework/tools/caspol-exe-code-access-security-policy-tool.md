---
title: Caspol.exe (strumento per i criteri di sicurezza dall&quot;accesso di codice) | Microsoft Docs
ms.custom: 
ms.date: 03/30/2017
...
|**-e**[**xecution**] {**on** &#124; **off**}|Abilita o disabilita il meccanismo che verifica l'autorizzazione all'esecuzione prima dell'avvio del codice. **Nota:** questa opzione è stata rimossa da [!INCLUDE[net_v40_short](../../../includes/net-v40-short-md.md)] e versioni successive. Per altre informazioni, vedere [Modifiche della sicurezza](../../../docs/framework/security/security-changes.md).|  
