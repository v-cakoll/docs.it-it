...
-   Limitare l'accesso al metodo ai chiamanti di un'identità specificata, in pratica, qualsiasi particolare [evidenza](http://msdn.microsoft.com/en-us/64ceb7c8-a0b4-46c4-97dc-6c22da0539da) (nome sicuro, publisher, zona e così via) desiderato.  
