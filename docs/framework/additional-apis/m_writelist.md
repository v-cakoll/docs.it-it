...
`Connection.m_WriteList` è un' <xref:System.Collections.ArrayList> di <xref:System.Net.HttpWebRequest> gli oggetti che sono in attesa di essere inviati tramite HTTP.
