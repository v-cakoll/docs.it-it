...
## <a name="remarks"></a>Commenti  
 Questo elemento viene impostato solo se l'attributo mode di [\<security>](security-of-peertransport.md) è impostato su `Transport` o `TransportWithMessageCredential` .  
