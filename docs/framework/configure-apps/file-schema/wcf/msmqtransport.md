...
|deadLetterQueue|Specifica il tipo di coda dei messaggi non recapitabili da usare.<br /><br /> I valori validi includono<br /><br /> -Personalizzata: Coda di messaggi non recapitabili personalizzato.<br />-None: Nessuna coda di messaggi non recapitabili deve essere utilizzato.<br />-System: Viene usata la coda di messaggi non recapitabili di sistema.<br /><br /> L'attributo è di tipo DeadLetterQueue.|  
