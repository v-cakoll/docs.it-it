...
## <a name="remarks"></a>Note  
 UdpBinding consente ai servizi WCF di comunicare tramite trasporto UDP. It allows for "fire and forget" message exchanges where a client sends a message to a service and expects no response back.  
