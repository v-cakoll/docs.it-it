...
|writeEncoding|Specifica la codifica dei caratteri usata per il testo dei messaggi. Di seguito vengono elencati i valori validi:<br /><br /> UnicodeFffeTextEncoding Codifica BigEndian Unicode.<br /><br /> Utf16TextEncoding codifica a 16 bit.<br /><br /> Utf8TextEncoding codifica a 8 bit.<br /><br /> L'impostazione predefinita è Utf8TextEncoding.|  
