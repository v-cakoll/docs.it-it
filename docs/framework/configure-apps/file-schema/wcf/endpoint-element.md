...
|-------------|-----------------|  
|[\<intestazioni >](headers.md)|Raccolte di intestazioni di indirizzo.|  
...
- [Procedura: Creare un endpoint del servizio nella configurazione](../../../wcf/feature-details/how-to-create-a-service-endpoint-in-configuration.md)
