...
---
# <a name="add-of-backuplist"></a>\<add> di \<backupList>
...
|-------------|-----------------|  
|[\<routing>](routing.md)|Contiene un elenco di endpoint che dovranno essere usati nel servizio di routing quando non è possibile raggiungere l'endpoint primario. |  
