...
|[\<rilevamento >](../../../../../docs/framework/configure-apps/file-schema/wcf/tracking-of-wcf.md)|Questa sezione definisce le impostazioni di rilevamento per un servizio del flusso di lavoro.|
