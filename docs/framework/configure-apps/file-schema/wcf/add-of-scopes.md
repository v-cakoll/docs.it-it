...
---
# <a name="add-of-scopes"></a>\<add> di \<scopes>
...
|-------------|-----------------|  
|[\<scopes>](scopes.md)|Contiene una raccolta di elementi di configurazione che specificano URI di ambito personalizzati che è possibile usare per filtrare gli endpoint del servizio durante l'esecuzione di query.|  
