...
ms.locfileid: "59102674"
---
# <a name="message-of-wshttpbinding"></a>\<messaggio > del \<wsHttpBinding >
...
|clientCredentialType|Facoltativo. Specifica il tipo di credenziale da usare se l'autenticazione client viene eseguita usando la modalità di sicurezza `Message` o `TransportWithMessageCredentials`. Vedere i valori di enumerazione di seguito. Il valore predefinito è `Windows`.<br /><br /> L'attributo è di tipo <xref:System.ServiceModel.MessageCredentialType>.|  
