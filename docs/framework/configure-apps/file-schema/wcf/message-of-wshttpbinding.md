...
ms.locfileid: "33364625"
---
# <a name="ltmessagegt-of-ltwshttpbindinggt"></a>&lt;message&gt; di &lt;wsHttpBinding&gt;
Definisce le impostazioni per la sicurezza a livello di messaggio di [ \<wsHttpBinding >](../../../../../docs/framework/configure-apps/file-schema/wcf/wshttpbinding.md).  
