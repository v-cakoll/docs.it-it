...
## <a name="remarks"></a>Note  
 ...
 Per impostazione predefinita, la sicurezza è disattivata, ma è possibile aggiungerla impostando l'attributo mode dell' `None` [ \<elemento figlio Security >](security-of-basichttpbinding.md) su un valore diverso da. Per impostazione predefinita usa una codifica dei messaggi "Text" e una codifica del testo UTF-8.  
...
## <a name="example"></a>Esempio  
 A partire da [!INCLUDE[netfx40_short](../../../../../includes/netfx40-short-md.md)], non è necessario che le associazioni e i comportamenti dispongano di un nome. La funzionalità dell'esempio precedente può essere eseguita rimuovendo il bindingConfiguration dall'indirizzo endpoint e il nome dall'associazione.  
