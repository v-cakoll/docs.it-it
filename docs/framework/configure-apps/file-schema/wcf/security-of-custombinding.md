...
## <a name="remarks"></a>Note  
 Per ulteriori informazioni sull'utilizzo di questo elemento, vedere modalità di autenticazione [di [SecurityBindingElement](../../../wcf/feature-details/securitybindingelement-authentication-modes.md) e procedura: Creare un'associazione personalizzata usando SecurityBindingElement](../../../wcf/feature-details/how-to-create-a-custom-binding-using-the-securitybindingelement.md).  
