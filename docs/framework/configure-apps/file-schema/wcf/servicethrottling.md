...
## <a name="see-also"></a>Vedere anche  
 ...
 [Uso di ServiceThrottlingBehavior per le prestazioni del servizio WCF di controllo](../../../../../docs/framework/wcf/feature-details/using-servicethrottlingbehavior-to-control-wcf-service-performance.md)
