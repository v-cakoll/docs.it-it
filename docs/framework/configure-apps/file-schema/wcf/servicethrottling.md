...
- [Uso di ServiceThrottlingBehavior per controllare le prestazioni del servizio WCF](../../../wcf/feature-details/using-servicethrottlingbehavior-to-control-wcf-service-performance.md)
