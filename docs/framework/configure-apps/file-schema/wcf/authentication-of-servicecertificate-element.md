...
---
# <a name="authentication-of-servicecertificate-element"></a>\<> di autenticazione \<dell'elemento > serviceCertificate
...
## <a name="example"></a>Esempio  
 Nell'esempio vengono svolte due attività: Per prima cosa specifica un certificato di servizio che il client deve usare durante la comunicazione con gli endpoint il `www.contoso.com` cui nome di dominio è sul protocollo http. In secondo luogo, specifica la modalità di revoca e il percorso dell'archivio usati durante l'autenticazione.  
