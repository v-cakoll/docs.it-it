...
---
# <a name="state-of-states"></a>\<state> di \<states>
...
|-------------|-----------------|  
|[\<states>](states-of-activitystatequery.md)|Raccolta di elementi di configurazione contenenti gli stati dell'attività sottoscritta per la quale deve essere generato un record di rilevamento.|  
