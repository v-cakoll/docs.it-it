...
---
# <a name="webproxyscript-element-network-settings"></a>\<elemento > webProxyScript (impostazioni di rete)
...
|---------------|-----------------|  
|`downloadTimeout`|Specifica il tempo massimo per il download dello script in ore, minuti e secondi. Il valore predefinito è un minuto.|  
