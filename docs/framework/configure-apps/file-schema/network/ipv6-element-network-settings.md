...
|-------------------|---------------------|  
|`enabled`|Specifica se i membri della classe <xref:System.Net.Dns> restituiscono indirizzi Internet Protocol versione 6 (IPv6). Il valore predefinito è `false`.|  
