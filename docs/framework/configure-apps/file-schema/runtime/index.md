...
## <a name="the-runtime-section-and-its-parent-and-child-elements"></a>La \<sezione del > di runtime e i relativi elementi padre e figlio
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[\<Cancella >](clear-element-for-namedcaches.md)\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[\<Rimuovi >](remove-element-for-namedcaches.md)  

## <a name="alphabetical-list-of-runtime-elements"></a>Elenco alfabetico \<di elementi > di runtime
