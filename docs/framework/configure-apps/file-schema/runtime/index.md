...
## <a name="the-runtime-section-and-its-parent-and-child-elements"></a>La sezione \<Runtime > e i relativi elementi padre e figlio
...
&nbsp;&nbsp;&nbsp;&nbsp;[\<assembly](assemblybinding-element-for-runtime.md) >\
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\<[aggiungi >](add-element-for-namedcaches.md)\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\<[deselezionare](clear-element-for-namedcaches.md) >\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[\<rimuovi >](remove-element-for-namedcaches.md)  

## <a name="alphabetical-list-of-runtime-elements"></a>Elenco alfabetico degli elementi > di runtime di \<
