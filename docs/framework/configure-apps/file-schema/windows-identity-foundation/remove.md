...
---
# \<remove>
Rimuove il gestore del token di sicurezza specificato dalla raccolta di gestori di token.  
...
|---------------|-----------------|  
|type|Nome del tipo CLR del gestore di token da rimuovere. Per ulteriori informazioni su come specificare l' `type` attributo, vedere [riferimenti ai tipi personalizzati](https://docs.microsoft.com/previous-versions/windows-identity-foundation/gg638728(v=msdn.10)#custom-type-references). Obbligatorio.|  
