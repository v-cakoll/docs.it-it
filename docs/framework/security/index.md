...
-   [Panoramica di Windows Identity Foundation 4.5](../../../docs/framework/security/wif-overview.md)  
  
    -   [Modello di identità basata sulle attestazioni](../../../docs/framework/security/claims-based-identity-model.md)  
  
    -   [Autorizzazione basata su attestazioni con WIF](../../../docs/framework/security/claims-based-authorization-using-wif.md)  
  
    -   [Modello di programmazione attestazioni WIF](../../../docs/framework/security/wif-claims-programming-model.md)  
...
-   [Indice delle procedure relative a WIF](../../../docs/framework/security/wif-how-tos-index.md)  
    ...
    -   [Procedura: Eseguire il debug di servizi e applicazioni che possono riconoscere attestazioni con le funzionalità di traccia WIF](../../../docs/framework/security/how-to-debug-claims-aware-applications-and-services-using-wif-tracing.md)  
    ...
    -   [Procedura: Attivare il rilevamento di attacchi di tipo replay dei messaggi](../../../docs/framework/security/how-to-enable-token-replay-detection.md)  
...
-   [Linee guida di WIF](../../../docs/framework/security/wif-guidelines.md)  
...
-   [Guida di riferimento per la configurazione di WIF](../../../docs/framework/security/wif-configuration-reference.md)  
    ...
    -   [Convenzioni dello schema di configurazione di WIF](../../../docs/framework/security/wif-configuration-schema-conventions.md)
