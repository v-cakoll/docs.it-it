...
1. Premere **F5** per compilare ed eseguire l'applicazione. Verrà visualizzata una finestra della console e il testo seguente: **Premere INVIO per richiamare il servizio, qualsiasi altro tasto per chiudere l'applicazione:**
