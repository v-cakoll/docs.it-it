...
## <a name="remote-debugging"></a>Remote Debugging  
 Il debug remoto di Windows Workflow Foundation (WF) funziona esattamente come il debug remoto per gli altri componenti di Visual Studio. Per informazioni sul debug remoto, vedere [come: Abilitare il debug remoto](https://go.microsoft.com/fwlink/?LinkId=196257).  
