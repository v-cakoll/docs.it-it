...
## <a name="wf-migration-whitepapers-and-cookbooks"></a>Whitepaper e guide di riferimento dettagliate sulla migrazione di WF  
 ...
 [Guida di riferimento alla migrazione di WF: attività personalizzate](https://go.microsoft.com/fwlink/?LinkId=153856)  
 Vengono forniti esempi e istruzioni per riprogettare le attività personalizzate di WF3 in WF4.  
  
 [Guida di riferimento alla migrazione di WF: attività personalizzate avanzate](https://go.microsoft.com/fwlink/?LinkId=275560)  
 ...
 [Guida di riferimento alla migrazione di WF: flussi di lavoro](https://go.microsoft.com/fwlink/?LinkId=153858)  
 Vengono forniti esempi e istruzioni per riprogettare i flussi di lavoro di WF3 in WF4.  
  
 [Guida di riferimento alla migrazione WF: hosting del flusso di lavoro](https://go.microsoft.com/fwlink/?LinkId=275561)  
 ...
 [Guida di riferimento alla migrazione di WF: rilevamento flussi di lavoro](https://go.microsoft.com/fwlink/?LinkId=275562)  
