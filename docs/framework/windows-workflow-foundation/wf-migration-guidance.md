...
[Materiale sussidiario sulla migrazione](~/docs/framework/windows-workflow-foundation/migration-guidance.md)   
È contenuto un elenco di collegamenti a whitepaper relativi agli argomenti della migrazione.

[Tramite le attività WF di .NET Framework 3.0 in .NET Framework 4 con l'attività di interoperabilità](~/docs/framework/windows-workflow-foundation/net-framework-3-0-wf-in-net-framework-4-interop.md)   
