...
10. Pulsante destro del mouse sul progetto UsingWorkflowItemPresenter in **Esplora soluzioni**, selezionare **Add**, quindi **nuovo elemento...** Per visualizzare il **Aggiungi nuovo elemento** finestra di dialogo e selezionare il **WPF** categoria dal **modelli installati** sezione a sinistra.

11. Selezionare il **finestra (WPF)** modello, denominarla `RehostingWFDesigner`, fare clic su **Add**.
...
15. Scegliere il **.NET** scheda, individuare l'assembly denominato **System.Activities.Core.Presentation**, selezionarlo e fare clic su **OK**.
...
18. Pulsante destro del mouse sul progetto UsingWorkflowItemPresenter in **Esplora soluzioni**, selezionare **Add**, quindi **nuovo elemento...** Per visualizzare il **Aggiungi nuovo elemento** finestra di dialogo e selezionare il **flusso di lavoro** categoria la **modelli installati** sezione a sinistra.

19. Selezionare il **ActivityDesigner** modello, denominarla `SimpleNativeDesigner`, fare clic su **Add**.
...
21. Pulsante destro del mouse sul progetto UsingWorkflowItemPresenter in **Esplora soluzioni**, selezionare **Add**, quindi **nuovo elemento...** Per visualizzare il **Aggiungi nuovo elemento** finestra di dialogo e selezionare il **flusso di lavoro** categoria la **modelli installati** sezione a sinistra.

22. Selezionare il **attività di codice** modello, denominarlo `SimpleNativeActivity`, fare clic su **Add**.
...
24. Selezionare **Compila soluzione** dalle **compilazione** menu.

25. Selezionare **Avvia senza eseguire debug** dalle **Debug** menu per aprire la finestra di progettazione riallocata.
