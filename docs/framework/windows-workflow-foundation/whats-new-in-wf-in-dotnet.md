...
###  <a name="BKMK_NewFlowchartCapabilities"></a> Diagramma di flusso sono state introdotte  
...
###  <a name="BKMK_VariableDeleteContextMenu"></a> Eliminare l'elemento menu di scelta rapida nella finestra di progettazione variabili e degli argomenti  
...
###  <a name="BKMK_AutoConnect"></a> Connessione e inserimento automatici nei flussi di lavoro macchina a stati e diagramma di flusso  
 ...
 ![Nodo iniziale del diagramma di flusso con punti](../../../docs/framework/windows-workflow-foundation/media/autoconnect1.png "Autoconnect1")  
...
###  <a name="BKMK_BackwardCompatRehostedDesigner"></a> Consenso per le funzionalità.NET 4.5 nella finestra di progettazione ospitata nuovamente  
