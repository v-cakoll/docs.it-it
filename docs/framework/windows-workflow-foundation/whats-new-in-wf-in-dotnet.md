...
>   
>  -   Le espressioni c# verranno sostituite con il messaggio nella finestra di progettazione **valore impostato in XAML**.  
...
###  <a name="BKMK_NewFlowchartCapabilities"></a>Nuove funzionalità di diagramma di flusso  
...
8.  Un singolo assembly che usa [trasparenza di livello 2](http://aka.ms/Level2Transparency) non può essere utilizzato [!INCLUDE[netfx40_short](../../../includes/netfx40-short-md.md)], [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)] in attendibilità totale, e [!INCLUDE[netfx_current_short](../../../includes/netfx-current-short-md.md)] in attendibilità parziale.  
...
###  <a name="BKMK_VariableDeleteContextMenu"></a>Eliminare voce del menu di scelta rapida nella finestra di progettazione variabili e argomenti  
...
###  <a name="BKMK_AutoSurround"></a>Racchiudere automaticamente con sequenza  
...
###  <a name="BKMK_AutoConnect"></a>Connessione e inserimento automatici nei flussi di lavoro macchina a stati e di diagramma di flusso  
...
###  <a name="BKMK_BackwardCompatRehostedDesigner"></a>Registrarsi per le funzionalità di flusso di lavoro 4.5 nella finestra di progettazione ospitata nuovamente  
...
###  <a name="BKMK_StateMachine"></a>Flussi di lavoro macchina a stati  
 Flussi di lavoro macchina a stati sono stati introdotti come parte di .NET Framework 4, versione 4.0.1 nel [Microsoft .NET Framework 4 Platform Update 1](http://go.microsoft.com/fwlink/?LinkID=215092). In questo aggiornamento sono incluse numerose nuove classi e attività che hanno consentito agli sviluppatori di creare i flussi di lavoro macchina a stati. Queste classi e attività sono state aggiornate per [!INCLUDE[net_v45](../../../includes/net-v45-md.md)]. Gli aggiornamenti includono:  
...
4.  Attività usate per creare i flussi di lavoro macchina a stati, incluse <xref:System.Activities.Statements.StateMachine>, <xref:System.Activities.Statements.State> e <xref:System.Activities.Statements.Transition>  
 ...
 Per ulteriori informazioni sulla creazione di flussi di lavoro macchina stato, vedere [flussi di lavoro macchina stato](../../../docs/framework/windows-workflow-foundation/state-machine-workflows.md).  
  
###  <a name="BKMK_ContractFirst"></a>Sviluppo di flussi di lavoro contratto  
