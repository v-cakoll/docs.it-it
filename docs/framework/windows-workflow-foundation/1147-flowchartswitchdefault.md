...
## <a name="description"></a>Descrizione  
 Indica che il case predefinito è stato selezionato in un'opzione diagramma di flusso.  
  
## <a name="message"></a>Messaggio  
 Diagramma di flusso '%1'/FlowSwitch: è stato selezionato il case predefinito.  
