...
## <a name="in-this-topic"></a><span data-ttu-id="4daab-107">Contenuto dell'argomento</span><span class="sxs-lookup"><span data-stu-id="4daab-107">In this topic</span></span>  
...
8.  <span data-ttu-id="4daab-131">Fare clic su **OK** per chiudere **gestione riferimenti** e aggiungere i riferimenti.</span><span class="sxs-lookup"><span data-stu-id="4daab-131">Click **OK** to close **Reference Manager** and add the references.</span></span>  
...
8.  <span data-ttu-id="4daab-177">Selezionare **sequentialnumberguessworkflow_du. XAML**, **flowchartnumberguessworkflow_du. XAML**, e **statemachinenumberguessworkflow_du. XAML** e fare clic su  **Aggiungere**.</span><span class="sxs-lookup"><span data-stu-id="4daab-177">Select **SequentialNumberGuessWorkflow_du.xaml**, **FlowchartNumberGuessWorkflow_du.xaml**, and **StateMachineNumberGuessWorkflow_du.xaml** and click **Add**.</span></span>  
...
6.  <span data-ttu-id="4daab-209">Selezionare la casella di controllo accanto a **System. Activities** dal **risultati della ricerca** elenco.</span><span class="sxs-lookup"><span data-stu-id="4daab-209">Check the checkbox beside **System.Activities** from the **Search Results** list.</span></span>  
...
<span data-ttu-id="4daab-247">**Aggiornato per: SequentialNumberGuessWorkflow; Versione 1.5.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-247">**Updated to: SequentialNumberGuessWorkflow; Version=1.5.0.0** </span></span>  
<span data-ttu-id="4daab-248">**Controllo: SequentialNumberGuessWorkflow; Versione 1.0.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-248">**Inspecting: SequentialNumberGuessWorkflow; Version=1.0.0.0** </span></span>  
<span data-ttu-id="4daab-249">**Aggiornato per: SequentialNumberGuessWorkflow; Versione 1.5.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-249">**Updated to: SequentialNumberGuessWorkflow; Version=1.5.0.0** </span></span>  
<span data-ttu-id="4daab-250">**Controllo: SequentialNumberGuessWorkflow; Versione 1.0.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-250">**Inspecting: SequentialNumberGuessWorkflow; Version=1.0.0.0** </span></span>  
<span data-ttu-id="4daab-251">**Aggiornato per: SequentialNumberGuessWorkflow; Versione 1.5.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-251">**Updated to: SequentialNumberGuessWorkflow; Version=1.5.0.0** </span></span>  
<span data-ttu-id="4daab-252">**Controllo: StateMachineNumberGuessWorkflow; Versione 1.0.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-252">**Inspecting: StateMachineNumberGuessWorkflow; Version=1.0.0.0** </span></span>  
<span data-ttu-id="4daab-253">**Aggiornato per: StateMachineNumberGuessWorkflow; Versione 1.5.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-253">**Updated to: StateMachineNumberGuessWorkflow; Version=1.5.0.0** </span></span>  
<span data-ttu-id="4daab-254">**Controllo: FlowchartNumberGuessWorkflow; Versione 1.0.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-254">**Inspecting: FlowchartNumberGuessWorkflow; Version=1.0.0.0** </span></span>  
<span data-ttu-id="4daab-255">**Aggiornato per: FlowchartNumberGuessWorkflow; Versione 1.5.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-255">**Updated to: FlowchartNumberGuessWorkflow; Version=1.5.0.0** </span></span>  
<span data-ttu-id="4daab-256">**Controllo: StateMachineNumberGuessWorkflow; Versione 2.0.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-256">**Inspecting: StateMachineNumberGuessWorkflow; Version=2.0.0.0** </span></span>  
<span data-ttu-id="4daab-257">**Controllo: StateMachineNumberGuessWorkflow; Versione 2.0.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-257">**Inspecting: StateMachineNumberGuessWorkflow; Version=2.0.0.0** </span></span>  
<span data-ttu-id="4daab-258">**Controllo: FlowchartNumberGuessWorkflow; Versione 2.0.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-258">**Inspecting: FlowchartNumberGuessWorkflow; Version=2.0.0.0** </span></span>  
<span data-ttu-id="4daab-259">**Controllo: FlowchartNumberGuessWorkflow; Versione 2.0.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-259">**Inspecting: FlowchartNumberGuessWorkflow; Version=2.0.0.0** </span></span>  
<span data-ttu-id="4daab-260">**Controllo: SequentialNumberGuessWorkflow; Versione 2.0.0.0 =** </span><span class="sxs-lookup"><span data-stu-id="4daab-260">**Inspecting: SequentialNumberGuessWorkflow; Version=2.0.0.0** </span></span>  
...
2.  <span data-ttu-id="4daab-265">Premere CTRL+F5 per eseguire l'applicazione.</span><span class="sxs-lookup"><span data-stu-id="4daab-265">Press CTRL+F5 to run the application.</span></span>  
  
3.  <span data-ttu-id="4daab-266">Fare clic su **nuova partita** per avviare un nuovo flusso di lavoro e annotare le informazioni sulla versione sotto la finestra di stato che indica il flusso di lavoro è un `v2` flusso di lavoro.</span><span class="sxs-lookup"><span data-stu-id="4daab-266">Click **New Game** to start a new workflow and note the version information below the status window that indicates the workflow is a `v2` workflow.</span></span>  
  
4.  <span data-ttu-id="4daab-267">Selezionare una del `v1` iniziare all'inizio di flussi di lavoro di [come: più versioni di Host di un flusso di lavoro Side-by-Side](../../../docs/framework/windows-workflow-foundation/how-to-host-multiple-versions-of-a-workflow-side-by-side.md) argomento.</span><span class="sxs-lookup"><span data-stu-id="4daab-267">Select one of the `v1` workflows you started at the beginning of the [How to: Host Multiple Versions of a Workflow Side-by-Side](../../../docs/framework/windows-workflow-foundation/how-to-host-multiple-versions-of-a-workflow-side-by-side.md) topic.</span></span> <span data-ttu-id="4daab-268">Si noti che le informazioni sulla versione nella finestra di stato indica che il flusso di lavoro è una versione **1.5.0.0** flusso di lavoro.</span><span class="sxs-lookup"><span data-stu-id="4daab-268">Note that the version information under the status window indicates that the workflow is a version **1.5.0.0** workflow.</span></span> <span data-ttu-id="4daab-269">Si noti inoltre che non sono disponibili informazioni sui tentativi precedenti, eccetto se troppo alti o troppo bassi.</span><span class="sxs-lookup"><span data-stu-id="4daab-269">Note that there is no information indicated about previous guesses other than whether they were too high or too low.</span></span>  
  
 <span data-ttu-id="4daab-270">**Immettere un numero compreso tra 1 e 10**</span><span class="sxs-lookup"><span data-stu-id="4daab-270">**Please enter a number between 1 and 10**</span></span>  
<span data-ttu-id="4daab-271">**La stima è troppo bassa.**</span><span class="sxs-lookup"><span data-stu-id="4daab-271">**Your guess is too low.**</span></span>  
  
5.  <span data-ttu-id="4daab-272">Prendere nota dell'oggetto `InstanceId`, quindi immettere dei tentativi finché il flusso di lavoro non viene completato.</span><span class="sxs-lookup"><span data-stu-id="4daab-272">Make a note of the `InstanceId` and then enter guesses until the workflow completes.</span></span> <span data-ttu-id="4daab-273">Nella finestra di stato vengono visualizzate le informazioni sul contenuto del tentativo, dal momento che le attività `WriteLine` sono state aggiornate dall'aggiornamento dinamico.</span><span class="sxs-lookup"><span data-stu-id="4daab-273">The status window displays information about the content of the guess because the `WriteLine` activities were updated by the dynamic update.</span></span>  
  
 <span data-ttu-id="4daab-274">**Immettere un numero compreso tra 1 e 10**</span><span class="sxs-lookup"><span data-stu-id="4daab-274">**Please enter a number between 1 and 10**</span></span>  
<span data-ttu-id="4daab-275">**La stima è troppo bassa.** </span><span class="sxs-lookup"><span data-stu-id="4daab-275">**Your guess is too low.** </span></span>  
<span data-ttu-id="4daab-276">**Immettere un numero compreso tra 1 e 10** </span><span class="sxs-lookup"><span data-stu-id="4daab-276">**Please enter a number between 1 and 10** </span></span>  
<span data-ttu-id="4daab-277">**5 è troppo basso.** </span><span class="sxs-lookup"><span data-stu-id="4daab-277">**5 is too low.** </span></span>  
<span data-ttu-id="4daab-278">**Immettere un numero compreso tra 1 e 10** </span><span class="sxs-lookup"><span data-stu-id="4daab-278">**Please enter a number between 1 and 10** </span></span>  
<span data-ttu-id="4daab-279">**7 è troppo alto.** </span><span class="sxs-lookup"><span data-stu-id="4daab-279">**7 is too high.** </span></span>  
<span data-ttu-id="4daab-280">**Immettere un numero compreso tra 1 e 10** </span><span class="sxs-lookup"><span data-stu-id="4daab-280">**Please enter a number between 1 and 10** </span></span>  
<span data-ttu-id="4daab-281">**Complimenti, il numero è decifrate a sua 4 volta.**</span><span class="sxs-lookup"><span data-stu-id="4daab-281">**Congratulations, you guessed the number in 4 turns.**</span></span>  
  
6.  <span data-ttu-id="4daab-282">Aprire Esplora risorse e passare al **NumberGuessWorkflowHost\bin\debug** cartella (o **bin\release** a seconda delle impostazioni di progetto) e aprire il file di rilevamento mediante blocco note corrispondente per il flusso di lavoro completato.</span><span class="sxs-lookup"><span data-stu-id="4daab-282">Open Windows Explorer and navigate to the **NumberGuessWorkflowHost\bin\debug** folder (or **bin\release** depending on your project settings) and open the tracking file using Notepad that corresponds to the completed workflow.</span></span> <span data-ttu-id="4daab-283">Se invece non hai apportato annotare il `InstanceId` potrebbe essere in grado di individuare il file di rilevamento corretto usando il **data modificata** informazioni in Esplora risorse.</span><span class="sxs-lookup"><span data-stu-id="4daab-283">If you did not make a note of the `InstanceId` you may be able to identify the correct tracking file by using the **Date modified** information in Windows Explorer.</span></span> <span data-ttu-id="4daab-284">Nell'ultima riga delle informazioni di rilevamento è contenuto l'output dell'attività `WriteLine` appena aggiunta.</span><span class="sxs-lookup"><span data-stu-id="4daab-284">The last line of the tracking information contains the output of the newly added `WriteLine` activity.</span></span>  
  
 <span data-ttu-id="4daab-285">**Immettere un numero compreso tra 1 e 10**</span><span class="sxs-lookup"><span data-stu-id="4daab-285">**Please enter a number between 1 and 10**</span></span>  
<span data-ttu-id="4daab-286">**La stima è troppo bassa.** </span><span class="sxs-lookup"><span data-stu-id="4daab-286">**Your guess is too low.** </span></span>  
<span data-ttu-id="4daab-287">**Immettere un numero compreso tra 1 e 10** </span><span class="sxs-lookup"><span data-stu-id="4daab-287">**Please enter a number between 1 and 10** </span></span>  
<span data-ttu-id="4daab-288">**5 è troppo basso.** </span><span class="sxs-lookup"><span data-stu-id="4daab-288">**5 is too low.** </span></span>  
<span data-ttu-id="4daab-289">**Immettere un numero compreso tra 1 e 10** </span><span class="sxs-lookup"><span data-stu-id="4daab-289">**Please enter a number between 1 and 10** </span></span>  
<span data-ttu-id="4daab-290">**7 è troppo alto.** </span><span class="sxs-lookup"><span data-stu-id="4daab-290">**7 is too high.** </span></span>  
...
2.  <span data-ttu-id="4daab-296">Nel **proprietà** finestra, seleziona il **elementi** proprietà e fare clic sul pulsante con i puntini di sospensione per modificare il **elementi** insieme.</span><span class="sxs-lookup"><span data-stu-id="4daab-296">In the **Properties** window, select the **Items** property and click the ellipsis button to edit the **Items** collection.</span></span>  
  
3.  <span data-ttu-id="4daab-297">Aggiungere alla raccolta i seguenti tre elementi.</span><span class="sxs-lookup"><span data-stu-id="4daab-297">Add the following three items to the collection.</span></span>  
    ...
    ```  
     ...
     <span data-ttu-id="4daab-298">La raccolta `Items` completata avrà sei elementi.</span><span class="sxs-lookup"><span data-stu-id="4daab-298">The completed `Items` collection will have six items.</span></span>  
...
4.  <span data-ttu-id="4daab-299">Fare doppio clic su **WorkflowHostForm** in **Esplora**e selezionare **Visualizza codice**.</span><span class="sxs-lookup"><span data-stu-id="4daab-299">Double-click **WorkflowHostForm** in **Solution Explorer**, and select **View Code**.</span></span>  
  
5.  <span data-ttu-id="4daab-300">Aggiungere tre nuovi casi al `switch` (o `Select Case`) istruzione il `NewGame_Click` gestore per eseguire il mapping di nuovi elementi del **WorkflowType** casella combinata per le identità del flusso di lavoro corrispondente.</span><span class="sxs-lookup"><span data-stu-id="4daab-300">Add three new cases to the `switch` (or `Select Case`) statement in the `NewGame_Click` handler to map the new items in the **WorkflowType** combo box to the matching workflow identities.</span></span>  
    ...
    ```  
     ...
     <span data-ttu-id="4daab-301">L'esempio riportato di seguito contiene l'istruzione completa `switch` (o `Select Case`).</span><span class="sxs-lookup"><span data-stu-id="4daab-301">The following example contains the complete `switch` (or `Select Case`) statement.</span></span>  
...
6.  <span data-ttu-id="4daab-302">Premere CTRL+F5 per compilare ed eseguire l'applicazione.</span><span class="sxs-lookup"><span data-stu-id="4daab-302">Press CTRL+F5 to build and run the application.</span></span> <span data-ttu-id="4daab-303">È possibile avviare le versioni `v1` del flusso di lavoro nonché le versioni correnti.</span><span class="sxs-lookup"><span data-stu-id="4daab-303">You can now start the `v1` versions of the workflow as well as the current versions.</span></span> <span data-ttu-id="4daab-304">Per aggiornare dinamicamente le nuove istanze, eseguire il **ApplyDynamicUpdate** dell'applicazione.</span><span class="sxs-lookup"><span data-stu-id="4daab-304">To dynamically update these new instances, run the **ApplyDynamicUpdate** application.</span></span>
