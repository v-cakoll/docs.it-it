...
-   <xref:System.Activities.Presentation.IWorkflowDesignerStorageService>: fornisce un servizio interno per l'archiviazione e il recupero dei dati. Il servizio viene usato internamente da .Net Framework e non è destinato all'uso esterno.  
