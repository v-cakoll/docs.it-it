...
## <a name="description"></a>Descrizione  
 Indica quale case è stato selezionato in un'opzione diagramma di flusso.  
  
## <a name="message"></a>Messaggio  
 Diagramma di flusso '%1'/FlowSwitch: è stato selezionato il case '%2'.  
...
|Case|xs:string|Lo switch case selezionato.|  
