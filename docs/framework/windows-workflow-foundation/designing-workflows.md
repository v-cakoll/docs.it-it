...
## <a name="in-this-section"></a>In questa sezione  
 ...
 [Flussi di lavoro procedurali](../../../docs/framework/windows-workflow-foundation/procedural-workflows.md)  
 Viene illustrato come creare flussi di lavoro usando un paradigma di esecuzione sequenziale, di base.  
  
 [Flussi di lavoro della macchina a stati](../../../docs/framework/windows-workflow-foundation/state-machine-workflows.md)  
