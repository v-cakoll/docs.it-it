...
###  <span data-ttu-id="2ab11-118"><a name="Prepare"></a>Preparare la definizione del flusso di lavoro per l'aggiornamento dinamico</span><span class="sxs-lookup"><span data-stu-id="2ab11-118"><a name="Prepare"></a> Prepare the workflow definition for dynamic update</span></span>  
...
###  <span data-ttu-id="2ab11-129"><a name="Update"></a>Aggiornare la definizione del flusso di lavoro in modo da riflettere le modifiche desiderate</span><span class="sxs-lookup"><span data-stu-id="2ab11-129"><a name="Update"></a> Update the workflow definition to reflect the desired changes</span></span>  
...
###  <span data-ttu-id="2ab11-135"><a name="Create"></a>Creare la mappa di aggiornamento</span><span class="sxs-lookup"><span data-stu-id="2ab11-135"><a name="Create"></a> Create the update map</span></span>  
...
###  <span data-ttu-id="2ab11-144"><a name="Apply"></a>Applicare la mappa di aggiornamento alle istanze del flusso di lavoro persistente desiderato</span><span class="sxs-lookup"><span data-stu-id="2ab11-144"><a name="Apply"></a> Apply the update map to the desired persisted workflow instances</span></span>  
