...
La compensazione in [!INCLUDE[wf](../../../includes/wf-md.md)] è il meccanismo mediante il quale il lavoro completato in precedenza può essere annullato o compensato (seguendo la logica definita dall'applicazione) in seguito a un errore. Contenuto della sezione viene illustrato come usare la compensazione nei flussi di lavoro.  
...
> [!NOTE]
>  In questo argomento viene illustrato il concetto di compensazione nei flussi di lavoro. [!INCLUDE[crabout](../../../includes/crabout-md.md)]le transazioni nei flussi di lavoro, vedere [transazioni](../../../docs/framework/windows-workflow-foundation/workflow-transactions.md) e <xref:System.Activities.Statements.TransactionScope>. [!INCLUDE[crabout](../../../includes/crabout-md.md)]lle transazioni, vedere <xref:System.Transactions?displayProperty=nameWithType> e <xref:System.Transactions.Transaction?displayProperty=nameWithType>.  
...
**CancelFlight: Ticket viene annullata.**   
**Flusso di lavoro completato con stato: annullata.**    
...
**Eccezione non gestita del flusso di lavoro:**   
**System. ApplicationException: Condizione di errore simulata nel flusso di lavoro.**   
**CancelCreditCard: Annullamento addebiti sulla carta di credito.**   
**Flusso di lavoro completato con stato: annullata.**  [!INCLUDE[crabout](../../../includes/crabout-md.md)]annullamento, vedere [annullamento](../../../docs/framework/windows-workflow-foundation/modeling-cancellation-behavior-in-workflows.md).  
