...
2.  Esistono due progetti diversi nella soluzione: `OrderErrorLibrary` e `OrderProcessingPolicy`. Il progetto `OrderProcessingPolicy` usa classi e metodi definiti in `OrderErrorLibrary`.  
