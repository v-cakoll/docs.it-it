...
In questa sezione è contenuti esempi che illustrano come creare attività personalizzate in Windows Workflow Foundation (WF).  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Sono contenuti esempi che illustrano la convalida di attività in fase di progettazione.
