...
## <a name="sample-details"></a>Dettagli dell'esempio  
 ...
 Oggetto <xref:System.Activities.WorkflowApplication> è impostata per eseguire la persistenza con un <!--zz <xref:System.Runtime.Persistence.InstanceStore> --> `System.Runtime.Persistence.InstanceStore`. In questo esempio viene usato l'oggetto <xref:System.Activities.DurableInstancing.SqlWorkflowInstanceStore>. Il <!--zz <xref:System.Runtime.Persistence.InstanceStore> --> `System.Runtime.Persistence.InstanceStore` devono essere assegnati al <xref:System.Activities.WorkflowApplication.InstanceStore%2A> proprietà prima che il <xref:System.Activities.WorkflowApplication> viene eseguito.  
...
4.  Eseguire l'esempio con privilegi di amministratore passando alla directory bin del progetto (\WF\Basic\Persistence\InstancePersistence\bin\Debug) in [!INCLUDE[fileExplorer](../../../../includes/fileexplorer-md.md)], facendo clic Workflow.exe e selezionando **Esegui come amministratore**.  
