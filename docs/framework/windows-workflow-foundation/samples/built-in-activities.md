...
Contenuto della sezione sono contenuti esempi che illustrano attività [!INCLUDE[wf](../../../../includes/wf-md.md)] incorporate.  
...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 [Emulazione di interruzione in qualche attività](../../../../docs/framework/windows-workflow-foundation/samples/emulating-breaking-in-a-while-activity.md)  
 ...
 [Utilizzo di variabili con un set di regole di .NET Framework 3.5](../../../../docs/framework/windows-workflow-foundation/samples/using-variables-with-dotnet-ruleset.md)  
 ...
 [Utilizzo delle attività di raccolta](../../../../docs/framework/windows-workflow-foundation/samples/using-collection-activities.md)  
 ...
 [Utilizzo dell'attività InvokeMethod](../../../../docs/framework/windows-workflow-foundation/samples/using-the-invokemethod-activity.md)  
 ...
 [Utilizzo dell'attività Pick](../../../../docs/framework/windows-workflow-foundation/samples/using-the-pick-activity.md)  
 Viene illustrato come usare l'attività <xref:System.Activities.Statements.Pick>.  
  
 [Utilizzo di attività procedurali](../../../../docs/framework/windows-workflow-foundation/samples/using-procedural-activities.md)  
 ...
 [Utilizzo dell'attività CancellationScope](../../../../docs/framework/windows-workflow-foundation/samples/using-cancellationscope.md)  
 ...
 [Utilizzo dell'attività Switch con tipi personalizzati](../../../../docs/framework/windows-workflow-foundation/samples/usage-of-the-switch-activity-with-custom-types.md)  
 ...
 [Interoperabilità con Set di regole 3.5](../../../../docs/framework/windows-workflow-foundation/samples/interop-with-3-5-rule-set.md)  
