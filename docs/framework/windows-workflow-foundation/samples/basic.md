...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 Sono inclusi esempi che illustrano le espressioni [!INCLUDE[wf](../../../../includes/wf-md.md)].  
  
 [Migrazione](../../../../docs/framework/windows-workflow-foundation/samples/migration.md)  
 Sono inclusi esempi che illustrano la migrazione dei flussi di lavoro con versioni precedenti di [!INCLUDE[wf](../../../../includes/wf-md.md)].  
