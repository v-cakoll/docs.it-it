...
ms.locfileid: "33515147"
---
# <a name="tracking"></a>Rilevamento
In questa sezione è contenuti esempi che illustrano in Windows Workflow Foundation (WF) di rilevamento del flusso di lavoro.  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 [Estrarre dati di WF usando il rilevamento](../../../../docs/framework/windows-workflow-foundation/samples/extract-wf-data-using-tracking.md)  
 Viene illustrato come usare il rilevamento del flusso di lavoro per estrarre variabili e argomenti del flusso di lavoro dalle attività.  
  
 [Rilevamento tramite un file di testo](../../../../docs/framework/windows-workflow-foundation/samples/tracking-using-a-text-file.md)  
 Viene illustrato come estendere il rilevamento in [!INCLUDE[wf1](../../../../includes/wf1-md.md)] creando un partecipante del rilevamento personalizzato.
