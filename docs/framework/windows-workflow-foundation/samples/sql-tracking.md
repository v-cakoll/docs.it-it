...
10. Nel client di prova WCF fare doppio clic su **GetStockPrice**. Verrà visualizzata l' `GetStockPrice` operazione che accetta un parametro, digitare il valore `Contoso` e fare clic su **richiama**.  
