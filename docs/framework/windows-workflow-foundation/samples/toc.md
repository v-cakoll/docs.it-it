...
#### [Gestione errori in un'attività Flowchart usando TryCatch](fault-handling-in-a-flowchart-activity-using-trycatch.md)
#### [Emulazione di interruzione in un'attività While](emulating-breaking-in-a-while-activity.md)
#### [Creazione DynamicActivity](dynamicactivity-creation.md)
#### [Uso di variabili con un set di regole di .NET Framework 3.5](using-variables-with-dotnet-ruleset.md)
#### [Caricare da XAML](load-from-xaml.md)
#### [Uso delle attività di raccolta](using-collection-activities.md)
#### [Uso dell'attività InvokeMethod](using-the-invokemethod-activity.md)
#### [Uso dell'attività Pick](using-the-pick-activity.md)
#### [Uso di attività procedurali](using-procedural-activities.md)
#### [Uso dell'attività CancellationScope](using-cancellationscope.md)
#### [InvokeMethod](invokemethod.md)
#### [Uso dell'attività Switch con tipi personalizzati](usage-of-the-switch-activity-with-custom-types.md)
...
##### [Uso di AsyncOperationContext in un'attività](using-asyncoperationcontext-in-an-activity-sample.md)
...
##### [Uso di ExpressionTextBox in un ActivityDesigner personalizzato](using-the-expressiontextbox-in-a-custom-activity-designer.md)
##### [Uso dell'ambito di modifica](using-editing-scope.md)
...
#### [Uso della classe WorkflowInvoker](using-the-workflowinvoker-class.md)
...
#### [Uso di un'attività di .NET Framework 3.0 o .NET Framework 3.5 in un flusso di lavoro di .NET Framework 4.5](using-a-net-3-0-or-net-3-5-activity-in-a-net-4-5-workflow.md)
#### [Uso di interoperabilità con scambio di dati esterni](using-interop-with-external-data-exchange.md)
...
#### [Uso di base delle attività SendParameters e ReceiveParameters](basic-usage-of-sendparameters-and-receiveparameters-activities.md)
...
#### [Estrarre dati di WF usando il rilevamento](extract-wf-data-using-tracking.md)
...
#### [Uso di TransactedReceiveScope](use-of-transactedreceivescope.md)
...
#### [Esempi di LINQ to SQL](linq-to-sql-sample.md)
#### [Uso dell'attività InvokePowerShell](using-the-invokepowershell-activity.md)
...
#### [Rollback di transazione](transaction-rollback.md)
...
### [Scenario StateMachine usando una combinazione attività FlowChart e Pick](statemachine-scenario-using-a-combination-of-flowchart-and-pick.md)
