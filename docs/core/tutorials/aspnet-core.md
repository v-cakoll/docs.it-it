...
---
# <a name="getting-started-with-aspnet-core"></a><span data-ttu-id="8b7eb-104">Introduzione ad ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="8b7eb-104">Getting started with ASP.NET Core</span></span>    
    
<span data-ttu-id="8b7eb-105">Per esercitazioni sullo sviluppo di applicazioni Web ASP.NET Core, si consiglia di consultare la [documentazione di ASP.NET Core](/aspnet/core/).</span><span class="sxs-lookup"><span data-stu-id="8b7eb-105">For tutorials about developing ASP.NET Core web applications, we suggest you head over to [ASP.NET Core documentation](/aspnet/core/).</span></span>
