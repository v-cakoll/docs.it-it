...
| App Web ASP.NET Core                         | `razor`, `webapp`| [C#]          |
...
| Libreria di classi Razor                          | `razorclasslib`  | [C#]          |
...
Il comando contiene un elenco predefinito di modelli. Usare `dotnet new -l` per ottenere un elenco dei modelli disponibili. La tabella seguente elenca i modelli preinstallati con .NET Core SDK 2.0. Il linguaggio predefinito per il modello è indicato tra parentesi quadre.
...
Il comando contiene un elenco predefinito di modelli. Usare `dotnet new -all` per ottenere un elenco dei modelli disponibili. La tabella seguente elenca i modelli preinstallati con .NET Core SDK 1.x. Il linguaggio predefinito per il modello è indicato tra parentesi quadre.
...
Creare un nuovo progetto di applicazione MVC con ASP.NET Core usando C# nella directory corrente senza autenticazione:

`dotnet new mvc -au None`

Creare una nuova applicazione xUnit:
