...
NET Core 2.x è supportato nelle versioni/distribuzioni di Linux x64 seguenti:
...
NET Core 1.x è supportato nelle versioni/distribuzioni di Linux x64 seguenti:
...
5. Estrarre i binari di .NET Core SDK.
...
Per installare .NET Core per Fedora 26, Fedora 25 (.NET Core 2.x) o Fedora 24 (.NET Core 1.x):
