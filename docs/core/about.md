...
- Tipi <xref:System.Numerics.Vector?displayProperty=nameWithType> a prestazioni elevate, ad esempio [pipeline](https://devblogs.microsoft.com/dotnet/system-io-pipelines-high-performance-io-in-net/)e.
