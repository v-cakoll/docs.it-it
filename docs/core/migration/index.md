...
# Migrazione di progetti .NET Core nel formato di file con estensione csproj
...
## Migrazione da versioni precedenti dei formati csproj di.NET Core alla versione RTM
