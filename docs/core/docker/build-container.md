...
- \ [SDK per .NET Core 3,1](https://dotnet.microsoft.com/download)
...
Se si usa Linux o macOS, usare il comando `ls` per ottenere un elenco di directory e verificare che il file *MyApp. dll* sia stato creato.
