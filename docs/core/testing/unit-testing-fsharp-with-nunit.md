...
## <a name="creating-the-source-project"></a><span data-ttu-id="9ecd3-110">Creazione del progetto di origine</span><span class="sxs-lookup"><span data-stu-id="9ecd3-110">Creating the source project</span></span>
