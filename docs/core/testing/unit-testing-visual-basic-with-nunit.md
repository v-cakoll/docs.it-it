...
## <a name="creating-the-source-project"></a><span data-ttu-id="4373b-110">Creazione del progetto di origine</span><span class="sxs-lookup"><span data-stu-id="4373b-110">Creating the source project</span></span>
