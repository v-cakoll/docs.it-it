...
---
# <a name="interop-breaking-changes"></a>Modifiche di rilievo di interoperabilità

In questa pagina sono documentate le modifiche di rilievo seguenti:

| Modifica | Versione introdotta |
| - | :-: |
| [Il supporto predefinito per WinRT è stato rimosso da .NET](#built-in-support-for-winrt-is-removed-from-net) | 5.0 |
