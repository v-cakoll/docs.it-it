...
* [Building a C# Hello World Application with .NET Core in Visual Studio 2017](../csharp/getting-started/with-visual-studio.md) - Learn how to build, debug, and publish a simple .NET Core console application using Visual Studio 2017. (Creazione di un'applicazione C# Hello World con .NET Core in Visual Studio 2017 - Informazioni su come creare, eseguire il debug e pubblicare una semplice applicazione console .NET Core con Visual Studio 2017).
* [Creazione di una libreria di classi con C# e .NET Core in Visual Studio 2017](../csharp/getting-started/library-with-visual-studio.md): informazioni su come compilare una libreria di classi scritta in C# con Visual Studio 2017.
