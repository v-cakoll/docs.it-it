...
### [Apprendere le nozioni di base di Docker con .NET Core](core/docker/docker-basics-dotnet-core.md)
...
### [Gestione dell'installazione di .NET Core](core/versions/install-management.md)
