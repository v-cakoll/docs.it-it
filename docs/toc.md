...
### [Eseguire il training di un modello con dati non contenuti in un file di testo](machine-learning/how-to-guides/load-non-file-training-data-ml-net.md)
...
### [Usare modelli additivi generalizzati per la comprensibilità dei modelli](machine-learning/how-to-guides/use-gams-for-model-explainability.md)
### [Usare le metriche per valutare la qualità di un modello](machine-learning/how-to-guides/verify-model-quality-ml-net.md)
## Riferimenti
