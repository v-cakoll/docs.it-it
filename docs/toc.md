...
### [Novità di .NET Standard](standard/whats-new/whats-new-in-dotnet-standard.md)
## [Framework di destinazione](standard/frameworks.md)
## [Glossario .NET](standard/glossary.md)
## [Linee guida sull'architettura](standard/guidance-architecture.md)
### [Progettare applicazioni Web moderne con ASP.NET Core e Microsoft Azure](standard/modern-web-apps-azure-architecture/)
### [Modernizzare le applicazioni .NET esistenti con il cloud di Azure e i contenitori di Windows](standard/modernize-with-azure-and-containers/)
### [Ciclo di vita delle applicazioni Docker in contenitori con piattaforma e strumenti Microsoft](standard/containerized-lifecycle-architecture/)
### [Microservizi .NET.: Architecture for Containerized .NET Applications](standard/microservices-architecture/) (Microservizi .NET. Architettura per le applicazioni .NET incluse in contenitori)
### [App serverless: architettura, modelli e implementazione di Azure](standard/serverless-architecture/)
## [Linee guida per le librerie open source](standard/library-guidance/)
...
## [Analizzatori](standard/analyzers/index.md)
...
### [Formato dei file di assembly .NET](standard/assembly/file-format.md)
### [Procedura: Usare ed eseguire il debug di assembly non caricabili in .NET Core](standard/assembly/unloadability-howto.md)
...
## [Elaborazione parallela, concorrenza e programmazione asincrona](standard/parallel-processing-and-concurrency.md)
...
### [Linee guida all'utilizzo di Memory<T> e Span<T>](standard/memory-and-spans/memory-t-usage-guidelines.md)
## [Interoperabilità nativa](standard/native-interop/index.md)
### [P/Invoke](standard/native-interop/pinvoke.md)
### [Marshalling dei tipi](standard/native-interop/type-marshalling.md)
### [Personalizzazione del marshalling della struttura](standard/native-interop/customize-struct-marshalling.md)
### [Personalizzazione del marshalling dei parametri](standard/native-interop/customize-parameter-marshalling.md)
### [Linee guida per l'interoperabilità](standard/native-interop/best-practices.md)
### [Set di caratteri e marshalling](standard/native-interop/charset.md)
...
### [Eseguire il debug dell'applicazione .NET Core Hello World C# o Visual Basic con Visual Studio 2017](core/tutorials/debugging-with-visual-studio.md)
### [Pubblicare l'applicazione Hello World con Visual Studio 2017](core/tutorials/publishing-with-visual-studio.md)
### [Compilare una libreria .NET Standard con C# e .NET Core in Visual Studio 2017](core/tutorials/library-with-visual-studio.md)
### [Compilare una libreria .NET Standard con Visual Basic e .NET Core in Visual Studio 2017](core/tutorials/vb-library-with-visual-studio.md)
### [Eseguire il test di una libreria .NET Standard con .NET Core in Visual Studio 2017](core/tutorials/testing-library-with-visual-studio.md)
### [Usare una libreria .NET Standard in Visual Studio 2017](core/tutorials/consuming-library-with-visual-studio.md)
...
### [Novità di .NET Core 3.0](core/whats-new/dotnet-core-3-0.md)
### [Novità di .NET Core 2.2](core/whats-new/dotnet-core-2-2.md)
...
### [Creare un modello personalizzato per dotnet new](core/tutorials/create-custom-template.md)
...
## Migrazione
### [.NET Core da 2.0 a 2.1](core/migration/20-21.md)
### [Migrazione da project.json](core/migration/index.md)
...
### [Distribuire un'app .NET Core in un contenitore](core/docker/docker-basics-dotnet-core.md)
### [Usare immagini Docker di base](core/docker/building-net-docker-images.md)
### [Visual Studio Tools per Docker](/aspnet/core/publishing/visual-studio-tools-for-docker)
## [Testing unità](core/testing/index.md)
### [Procedure consigliate per gli unit test](core/testing/unit-testing-best-practices.md)
...
### [Selezione versione .NET Core](core/versions/selection.md)
### [Rimozione di SDK e runtime non aggiornati](core/versions/remove-runtime-sdk-versions.md)
...
#### [Creare uno strumento globale](core/tools/global-tools-how-to-create.md)
...
### [Abilitare il completamento tramite TAB](core/tools/enable-tab-autocomplete.md)
...
### [Script dotnet-install](core/tools/dotnet-install-script.md)
...
### [Tecnologie di .NET Framework non disponibili in .NET Core](core/porting/net-framework-tech-unavailable.md)
...
### [Introduzione a C#](csharp/tutorials/intro-to-csharp/index.md)
#### [Hello world](csharp/tutorials/intro-to-csharp/hello-world.yml)
#### [Numeri in C#](csharp/tutorials/intro-to-csharp/numbers-in-csharp.yml)
#### [Rami e cicli](csharp/tutorials/intro-to-csharp/branches-and-loops.yml)
#### [Interpolazione di stringhe](csharp/tutorials/intro-to-csharp/interpolated-strings.yml)
#### [Raccolte di elenchi](csharp/tutorials/intro-to-csharp/list-collection.yml)
#### [Lavorare nell'ambiente locale](csharp/tutorials/intro-to-csharp/local-environment.md)
##### [Numeri in C#](csharp/tutorials/intro-to-csharp/numbers-in-csharp-local.md)
##### [Rami e cicli](csharp/tutorials/intro-to-csharp/branches-and-loops-local.md)
##### [Interpolazione di stringhe](csharp/tutorials/intro-to-csharp/interpolated-strings-local.md)
##### [Raccolte di elenchi](csharp/tutorials/intro-to-csharp/arrays-and-collections.md)
##### [Introduzione alle classi](csharp/tutorials/intro-to-csharp/introduction-to-classes.md)
### [Esplorare C# 6](csharp/tutorials/exploration/csharp-6.yml)
### [Usare tipi riferimento nullable](csharp/tutorials/nullable-reference-types.md)
### [Aggiornare un'app per i tipi riferimento nullable](csharp/tutorials/upgrade-to-nullable-references.md)
### [Generare e usare flussi asincroni](csharp/tutorials/generate-consume-asynchronous-stream.md)
### [Estendere le funzionalità per i dati usando i criteri di ricerca](csharp/tutorials/pattern-matching.md)
...
### [Interpolazione di stringhe](csharp/tutorials/string-interpolation.md)
### [Uso degli attributi](csharp/tutorials/attributes.md)
...
### [C# 8.0 - Anteprima 2](csharp/whats-new/csharp-8.md)
...
### [Considerazioni su versione e aggiornamento](csharp/whats-new/version-update-considerations.md)
<!-- End What's New -->
...
### [Tipi riferimento nullable](csharp/nullable-references.md)
...
### [Variabili discard](csharp/discards.md)
...
#### [Schema di eventi .NET standard](csharp/event-pattern.md)
...
### [Analizzare le stringhe con `String.Split`](csharp/how-to/parse-strings-using-split.md)
### [Concatenare le stringhe](csharp/how-to/concatenate-multiple-strings.md)
### [Convertire una stringa in DateTime](standard/base-types/parsing-datetime.md)
### [Stringhe di ricerca](csharp/how-to/search-strings.md)
### [Modificare il contenuto delle stringhe](csharp/how-to/modify-string-contents.md)
### [Confrontare le stringhe](csharp/how-to/compare-strings.md)
### [Eseguire il cast sicuro con i criteri di ricerca e gli operatori is e as](csharp/how-to/safely-cast-using-pattern-matching-is-and-as-operators.md)
...
## [Introduzione](fsharp/get-started/index.md)
### [Installazione di F#](fsharp/get-started/install-fsharp.md)
### [Introduzione a F# in Visual Studio](fsharp/get-started/get-started-visual-studio.md)
### [Introduzione a F# in Visual Studio per Mac](fsharp/get-started/get-started-with-visual-studio-for-mac.md)
### [Introduzione a F# in Visual Studio Code e Ionide](fsharp/get-started/get-started-vscode.md)
### [Introduzione a F# con l'interfaccia della riga di comando di .NET Core](fsharp/get-started/get-started-command-line.md)

## [Cos'è F#](fsharp/what-is-fsharp.md)
...
#### [Funzioni di prima classe](fsharp/introduction-to-functional-programming/first-class-functions.md)
...
#### [Creare un provider di tipi](fsharp/tutorials/type-providers/creating-a-type-provider.md)
...
### [Tipi di base](fsharp/language-reference/basic-types.md)
...
### [Matrici](fsharp/language-reference/arrays.md)
### [Sequenze](fsharp/language-reference/sequences.md)
### [Sezioni](fsharp/language-reference/slices.md)
### [Opzioni](fsharp/language-reference/options.md)
### [Opzioni Value](fsharp/language-reference/value-options.md)
...
### [Dichiarazioni di importazione: parole chiave open](fsharp/language-reference/import-declarations-the-open-keyword.md)
### [File di firma](fsharp/language-reference/signature-files.md)
...
### [Espressioni lazy](fsharp/language-reference/lazy-expressions.md)
...
### [Opzioni di F# Interactive](fsharp/language-reference/fsharp-interactive-options.md)
...
### [Modifiche importanti apportate a Visual Basic in Visual Studio ](visual-basic/getting-started/breaking-changes-in-visual-studio.md)
...
### [Covarianza e controvarianza](visual-basic/programming-guide/concepts/covariance-contravariance/index.md)
...
#### [Tuple](visual-basic/programming-guide/language-features/data-types/tuples.md)
...
### [Riepilogo dei tipi di dati](visual-basic/language-reference/data-types/index.md)
...
#### [Modulo](visual-basic/language-reference/modifiers/module-keyword.md)
...
##### [Operatore <](visual-basic/language-reference/operators/comparison-operators.md)
##### [Operatore <=](visual-basic/language-reference/operators/comparison-operators.md)
##### [Operatore >](visual-basic/language-reference/operators/comparison-operators.md)
##### [Operatore >=](visual-basic/language-reference/operators/comparison-operators.md)
...
##### [Operatore ?()](visual-basic/language-reference/operators/null-conditional-operators.md)
##### [Operatore (operatore)](visual-basic/language-reference/operators/null-conditional-operators.md)
...
#### [L'operazione richiesta non è disponibile (BC35000)](visual-basic/language-reference/error-messages/bc35000.md)
...
### [Specifiche del linguaggio](visual-basic/reference/language-specification/)
...
## Panoramica
### [Informazioni su ML.NET](machine-learning/what-is-mldotnet.md)
### [Concetti relativi al training dei modelli](machine-learning/basic-concepts-model-training-in-mldotnet.md)
...
### [Classificazione dei problemi (classificazione multiclasse)](machine-learning/tutorials/github-issue-classification.md)
### [Stima dei prezzi (regressione)](machine-learning/tutorials/taxi-fare.md)
### [Iris (clustering)](machine-learning/tutorials/iris-clustering.md)
### [Suggerimento di film (consiglio)](machine-learning/tutorials/movie-recommmendation.md)
## [Guide pratiche](machine-learning/how-to-guides/index.md)
### Preparare i dati
#### [Applicare la progettazione di funzionalità categoriche](machine-learning/how-to-guides/train-model-categorical-ml-net.md)
#### [Applicare la progettazione di funzionalità testuali](machine-learning/how-to-guides/train-model-textual-ml-net.md)
#### [Caricare dati con più colonne](machine-learning/how-to-guides/load-data-from-mult-column-csv-ml-net.md)
#### [Caricare dati da più file](machine-learning/how-to-guides/load-data-from-multiple-files-ml-net.md)
#### [Caricare dati da file di testo](machine-learning/how-to-guides/load-data-from-text-file-ml-net.MD)
#### [Pre-elaborare i dati con i normalizzatori](machine-learning/how-to-guides/normalizers-preprocess-data-ml-net.md)
### Eseguire il training del modello, valutarlo e spiegarlo
#### [Eseguire il training del modello con origini dati in tempo reale](machine-learning/how-to-guides/load-non-file-training-data-ml-net.md)
#### [Eseguire il training di un modello usando la convalida incrociata](machine-learning/how-to-guides/train-cross-validation-ml-net.md)
#### [Esaminare i valori dei dati intermedi di una pipeline](machine-learning/how-to-guides/inspect-intermediate-data-ml-net.md)
#### [Eseguire il training di un modello di regressione](machine-learning/how-to-guides/train-regression-model-ml-net.md)
#### [Determinare l'importanza delle funzionalità dei modelli con PFI](machine-learning/how-to-guides/determine-global-feature-importance-in-model.md)
...
#### [Fornire un modello tramite l'API Web](machine-learning/how-to-guides/serve-model-web-api-ml-net.md)
### Infer.NET
#### [Programmazione probabilistica con Infer.NET](machine-learning/how-to-guides/matchup-app-infer-net.md)
## Riferimenti
### [Riferimento API](https://docs.microsoft.com/dotnet/api/?view=ml-dotnet)
...
### [Trasformazioni di dati](machine-learning/resources/transforms.md)
