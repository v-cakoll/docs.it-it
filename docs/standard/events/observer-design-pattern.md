...
description: Informazioni sul modello di progettazione Observer in .NET. Questo modello consente a un Sottoscrittore di effettuare la registrazione e ricevere notifiche da un provider.
ms.date: 03/30/2017
