...
A partire da [!INCLUDE[net_v45](../../../includes/net-v45-md.md)], il metodo <xref:System.Threading.Tasks.Task.Delay%2A?displayProperty=nameWithType> viene fornito a questo scopo e può essere usato in un altro metodo asincrono, ad esempio, per implementare un ciclo asincrono di polling:
