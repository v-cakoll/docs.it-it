...
description: Informazioni su come concatenare l'attività usando le attività di continuazione in .NET. Un'attività di continuazione è un'attività asincrona richiamata da un'altra attività.
ms.date: 02/11/2019
