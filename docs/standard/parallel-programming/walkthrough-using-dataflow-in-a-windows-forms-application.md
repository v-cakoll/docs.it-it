...
2.  Assicurarsi che in Form1.cs (Form1.vb per [!INCLUDE[vbprvb](../../../includes/vbprvb-md.md)]) siano contenute le seguenti istruzioni `using` (`Using` in [!INCLUDE[vbprvb](../../../includes/vbprvb-md.md)]):  
