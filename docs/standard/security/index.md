...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene fornita una panoramica di servizi di crittografia forniti da .NET. Questa sezione è di particolare interesse per gli sviluppatori.  
