...
-   **eBook: Modernize existing .NET Framework applications with Azure and Windows Containers** (eBook: modernizzare le applicazioni .NET Framework esistenti con i contenitori di Azure e di Windows)  
