...
-   **EventSource Class**. API for events tracing for Windows (ETW) (Classe EventSource. API per l'analisi degli eventi per Windows)[*https://docs.microsoft.com/dotnet/api/system.diagnostics.tracing.eventsource*](https://docs.microsoft.com/dotnet/api/system.diagnostics.tracing.eventsource)
