 ...
 **X AVOID** esposte pubblicamente tipi annidati. L'unica eccezione è rappresentata dal caso in cui le variabili del tipo annidato debbano essere dichiarate solo in rari scenari, ad esempio la sottoclasse o altri scenari di personalizzazione avanzati.  
 ...
 **X DO NOT** utilizzare tipi annidati se devono essere creata un'istanza mediante il codice client.  Se un tipo dispone di un costruttore pubblico, probabilmente non dovrebbe essere annidato.  
 ...
 **X DO NOT** definire un tipo annidato come membro di interfaccia. Molti linguaggi non supportano un costrutto di questo tipo.  
