 ...
 **✓ CONSIDER** le implicazioni sulle prestazioni di generazione di eccezioni. Velocità di generazione superiore a 100 al secondo in genere notevolmente sulle prestazioni della maggior parte delle applicazioni.  
 ...
 **X AVOID** in modo esplicito la generazione di eccezioni da blocchi finally. Le eccezioni generate implicitamente risultante dalla chiamata di metodi che generano sono accettabili.  
