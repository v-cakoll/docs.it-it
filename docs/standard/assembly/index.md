...
|Titolo|Descrizione|
|-----------|-----------------|
|[Contenuto degli assembly](contents.md)|Elementi che costituiscono un assembly.|
...
- [Formato del file di assembly .NET](file-format.md)
...
- [Procedura: controllare il contenuto dell'assembly tramite MetadataLoadContext](inspect-contents-using-metadataloadcontext.md)
