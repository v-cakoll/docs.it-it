...
- L'assembly viene annotato con l'attributo `ImportedFromTypeLib` o l'attributo `PrimaryInteropAssembly` e un attributo `Guid` a livello di assembly. Per impostazione predefinita, i modelli di progetto Visual C# e Visual Basic includono un attributo a livello `Guid` di assembly.
...
1. Nella finestra di dialogo **Crea un nuovo progetto** Digitare *libreria di classi* nella casella **Cerca modelli** . Selezionare il modello libreria di classi C# o Visual Basic **(.NET Framework)** nell'elenco e quindi fare clic su **Avanti**.

1. Nella finestra di dialogo **Configura nuovo progetto** , in **nome progetto**, digitare *TypeEquivalenceInterface*e quindi selezionare **Crea**. Viene creato il nuovo progetto.
...
1. Aprire il file di classe *ISampleInterface* nell'editor di codice e sostituirne il contenuto con il codice seguente per creare l' `ISampleInterface` interfaccia:
...
1. Nell' `Guid` attributo del codice sostituire il GUID di esempio con il GUID copiato e rimuovere le parentesi graffe (**{}**).
...
1. Nella finestra di dialogo **Configura nuovo progetto** , in **nome progetto**, digitare *TypeEquivalenceRuntime*e quindi selezionare **Crea**. Viene creato il nuovo progetto.

1. In **Esplora soluzioni**fare clic con il pulsante destro del mouse sul file *Class1.cs* o *Class1. vb* , scegliere **Rinomina**e rinominare il file da *Class1* a *SampleClass*. Rispondere **Sì** al prompt per rinominare anche la classe in `SampleClass` . La classe implementa l'interfaccia `ISampleInterface`.
...
1. Aprire il file di classe *SampleClass* nell'editor di codice e sostituirne il contenuto con il codice seguente per creare la `SampleClass` classe:
...
1. Nella finestra di dialogo **Crea un nuovo progetto** Digitare *console* nella casella **Cerca modelli** . Selezionare il modello applicazione console C# o Visual Basic **(.NET Framework)** dall'elenco e quindi fare clic su **Avanti**.

1. Nella finestra di dialogo **Configura nuovo progetto** , in **nome progetto**, digitare *TypeEquivalenceClient*e quindi selezionare **Crea**. Viene creato il nuovo progetto.
...
1. In Visual Studio selezionare **file**  >  **Apri**  >  **progetto/soluzione**e aprire il progetto **TypeEquivalenceInterface** .
...
1. Aprire il file *SampleInterface.cs* o *SampleInterface. vb* e aggiungere la riga di codice seguente all' `ISampleInterface` interfaccia:
...
1. Aprire il file *SampleClass.cs* o *SampleClass. vb* e aggiungere il codice seguente alla `SampleClass` classe:
...
Passare al percorso della cartella di output di compilazione ed eseguire *TypeEquivalenceClient. exe*. Si noti che l'output della console ora riflette la nuova versione dell' `TypeEquivalenceRuntime` assembly, *2.0.0.0*, senza il programma da ricompilare.
