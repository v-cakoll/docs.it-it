...
2. Aggiungere quanto segue:  
 ...
 È possibile ripristinare la funzionalità bypass per l'applicazione rimuovendo l'impostazione del file di configurazione o impostando l' `true`attributo su.  
