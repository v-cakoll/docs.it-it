...
Per visualizzare il contenuto di un assembly tramite *Ildasm. exe*, digitare **Ildasm** \<*nome assembly*> al prompt dei comandi. Ad esempio, il comando seguente Disassembla l'assembly *Hello. exe* .  
