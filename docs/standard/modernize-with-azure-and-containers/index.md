...
Questo libro viene fornito "così com'è" ed esprime i punti di vista e le opinioni dell'autore. Le viste, le opinioni e informazioni espresse nel presente documento, inclusi gli URL e altri riferimenti a siti Web Internet, soggette a modifiche senza preavviso.
...
La prima versione delle applicazioni .NET Framework è stata .NET Framework 1.0, rilasciata verso la fine del 2001. Le aziende sono quindi passate a versioni più recenti (ad esempio 2.0, 3.5 e .NET 4.x). La maggior parte di tali applicazioni sono stati eseguiti in Windows Server e Internet Information Server (IIS) e utilizzato un database relazionale, ad esempio SQL Server, Oracle, MySQL o qualsiasi altro sistema RDBMS.
...
Questa guida è stata scritta per aiutare a comprendere le opzioni per il miglioramento e modernizzare le applicazioni web .NET esistenti. La guida e le applicazioni di esempio correlate sono in continua evoluzione. I commenti sono iniziale. È possibile inviare eventuali commenti su come rendere la guida ancora più utile all'indirizzo: [dotnet-architecture-ebooks-feedback@service.microsoft.com](mailto:dotnet-architecture-ebooks-feedback@service.microsoft.com?subject=Feedback%20for%20.NET%20Container%20&%20Microservices%20Architecture%20book).
