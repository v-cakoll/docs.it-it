...
- È necessario accedere agli elementi in un determinato ordine, ad esempio FIFO, LIFO o casuale?
  ...
  - La <xref:System.Collections.Queue> classe, nonché le <xref:System.Collections.Generic.Queue%601> <xref:System.Collections.Concurrent.ConcurrentQueue%601> <xref:System.Collections.Immutable.ImmutableQueue%601> classi generiche, e offrono l'accesso FIFO. Per altre informazioni, vedere [When to Use a Thread-Safe Collection](thread-safe/when-to-use-a-thread-safe-collection.md) (Quando usare una raccolta thread-safe).

  - La <xref:System.Collections.Stack> classe, nonché le <xref:System.Collections.Generic.Stack%601> <xref:System.Collections.Concurrent.ConcurrentStack%601> <xref:System.Collections.Immutable.ImmutableStack%601> classi generiche, e offrono l'accesso LIFO. Per altre informazioni, vedere [When to Use a Thread-Safe Collection](thread-safe/when-to-use-a-thread-safe-collection.md) (Quando usare una raccolta thread-safe).
...
- Ogni elemento contiene un valore, una combinazione di una chiave e un valore o una combinazione di una chiave e più valori?
  ...
  - Un valore: usare una qualsiasi raccolta basata sull'interfaccia <xref:System.Collections.IList> o sull'interfaccia generica <xref:System.Collections.Generic.IList%601>. Per un'opzione non modificabile, prendere in considerazione l' <xref:System.Collections.Immutable.IImmutableList%601> interfaccia generica.

  - Una chiave e un valore: usare una qualsiasi raccolta basata sull'interfaccia <xref:System.Collections.IDictionary> o sull'interfaccia generica <xref:System.Collections.Generic.IDictionary%602>. Per un'opzione non modificabile, prendere in considerazione le <xref:System.Collections.Immutable.IImmutableSet%601> <xref:System.Collections.Immutable.IImmutableDictionary%602> interfacce generiche o.
...
PLINQ fornisce un'implementazione parallela di LINQ to Objects in grado di offrire un'esecuzione più rapida delle query in molti scenari, grazie a un uso più efficiente dei computer multicore. Per altre informazioni, vedere [Parallel LINQ (PLINQ)](../parallel-programming/introduction-to-plinq.md).
...
- [Raccolte thread-safe](thread-safe/index.md)
