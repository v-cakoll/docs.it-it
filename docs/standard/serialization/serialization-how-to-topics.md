...
---
# <a name="serialization-how-to-topics"></a>Argomenti sulle procedure relative alla serializzazione
Di seguito vengono elencati i collegamenti ad alcune procedure contenute nella documentazione sui concetti relativi alla serializzazione.  
...
-   [Procedura: Suddividere in blocchi i dati serializzati](../../../docs/standard/serialization/how-to-chunk-serialized-data.md)  
