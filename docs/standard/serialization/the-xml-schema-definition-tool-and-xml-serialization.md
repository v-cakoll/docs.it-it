...
- [Procedura: utilizzare lo strumento XML Schema Definition per generare classi e documenti di XML Schema.](../../../docs/standard/serialization/xml-schema-def-tool-gen.md)
