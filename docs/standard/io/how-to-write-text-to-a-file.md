...
---
# <a name="how-to-write-text-to-a-file"></a>Procedura: scrivere testo in un fileHow to: Write text to a file
...
## <a name="example-synchronously-write-text-with-streamwriter"></a>Esempio: scrittura sincrona di testo con StreamWriterExample: Synchronously write text with StreamWriter
...
## <a name="example-synchronously-append-text-with-streamwriter"></a>Esempio: aggiunta sincrona di testo con StreamWriterExample: Synchronously append text with StreamWriter
...
## <a name="example-asynchronously-write-text-with-streamwriter"></a>Esempio: scrivere testo in modo asincrono con StreamWriterExample: Asynchronously write text with StreamWriter
