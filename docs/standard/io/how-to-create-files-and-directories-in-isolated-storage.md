...
Una volta ottenuto uno spazio di memorizzazione isolato, è possibile creare directory e file per archiviare i dati. All'interno di un archivio i nomi di file e directory vengono specificati rispetto alla radice del file system virtuale.  
