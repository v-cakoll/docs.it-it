...
Gli esempi di codice seguenti creano un **FileStream** per il file esistente *MyFile.txt* in modo da inserire nel buffer *MyFile.txt*. Si **noti che FileStreams** vengono memorizzati nel buffer per impostazione predefinita.

>[!IMPORTANT]
>Gli esempi presuppongono che un file denominato *MyFile.txt* esista già nella stessa cartella dell'app.  

## <a name="example-use-streamreader"></a>Esempio: usare StreamReaderExample: Use StreamReader
...
## <a name="example-use-binaryreader"></a>Esempio: utilizzo di BinaryReaderExample: Use BinaryReader
