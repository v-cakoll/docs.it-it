...
## <a name="xpathnavigator-typed-accessors"></a>Funzioni di accesso tipizzate di XPathNavigator  
...
|<xref:System.Xml.XPath.XPathNavigator.ValueAs%2A>|Il contenuto del nodo di cui viene eseguito il cast nel tipo di destinazione in base alle regole di XPath 2.0 per l'esecuzione del cast.|  
 ...
 Per ulteriori informazioni sul mapping dai tipi incorporati nello schema ai tipi CLR, vedere [supporto dei tipi nelle classi System. XML](../../../../docs/standard/data/xml/type-support-in-the-system-xml-classes.md).  
...
## <a name="obtain-typed-values-using-valueas-properties"></a>Recupero di valori tipizzati mediante le proprietà ValueAs  
