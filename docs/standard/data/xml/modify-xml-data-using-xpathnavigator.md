...
|<xref:System.Xml.XPath.XPathNodeType.ProcessingInstruction>|Contenuto eccetto la destinazione.|  
|<xref:System.Xml.XPath.XPathNodeType.Comment>|Contenuto del commento.|  
...
### <a name="modifying-typed-values"></a>Modifica dei valori tipizzati  
...
> Gli attributi possono disporre solo di tipi semplici.  
 ...
 Per altre informazioni sulla convalida degli schemi e sulla classe <xref:System.Xml.XPath.XPathNavigator>, vedere [Convalida dello schema con XPathNavigator](schema-validation-using-xpathnavigator.md).  
...
## <a name="innerxml-and-outerxml-properties"></a>Proprietà InnerXml e OuterXml  
...
## <a name="modifying-namespace-nodes"></a>Modifica dei nodi dello spazio dei nomi  
...
## <a name="modifying-entity-reference-nodes"></a>Modifica dei nodi dei riferimenti all'entità  
...
## <a name="modifying-xsinil-nodes"></a>Modifica dei nodi xsi:nil  
