...
ms.locfileid: "56411423"
---
# <a name="customizing-parameter-marshalling"></a>Personalizzazione del marshalling dei parametri
...
| Valore di `System.Runtime.InteropServices.UnmanagedType` | Codifica |
|------------------------------------------------------|----------|
| LPStr | ANSI |
| LPUTF8Str | UTF-8 | 
| LPWStr | UTF-16 |
...
### <a name="marshalling-as-specific-com-interfaces"></a>Marshalling come interfacce COM specifiche
