...
---
# <a name="customizing-structure-marshalling"></a>Personalizzazione del marshalling delle strutture
...
## <a name="customizing-boolean-field-marshalling"></a>Personalizzazione del marshalling di campi booleani
...
Usando i valori `UmanagedType.U1` o `UnmanagedType.I1` di seguito, è possibile indicare al runtime di effettuare il marshalling del campo `b` come tipo `bool` nativo a 1 byte.
...
## <a name="customizing-array-field-marshalling"></a>Personalizzazione del marshalling delle matrici
...
## <a name="customizing-string-field-marshalling"></a>Personalizzazione del marshalling dei campi stringa
...
## <a name="customizing-decimal-field-marshalling"></a>Personalizzazione del marshalling dei campi decimali
...
## <a name="marshalling-systemobjects"></a>Marshalling di `System.Object`
