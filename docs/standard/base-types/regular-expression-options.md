...
description: Informazioni su come usare le opzioni di espressioni regolari in .NET, ad esempio la corrispondenza senza distinzione tra maiuscole e minuscole, la modalità multiriga e la modalità da destra a sinistra.
ms.date: 03/30/2017
