---
title: Converte le stringhe in DateTime
...
ms.locfileid: "84662901"
---
# <a name="parse-date-and-time-strings-in-net"></a>Analizzare le stringhe di data e ora in .NET
...
> [!NOTE]
> Questi esempi sono disponibili nel repository docs di GitHub per [C#](https://github.com/dotnet/docs/tree/master/samples/snippets/csharp/how-to/conversions) e [Visual Basic](https://github.com/dotnet/docs/tree/master/samples/snippets/visualbasic/how-to/conversions).
