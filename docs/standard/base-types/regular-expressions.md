...
- Trova modelli di caratteri specifici.
...
## <a name="how-regular-expressions-work"></a>Come funzionano le espressioni regolari
...
### <a name="example-1-replace-substrings"></a>Esempio 1: Sostituire le sottostringheExample 1: Replace substrings  
...
### <a name="example-2-identify-duplicated-words"></a>Esempio 2: Identificare le parole duplicateExample 2: Identify duplicated words  
