...
---
# <a name="change-case-in-net"></a>Modificare il caso in .NET

Se si scrive un'applicazione che accetta input da un utente, non è mai possibile verificare il caso (superiore o inferiore) che verrà usato per immettere i dati. Spesso è desiderabile che le la combinazione di maiuscole e minuscole nelle stringhe sia coerente, in particolare se le stringhe vengono visualizzate nell'interfaccia utente. La tabella seguente descrive tre metodi per la modifica della combinazione di maiuscole e minuscole. I primi due metodi forniscono un overload che accetta determinate impostazioni cultura.  
...
<a name="Comparing"></a>
## <a name="compare-strings-of-mixed-case"></a>Confrontare stringhe di maiuscole e minuscole  
 ...
 Per altre informazioni, vedere [Best Practices for Using Strings](best-practices-strings.md) (Procedure consigliate per l'uso di stringhe).  
...
- [Esecuzione di operazioni sulle stringhe indipendenti dalle impostazioni cultura](../globalization-localization/performing-culture-insensitive-string-operations.md)
