...
[!INCLUDE[standard](../../../includes/pcl-to-standard.md)]
 ...
 Questo articolo illustra lo sviluppo di app in Visual Studio, ma Microsoft fornisce anche assembly di riferimento per Libreria di classi portabile che è possibile usare per lo sviluppo di app e librerie con altri strumenti, ad esempio Xamarin. Queste app e librerie possono essere usate su qualsiasi runtime basato su .NET Framework o su piattaforme non Microsoft. Per altre informazioni sugli assembly di riferimento, vedere il post di blog [Portable Class Library (PCL) ora disponibile in tutte le piattaforme](http://blogs.msdn.com/b/dotnet/archive/2013/10/14/portable-class-library-pcl-now-available-on-all-platforms.aspx). Per scaricare gli assembly, vedere [assembly di riferimento di Microsoft .NET Portable Library](http://www.microsoft.com/download/details.aspx?id=40727) nel Microsoft Download Center. Per altre informazioni su come usare gli assembly con Xamarin, vedere il post di blog [libreria di classi Portabile e le librerie NuGet di .NET per Xamarin](http://blogs.msdn.com/b/dotnet/archive/2013/11/13/pcl-and-net-nuget-libraries-are-now-enabled-for-xamarin.aspx).  
...
>  Visual Studio 2013 Update 2 include aggiornamenti ai modelli di libreria di classi portabile. Se si dispone di una versione precedente di Visual Studio e Visual Studio 2013 installato nello stesso computer, e si installa l'Update 2, le modifiche per il **Framework di destinazione** scelte verranno applicate a entrambe le versioni di Visual Studio.  
 ...
 [Uso della libreria di classi portabile](#using)  
...
|Visual Studio Community 2013 per Windows|Sì, quando si installa il [versione più recente di Visual Studio Community 2013](https://visualstudio.microsoft.com/vs/older-downloads/), che include l'Update 2.|  
...
## <a name="creating-a-portable-class-library-project"></a>Creazione di un progetto Libreria di classi portabile  
 ...
 In Visual Studio 2013 Update 2, è possibile scegliere il **libreria di classi (portabile)** modello per il linguaggio scelto e la piattaforma per creare una libreria di classi portabile. Questo modello verrà visualizzato per le piattaforme seguenti:  
...
-   Silverlight  
 ...
 Se si desidera creare una libreria con destinazione Windows Phone 8.1 e Windows 8.1 in c#, è possibile scegliere **Store apps**, quindi scegliere **libreria di classi (portabile per applicazioni universali)**.  
  
 ![Libreria di classi portabile per App Store](../../../docs/standard/cross-platform/media/storeuniversalpcl.png "StoreUniversalPCL")  
 ...
 Il **Aggiungi libreria di classi portabile** verrà visualizzata la finestra di dialogo, ed è possibile selezionare piattaforme aggiuntive. La finestra di dialogo mostrerà avvisi di compatibilità in base alle destinazioni selezionate.  
  
 ![Finestra di dialogo di modifica target Framework per VS2013](../../../docs/standard/cross-platform/media/clr-pcl-changeframeworks.png "CLR_PCL_ChangeFrameworks")  
...
|Windows Store|-.NET per App di Windows Store|-Windows Store App (Windows 8) e versioni successive<br /><br /> -Le app di Windows Store (Windows 8.1)|-Windows 8<br /><br /> -Windows 8.1|  
...
Pagina delle proprietà di Libreria di classi portabile per Visual Studio 2013 Update 2  
 ...
 Se si vuole valutare la portabilità degli assembly prima di apportare modifiche in Visual Studio, è possibile usare la [.NET Portability Analyzer](http://visualstudiogallery.msdn.microsoft.com/1177943e-cfb7-4822-a8a6-e56c7905292b).  
...
## <a name="supported-features"></a>Funzionalità supportate  
 Nella tabella seguente vengono elencate le funzionalità supportate sulle piattaforme e versioni disponibili. In alcuni casi, Microsoft ha aggiunto supporto con il rilascio di un pacchetto NuGet e il fatto è stato segnalato. Per altre informazioni sui pacchetti NuGet per .NET Framework, vedere [.NET Framework e rilasci fuori banda](../../../docs/framework/get-started/the-net-framework-and-out-of-band-releases.md).  
...
|XLINQ||✓|✓|✓|✓|✓|✓|✓|✓|✓|✓|✓|  
 ...
 È necessario ➊ [Async Microsoft](https://www.nuget.org/packages/Microsoft.Bcl.Async/) pacchetto  
 È necessario ➋ [Microsoft Compression](https://www.nuget.org/packages/Microsoft.Bcl.Compression) pacchetto  
