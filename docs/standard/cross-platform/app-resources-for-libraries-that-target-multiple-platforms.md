...
|Titolo|Employee Database|
 ...
 Il codice seguente illustra il modo in cui è possibile accedere alla classe `UILibrary` e alle relative risorse da un'app di Windows 8. x Store. Richiede l'aggiunta di un riferimento a UILibrary. dll al progetto di app di Windows Store.
...
|Titolo|Base de données des employés|
 ...
 Il codice seguente illustra il modo in cui è possibile accedere alla classe `UILibrary` e alle relative risorse da un'app di Windows 8. x Store. Richiede l'aggiunta di un riferimento a UILibrary. dll al progetto di app di Windows Store. Usa la proprietà statica `ApplicationLanguages.PrimaryLanguageOverride` per impostare la lingua preferita dell'applicazione in francese.
