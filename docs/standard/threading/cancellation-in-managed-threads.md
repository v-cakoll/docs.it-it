...
description: Informazioni sull'annullamento nei thread gestiti. Informazioni sui token di annullamento nell'annullamento cooperativo di operazioni sincrone asincrone o con esecuzione prolungata.
ms.date: 03/30/2017
