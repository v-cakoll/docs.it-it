...
La proprietà <xref:System.Threading.Thread.ThreadState%2A?displayProperty=nameWithType> fornisce una maschera di bit che indica lo stato del thread corrente. Un thread si trova sempre in almeno uno degli stati possibili nell'enumerazione <xref:System.Threading.ThreadState> e può essere contemporaneamente in più stati.  
...
|Il thread chiama <xref:System.Threading.Thread.Join%2A?displayProperty=nameWithType> in un altro thread.|<xref:System.Threading.ThreadState.WaitSleepJoin>|  
...
|Il thread risponde a un <xref:System.Threading.Thread.Suspend%2A?displayProperty=nameWithType> richiesta.|<xref:System.Threading.ThreadState.Suspended>|  
...
|Il thread risponde a un <xref:System.Threading.Thread.Abort%2A?displayProperty=nameWithType>.|<xref:System.Threading.ThreadState.Aborted>, quindi <xref:System.Threading.ThreadState.Stopped>|  
...
```  
 ...
 In uno specifico momento, i thread spesso sono in più di uno stato. Ad esempio, se un thread è bloccato su un <xref:System.Threading.Monitor.Wait%2A?displayProperty=nameWithType> chiamata e un altro thread chiama <xref:System.Threading.Thread.Abort%2A> sullo stesso thread, il thread sarà contemporaneamente nel <xref:System.Threading.ThreadState.WaitSleepJoin> e <xref:System.Threading.ThreadState.AbortRequested> stati nello stesso momento. In tal caso, non appena il thread viene restituito dalla chiamata a <xref:System.Threading.Monitor.Wait%2A> o viene interrotto, riceve <xref:System.Threading.ThreadAbortException>.  
