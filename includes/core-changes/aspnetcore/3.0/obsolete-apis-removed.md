...
ms.locfileid: "82135845"
---
### <a name="obsolete-antiforgery-cors-diagnostics-mvc-and-routing-apis-removed"></a><span data-ttu-id="99cec-101">Sono state rimosse le API obsolete, CORS, Diagnostics, MVC e routing</span><span class="sxs-lookup"><span data-stu-id="99cec-101">Obsolete Antiforgery, CORS, Diagnostics, MVC, and Routing APIs removed</span></span>

<span data-ttu-id="99cec-102">I membri obsoleti e le opzioni di compatibilità in ASP.NET Core 2,2 sono stati rimossi.</span><span class="sxs-lookup"><span data-stu-id="99cec-102">Obsolete members and compatibility switches in ASP.NET Core 2.2 were removed.</span></span>

#### <a name="version-introduced"></a><span data-ttu-id="99cec-103">Versione introdotta</span><span class="sxs-lookup"><span data-stu-id="99cec-103">Version introduced</span></span>

<span data-ttu-id="99cec-104">3.0</span><span class="sxs-lookup"><span data-stu-id="99cec-104">3.0</span></span>

#### <a name="reason-for-change"></a><span data-ttu-id="99cec-105">Motivo della modifica</span><span class="sxs-lookup"><span data-stu-id="99cec-105">Reason for change</span></span>

<span data-ttu-id="99cec-106">Miglioramento della superficie dell'API nel tempo.</span><span class="sxs-lookup"><span data-stu-id="99cec-106">Improvement of API surface over time.</span></span>

#### <a name="recommended-action"></a><span data-ttu-id="99cec-107">Azione consigliata</span><span class="sxs-lookup"><span data-stu-id="99cec-107">Recommended action</span></span>

<span data-ttu-id="99cec-108">Se la destinazione è .NET Core 2,2, seguire le istruzioni contenute nei messaggi di compilazione obsoleti per adottare le nuove API.</span><span class="sxs-lookup"><span data-stu-id="99cec-108">While targeting .NET Core 2.2, follow the guidance in the obsolete build messages to adopt new APIs instead.</span></span>

#### <a name="category"></a><span data-ttu-id="99cec-109">Category</span><span class="sxs-lookup"><span data-stu-id="99cec-109">Category</span></span>

<span data-ttu-id="99cec-110">ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="99cec-110">ASP.NET Core</span></span>

#### <a name="affected-apis"></a><span data-ttu-id="99cec-111">API interessate</span><span class="sxs-lookup"><span data-stu-id="99cec-111">Affected APIs</span></span>

<span data-ttu-id="99cec-112">I tipi e i membri seguenti sono stati contrassegnati come obsoleti per ASP.NET Core 2,1 e 2,2:</span><span class="sxs-lookup"><span data-stu-id="99cec-112">The following types and members were marked as obsolete for ASP.NET Core 2.1 and 2.2:</span></span>

<span data-ttu-id="99cec-113">**Tipi**</span><span class="sxs-lookup"><span data-stu-id="99cec-113">**Types**</span></span>
...
<span data-ttu-id="99cec-114">**Costruttori**</span><span class="sxs-lookup"><span data-stu-id="99cec-114">**Constructors**</span></span>
...
- [<span data-ttu-id="99cec-117">Microsoft. AspNetCore. Mvc. Routing. KnownRouteValueConstraint ()</span><span class="sxs-lookup"><span data-stu-id="99cec-117">Microsoft.AspNetCore.Mvc.Routing.KnownRouteValueConstraint()</span></span>](https://docs.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.routing.knownroutevalueconstraint.-ctor?view=aspnetcore-2.2#Microsoft_AspNetCore_Mvc_Routing_KnownRouteValueConstraint__ctor)
...
<span data-ttu-id="99cec-119">**Proprietà**</span><span class="sxs-lookup"><span data-stu-id="99cec-119">**Properties**</span></span>
...
<span data-ttu-id="99cec-120">**Metodi**</span><span class="sxs-lookup"><span data-stu-id="99cec-120">**Methods**</span></span>
